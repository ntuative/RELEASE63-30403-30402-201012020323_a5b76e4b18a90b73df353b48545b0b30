package com.sulake.room.renderer.utils
{
   ...
   public class ExtendedSprite extends Bitmap
   {
      ...
      private var var_1222:int = 128;
      
      private var var_1223:Boolean = false;
      
      private var var_2609:Point;
      ...
      {
         if(param1 != this.var_1512 || param2 != this.var_1513)
         {
      ...
      {
         if(this.var_1222 > 255 || bitmapData == null)
         {
            return false;
         }
