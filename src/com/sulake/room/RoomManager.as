package com.sulake.room
{
   ...
   public class RoomManager extends Component implements IRoomManager, IRoomInstanceContainer
   {
      ...
      public static const const_689:int = -1;
      ...
      private var var_144:IRoomManagerListener;
      
      private var var_2659:IRoomContentLoader;
      
      private var var_564:IRoomObjectFactory = null;
      
      private var var_461:IRoomObjectVisualizationFactory = null;
      
      private var _state:int = 0;
      
      private var var_1040:XML = null;
      ...
      public function RoomManager(param1:IContext, param2:uint = 0)
      {
         ...
         events.addEventListener(RoomContentLoadedEvent.const_799,this.onContentLoaded);
      }
      ...
      private function objectFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_564 = param2 as IRoomObjectFactory;
      ...
      {
         var _loc1_:* = null;
         if(this.var_564 == null || this.var_461 == null)
         {
            return;
         }
         this._state = const_1362;
         if(this.var_1040 != null)
         {
            _loc1_ = this.var_1040;
            this.var_1040 = null;
            this.initialize(_loc1_,this.var_144);
         }
      }
      ...
      public function initialize(param1:XML, param2:IRoomManagerListener) : Boolean
      {
         ...
         while(_loc4_ < _loc3_.length)
         {
            ...
            if(this.var_565.indexOf(_loc5_) < 0)
            {
               this.var_44.loadObjectContent(_loc5_,events);
               this.var_565.push(_loc5_);
            }
            _loc4_++;
         }
      ...
      {
         var _loc4_:* = null;
         var _loc2_:int = this.var_522.indexOf(param1);
         if(_loc2_ >= 0)
         {
            return;
         }
         this.var_522.push(param1);
      ...
      public function createRoom(param1:String, param2:XML) : IRoomInstance
      {
         ...
         var _loc4_:int = this.var_522.length - 1;
         while(_loc4_ >= 0)
         {
            _loc5_ = this.var_522[_loc4_];
      ...
      public function createRoomObject(param1:String, param2:int, param3:String, param4:int) : IRoomObject
      {
         ...
         var _loc17_:IRoomObjectGraphicVisualization = this.var_461.createRoomObjectVisualization(_loc10_);
         if(_loc17_ == null)
         {
            _loc5_.disposeObject(param2,param4);
            return null;
         ...
         var _loc18_:* = null;
         _loc18_ = this.var_461.getRoomObjectVisualizationData(_loc12_,_loc10_,_loc8_);
         ...
         var _loc19_:IRoomObjectEventHandler = this.var_564.createRoomObjectLogic(_loc11_);
      ...
      public function createRoomObjectManager() : IRoomObjectManager
      {
         if(this.var_564 != null)
         {
            return this.var_564.createRoomObjectManager();
         }
         return null;
      }
      ...
      private function processInitialContentLoad(param1:String) : void
      {
         ...
         if(this.var_44.getGraphicAssetCollection(param1) != null)
         {
            ...
            if(this.var_565.length == 0)
            {
               ...
               {
                  this.var_144.roomManagerInitialized();
               }
            }
         }
         else
         {
            this._state = const_689;
            this.var_144.roomManagerInitialized(false);
         }
      }
      ...
      private function onContentLoaded(param1:RoomContentLoadedEvent) : void
      {
         ...
         if(_loc2_ == null)
         {
            if(this.var_144 != null)
            {
               this.var_144.contentLoaded(null,false);
            }
            return;
         }
         ...
         if(_loc3_ == null)
         {
            if(this.var_144 != null)
            {
               this.var_144.contentLoaded(_loc2_,false);
            }
            return;
         }
         ...
         if(this.var_144 != null)
         {
            this.var_144.contentLoaded(_loc2_,true);
         }
         if(this.var_565.length > 0)
         {
      ...
      private function updateObjectContent(param1:String) : void
      {
         ...
         if(this.var_44 == null || this.var_461 == null)
         {
            return;
         }
                  ...
                  while(_loc13_ >= 0)
                  {
                     ...
                     if(_loc14_ != null)
                     {
                        ...
                        if(_loc16_ == param1)
                        {
                           ...
                           _loc5_ = this.var_461.getRoomObjectVisualizationData(_loc15_,_loc17_,_loc2_);
                           _loc19_ = this.var_461.createRoomObjectVisualization(_loc17_);
                           if(_loc19_ != null)
                           {
                              ...
                              else
                              {
                                 ...
                                 _loc20_ = this.var_564.createRoomObjectLogic(_loc18_);
                                 ...
                                 if(this.var_144 != null)
                                 {
                                    this.var_144.objectInitialized(_loc8_,_loc14_.getId(),_loc11_);
                                 }
                              }
                           }
                           else
