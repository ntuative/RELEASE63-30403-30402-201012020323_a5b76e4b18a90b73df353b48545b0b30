package com.sulake.room
{
   ...
   public class RoomInstance implements IRoomInstance
   {
      ...
      {
         return this.var_520[param1];
      }
      
      public function setNumber(param1:String, param2:Number, param3:Boolean = false) : void
      {
         if(this.var_1193.indexOf(param1) >= 0)
         {
            return;
         }
         if(param3)
      ...
      {
         if(this.var_1194.indexOf(param1) >= 0)
         {
            return;
         }
         if(param3)
      ...
      public function update() : void
      {
         ...
         var _loc2_:int = this.var_522.length - 1;
         while(_loc2_ >= 0)
         {
            _loc3_ = int(this.var_522[_loc2_]);
