package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      private var var_373:Number = 1.0;
      
      private var var_374:Number = 1.0;
      
      private var var_375:Number = 1.0;
      ...
      private var var_2620:Number = -500.0;
      
      private var var_2619:Number = 500.0;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         this.x_scale = 1;
         this.y_scale = 1;
         this.var_1613 = Math.sqrt(0.5) / Math.sqrt(0.75);
         this.z_scale = 1;
      ...
      {
         return new Vector3d(this.var_74.x * this.var_373,this.var_74.y * this.var_374,this.var_74.z * this.var_375);
      }
      ...
      {
         if(this.var_373 != param1 * this.var_1614)
         {
            this.var_373 = param1 * this.var_1614;
            ++this.var_142;
         }
      }
      ...
      {
         if(this.var_374 != param1 * this.var_1615)
         {
            this.var_374 = param1 * this.var_1615;
            ++this.var_142;
         }
      }
      ...
      {
         if(this.var_375 != param1 * this.var_1613)
         {
            this.var_375 = param1 * this.var_1613;
            ++this.var_142;
         }
      }
      ...
      public function set location(param1:IVector3d) : void
      {
         ...
         this.var_74.x /= this.var_373;
         this.var_74.y /= this.var_374;
         this.var_74.z /= this.var_375;
      ...
      private function getDisplacenent(param1:IVector3d) : IVector3d
      {
         ...
         if(this.var_445 != null)
         {
            ...
            return this.var_445.getValue(_loc2_);
         }
         return null;
      }
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            this.var_1011.assign(_loc22_);
         }
         else
         {
            this.var_1011.assign(_loc17_);
         }
         ++this.var_142;
      }
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         _loc2_.x *= this.var_373;
         _loc2_.y *= this.var_374;
         _loc2_.z *= this.var_375;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,this.var_1011);
         if(_loc3_ < this.var_2620 || _loc3_ > this.var_2619)
         {
            return null;
         }
         ...
         if(_loc6_ != null)
         {
            ...
            _loc2_.y *= this.var_374;
            _loc2_.z *= this.var_375;
            _loc3_ = Vector3d.scalarProjection(_loc2_,this.var_1011);
         }
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc7_:IVector3d = Vector3d.sum(Vector3d.product(this._x,_loc5_),Vector3d.product(this.var_164,_loc6_));
         var _loc8_:Vector3d = new Vector3d(this.var_74.x * this.var_373,this.var_74.y * this.var_374,this.var_74.z * this.var_375);
         var _loc9_:IVector3d = Vector3d.sum(_loc8_,_loc7_);
         var _loc10_:IVector3d = this.var_165;
         var _loc11_:Vector3d = new Vector3d(param2.x * this.var_373,param2.y * this.var_374,param2.z * this.var_375);
         var _loc12_:Vector3d = new Vector3d(param3.x * this.var_373,param3.y * this.var_374,param3.z * this.var_375);
         var _loc13_:Vector3d = new Vector3d(param4.x * this.var_373,param4.y * this.var_374,param4.z * this.var_375);
      ...
      public function performZoom() : void
      {
         if(this.isZoomedIn())
         {
            this.scale = const_965;
         }
         else
         {
            this.scale = const_643;
         }
      }
      
      public function isZoomedIn() : Boolean
      {
         return this.scale == const_643;
      }
