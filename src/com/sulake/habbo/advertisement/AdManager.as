package com.sulake.habbo.advertisement
{
   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      private var var_932:BitmapData = null;
      ...
      {
         this.var_266 = param2 as IHabboCommunicationManager;
         if(this.var_266 == null)
         {
            return;
         }
         this._connection = this.var_266.getHabboMainConnection(this.onConnectionReady);
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1882 = this._config.getKey("interstitial.enabled","false") == "true";
         this.var_1879 = int(this._config.getKey("interstitial.interval","30000"));
         this.var_1881 = int(this._config.getKey("interstitial.show.time","5000"));
         this.var_1410 = int(this._config.getKey("interstitial.max.displays.flash","-1"));
      ...
      public function showInterstitial() : Boolean
      {
         ...
         if(this.var_931 == 0)
         {
            this.var_931 = getTimer();
            return false;
         }
         if(this.var_1410 > 0 && this.var_1409 >= this.var_1410)
         {
            return false;
         }
         var _loc1_:int = getTimer() - this.var_931;
         if(_loc1_ > this.var_1879)
         {
            ++this.var_1409;
      ...
      private function onInterstitial(param1:InterstitialMessageEvent) : void
      {
         ...
         this.var_1172 = _loc2_.imageUrl;
         this.var_1880 = _loc2_.clickUrl;
         this.var_931 = getTimer();
         if(this.var_1172 != "")
         {
            _loc3_ = this.var_1172;
            ...
            {
               this.var_188 = new Timer(this.var_1881,1);
            ...
            this.var_188.start();
            _loc4_ = new URLRequest(this.var_1172);
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_452,0,0,param1.bitmapData,this.var_1880));
            this.var_931 = getTimer();
         }
         else
         {
      ...
      private function onRoomAd(param1:RoomAdMessageEvent) : void
      {
         ...
         this.var_1171 = _loc2_.imageUrl;
         this.var_1411 = _loc2_.clickUrl;
         if(this.var_1171 != "" && this.var_1411 != "")
         {
            ...
            _loc4_ = new URLRequest(this.var_1171);
            _loc5_ = assets.loadAssetFromFile(_loc3_,_loc4_,"image/jpeg");
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(this.isValidAdImage(_loc3_))
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_408,0,0,_loc4_,this.var_1411,this.var_932,this.var_930));
         }
      }
      ...
      private function adWarningLeftReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            this.var_932 = this.emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
      ...
      private function adWarningRightReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            this.var_930 = this.emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
