package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel implements IInventoryModel
   {
      ...
      private static const const_1194:int = 100;
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboCatalog)
      {
         ...
         this.var_570 = new Timer(const_1194,1);
         this.var_570.addEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
         var _loc8_:IAsset = this._assets.getAssetByName("inventory_thumb_xml");
         var _loc9_:XmlAsset = XmlAsset(_loc8_);
         this.var_2345 = XML(_loc9_.content);
         this.clearFurniList();
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            {
               this.var_570.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
               this.var_570.stop();
               this.var_570 = null;
            }
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         if(this.var_875 == null)
         {
            this.var_875 = this._windowManager.buildFromXML(this.var_2345) as IWindowContainer;
         }
         var _loc11_:IWindowContainer = this.var_875.clone() as IWindowContainer;
      ...
      {
         this._controller.checkCategoryInitilization(InventoryCategory.const_362);
      ...
      public function clearFurniList() : void
      {
         ...
         this.var_465.add(const_42,new Array());
         this.var_465.add(const_46,new Array());
         if(this._view != null)
         {
      ...
      {
         this.method_3(param1,param2);
      }
      
      public function method_3(param1:IItem, param2:Boolean = false, param3:int = -1) : void
      {
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc7_:* = null;
      ...
      {
         return this._controller.getSubCategoryViewId() == InventorySubCategory.const_260;
      }
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_336 || _loc3_.category == FurniCategory.const_324 || _loc3_.category == FurniCategory.const_381)
         {
            if(param1)
            {
               return false;
      ...
      {
         if(this.var_1307 && param1.type == RoomEngineObjectEvent.const_237)
         {
            this.var_1307 = false;
         }
      }
      ...
      {
         return this.var_465.getValue(param1);
      }
      ...
      public function getAllStripIds(param1:Array) : void
      {
         ...
         var _loc7_:int = 0;
         var _loc8_:int = 0;
         var _loc2_:Array = this.var_465.getKeys();
         var _loc3_:int = 0;
         while(_loc3_ < _loc2_.length)
         {
            _loc4_ = this.var_465.getValue(_loc2_[_loc3_]) as Array;
            if(_loc4_ != null)
            {
               _loc5_ = 0;
               while(_loc5_ < _loc4_.length)
               {
                  ...
                  if(_loc6_.category == FurniCategory.const_562)
                  {
                     _loc7_ = 1;
                  }
                  _loc8_ = 0;
