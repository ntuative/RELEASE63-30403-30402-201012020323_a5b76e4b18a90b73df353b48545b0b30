package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniView implements IInventoryView, IGetImageListener
   {
      ...
      private const const_874:int = 1;
      
      private const const_1550:int = 2;
      
      private const const_1549:int = 3;
      
      private const const_1560:int = 42;
      
      private const const_1561:int = 120;
      ...
      public function FurniView(param1:FurniModel, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine)
      {
         ...
         this.var_487.add(FurniModel.const_42,new FurniGridView(this.var_62,FurniModel.const_42,this._windowManager,this._assetLibrary,this._roomEngine));
         this.var_487.add(FurniModel.const_46,new FurniGridView(this.var_62,FurniModel.const_46,this._windowManager,this._assetLibrary,this._roomEngine));
      ...
      private function showCategoryGrid(param1:String = null) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_487.getValue(this.var_402);
         if(_loc3_)
         {
      ...
      {
         var _loc2_:int = 0;
         var _loc1_:Array = this.var_62.getCategoryContent(this.var_402);
         if(!this.var_62.isListInited())
         {
            _loc2_ = this.const_874;
         }
         ...
         if(this.var_2423 == _loc2_)
         {
            return;
         }
         this.var_2423 = _loc2_;
      ...
      public function clearViews() : void
      {
         ...
         while(_loc4_ < _loc1_.length)
         {
            ...
            _loc3_ = this.var_487.getValue(_loc2_);
            if(_loc3_ != null)
            {
               _loc3_.clearGrid();
            }
      ...
      public function updateItem(param1:String, param2:GroupItem, param3:int) : void
      {
         ...
         var _loc4_:FurniGridView = this.var_487.getValue(param1);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      public function addItemToBottom(param1:String, param2:GroupItem) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_487.getValue(param1);
         if(_loc3_ == null)
         {
            return;
         }
      ...
      public function updateActionView() : void
      {
         ...
         _loc4_ = this.var_62.getGroupItemInIndex(_loc3_,this.var_402);
         ...
         if(_loc11_)
         {
            if(_loc1_ && this.var_663 && this.var_663.isEnabled && _loc5_.sellable)
            {
               _loc11_.enable();
            }
            else
      ...
      private function setPreviewImage(param1:BitmapData) : void
      {
         ...
         if(_loc3_ > this.const_1561)
         {
            _loc3_ = this.const_1561;
         }
         else if(_loc3_ < this.const_1560)
         {
            _loc3_ = this.const_1560;
         }
         else
         {
