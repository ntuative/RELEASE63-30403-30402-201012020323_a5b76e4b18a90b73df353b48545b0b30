package com.sulake.habbo.inventory.common
{
   ...
   public class ThumbListManager
   {
      ...
      private var var_1327:IThumbListDataProvider;
      ...
      public function ThumbListManager(param1:IAssetLibrary, param2:IThumbListDataProvider, param3:String, param4:String, param5:int, param6:int)
      {
         ...
         if(_loc7_ != null)
         {
            this.var_581 = BitmapData(_loc7_.content);
         }
         ...
         this._thumbWidth = this.var_581.width;
         this.var_88 = this.var_581.height;
         this.var_1071 = param5;
         this.var_882 = param6;
         this.var_207 = Math.floor(this.var_1071 / this._thumbWidth);
         this.var_26 = new BitmapData(this.var_1071,this.var_882);
      }
      ...
      public function updateImageFromList() : void
      {
         ...
         this.var_26 = new BitmapData(Math.max(this.var_207 * this._thumbWidth,this.var_1071),Math.max(this.var_580 * this.var_88,this.var_882),true,16777215);
      ...
      private function getList() : Array
      {
         ...
         {
            _loc1_ = this.var_1327.getDrawableList();
         }
      ...
      private function removeItemInImage(param1:Point) : void
      {
         ...
         if(this.var_26.height < this.var_882)
         {
            _loc12_ = new BitmapData(this.var_26.width,this.var_882);
      ...
      {
         var _loc4_:* = null;
         var _loc3_:BitmapData = new BitmapData(this.var_581.width,this.var_581.height);
         if(param2)
         {
            _loc3_.copyPixels(this._itemBgImageSelected,this.var_581.rect,new Point(0,0),null,null,false);
         }
         else
         {
            _loc3_.copyPixels(this.var_581,this.var_581.rect,new Point(0,0),null,null,false);
         }
         if(param1 != null)
         {
