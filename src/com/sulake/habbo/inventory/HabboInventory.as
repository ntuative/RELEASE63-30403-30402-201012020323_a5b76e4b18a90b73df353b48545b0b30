package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private var var_1016:IRoomSession;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_20 != null)
         {
            this.var_20.events.removeEventListener(RoomSessionEvent.const_87,this.roomSessionEventHandler);
            this.var_20.events.removeEventListener(RoomSessionEvent.const_92,this.roomSessionEventHandler);
            this.var_20.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_466,this.roomSessionEventHandler);
      ...
      {
         return FurniModel(this.var_46.getValue(InventoryCategory.const_80));
      }
      
      public function get tradingModel() : TradingModel
      {
         return TradingModel(this.var_46.getValue(InventorySubCategory.const_260));
      }
      
      public function get effectsModel() : EffectsModel
      {
         return EffectsModel(this.var_46.getValue(InventoryCategory.const_655));
      }
      ...
      {
         return AchievementsModel(this.var_46.getValue(InventoryCategory.const_341));
      }
      ...
      {
         return this.var_46.getValue(InventoryCategory.const_362) as MarketplaceModel;
      }
      ...
      {
         this.var_359 = ISessionDataManager(param2);
         this.initInventory();
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_20.events.addEventListener(RoomSessionEvent.const_87,this.roomSessionEventHandler);
         this.var_20.events.addEventListener(RoomSessionEvent.const_92,this.roomSessionEventHandler);
         this.var_20.events.addEventListener(RoomSessionPropertyUpdateEvent.const_466,this.roomSessionEventHandler);
         this.initInventory();
      }
      ...
      private function roomSessionEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_92:
               this.var_1016 = null;
               break;
            case RoomSessionPropertyUpdateEvent.const_466:
               this.petsModel.updatePetsAllowed();
         }
      }
      ...
      {
         if(!this._communication || !this._windowManager || !this._localization || !this._roomEngine || !this.var_359 || !this._config || !this._catalog || !this._avatarRenderer || !this.var_20 || !this._toolbar)
         {
            return;
         }
         ...
         this.var_46.add(InventoryCategory.const_362,_loc1_);
         ...
         this.var_46.add(InventoryCategory.const_80,_loc2_);
         var _loc3_:BadgesModel = new BadgesModel(this,this._windowManager,this._communication,this._assetLibrary,this.var_359);
         ...
         this.var_46.add(InventoryCategory.const_655,_loc4_);
         var _loc5_:AchievementsModel = new AchievementsModel(this,this._windowManager,this._communication,this._assetLibrary,this._localization,this.var_359);
         this.var_46.add(InventoryCategory.const_341,_loc5_);
         ...
         this.var_46.add(InventorySubCategory.const_260,_loc6_);
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         if(param2)
         {
            if(this.var_901.indexOf(param1) == -1)
            {
         ...
         {
            _loc3_ = this.var_901.indexOf(param1);
            if(_loc3_ >= 0)
            {
               this.var_901.splice(_loc3_,1);
            }
         }
      }
      ...
      {
         if(this.var_901.indexOf(param1) >= 0)
         {
            return true;
         }
         return false;
