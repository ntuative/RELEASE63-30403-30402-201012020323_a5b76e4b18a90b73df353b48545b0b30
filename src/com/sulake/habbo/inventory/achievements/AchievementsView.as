package com.sulake.habbo.inventory.achievements
{
   ...
   public class AchievementsView implements IInventoryView
   {
      ...
      public function AchievementsView(param1:AchievementsModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:ISessionDataManager)
      {
         ...
         this.var_399.addEventListener(TimerEvent.TIMER,this.doBadgeRefresh);
         this.var_359.events.addEventListener(BadgeImageReadyEvent.const_129,this.onBadgeImageReady);
      }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this.var_399)
            {
               this.var_399.removeEventListener(TimerEvent.TIMER,this.doBadgeRefresh);
               this.var_399.reset();
               this.var_399 = null;
            }
            this._disposed = true;
      ...
      {
         Logger.log("Got badge: " + param1.badgeId + ", " + this.var_399.running);
      ...
      private function refreshBadgeImage(param1:IWindowContainer, param2:AchievementData) : void
      {
         ...
         if(_loc4_ == null)
         {
            _loc4_ = this.var_359.getBadgeImage(param2.badgeId);
