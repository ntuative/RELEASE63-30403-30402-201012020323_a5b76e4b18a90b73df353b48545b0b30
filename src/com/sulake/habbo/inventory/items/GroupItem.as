package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      private const const_1804:int = 8947848;
      
      private const const_1805:int = 13421772;
      
      private const const_1526:Number = 1;
      
      private const const_1527:Number = 0.2;
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(this.category == FurniCategory.const_562)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < this._items.length)
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            if(_loc2_ <= 0)
            {
               this._window.blend = this.const_1527;
               _loc1_.blend = this.const_1527;
            }
            else
            {
               this._window.blend = this.const_1526;
               _loc1_.blend = this.const_1526;
            }
         }
         if(this.isSelected)
         {
         ...
         if(_loc5_)
         {
            if(this.var_1857 && this.getRecyclableCount() > 0)
            {
