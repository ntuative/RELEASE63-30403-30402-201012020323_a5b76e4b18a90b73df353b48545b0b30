package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingModel implements IInventoryModel, IGetImageListener
   {
      ...
      public static const const_306:uint = 3;
      ...
      public function startTrading(param1:int, param2:String, param3:Boolean, param4:int, param5:String, param6:Boolean) : void
      {
         ...
         this.var_49.updateItemList(this.var_741);
         this.var_49.updateItemList(this.var_1389);
      ...
      public function close() : void
      {
         if(this.var_623)
         {
            if(this._state != const_163 && this._state != const_240)
            {
               this.requestCancelTrading();
               this.state = TradingModel.TRADING_STATE_CANCELLED;
            }
            this.state = const_163;
            this._inventory.toggleInventorySubPage(InventorySubCategory.const_993);
            this.var_623 = false;
         }
      ...
      {
         this.var_49.setMinimized(param1 != InventoryCategory.const_80);
         this._inventory.updateSubView();
      }
      
      public function set state(param1:uint) : void
      {
         Logger.log("OLD STATE: " + this._state + " NEW STATE: " + param1 + " OWN: " + this.var_742 + " OTHER: " + this.var_1139);
         ...
         {
            case const_163:
               if(param1 == const_177 || param1 == const_240)
               {
                  this._state = param1;
                  _loc2_ = true;
               }
      ...
      public function handleMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(param1 is TradingAlreadyOpenEvent)
         {
            ...
            this.var_49.alertPopup(TradingView.const_1077);
         }
         else if(param1 is TradingAcceptEvent)
         {
            Logger.log("TRADING::TradingAcceptEvent");
            if(TradingAcceptEvent(param1).userID == this.var_741)
            {
               this.var_742 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            else
            {
               this.var_1139 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            this.var_49.updateUserInterface();
         }
         ...
         else if(param1 is TradingCloseEvent)
         {
            ...
            if(_loc2_.userID != this.var_741)
            {
               this.var_49.alertPopup(TradingView.const_902);
            }
            this.close();
         }
      ...
      public function requestAddItemToTrading(param1:int, param2:int, param3:int, param4:Boolean, param5:String = "") : Boolean
      {
         ...
         if(this.var_286.length < const_1432)
         {
