package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIconGroup
   {
      ...
      public function getMenuYieldList(param1:String) : Array
      {
         ...
         var _loc3_:XMLList = this.var_2025.elements("menu");
         var _loc5_:int = 0;
      ...
      {
         return this.var_648.indexOf(param1) > -1;
      }
      ...
      public function get size() : Number
      {
         ...
         {
            if(this.var_261[_loc2_].exists)
            {
               _loc1_ += this.var_1217;
            }
            _loc2_++;
         }
         return _loc1_;
      ...
      private function alignItems() : void
      {
         ...
         var _loc3_:* = 0;
         var _loc4_:int = 0;
         while(_loc4_ < this.var_1216.length)
         {
            _loc2_ = this.var_648.indexOf(this.var_1216[_loc4_]);
            if(_loc2_ > -1)
            {
               _loc1_ = this.var_261[_loc2_];
               if(_loc1_.exists)
               {
      ...
      public function getIconById(param1:String) : ToolbarIcon
      {
         ...
         return this.var_261[this.var_648.indexOf(param1)];
      }
      ...
      private function createIconObject(param1:String) : ToolbarIcon
      {
         ...
         this.var_648.push(param1);
         this.var_261.push(_loc2_);
         return _loc2_;
      }
   }
}
