package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private static const const_1181:Number = 25;
      
      private static const const_1179:Number = 90;
      
      private static const const_856:int = 50;
      
      private static const const_1202:int = 50;
       
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_1309:ToolbarView;
      ...
      public function ToolbarBarMenuAnimator(param1:IHabboWindowManager, param2:ToolbarView)
      {
         ...
         this.var_703 = new Timer(const_1181);
         this.var_703.addEventListener(TimerEvent.TIMER,this.animationUpdate);
      }
      ...
      {
         return param1.x + param1.width < const_856 + this._toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_856 || param1.desktop.height - param1.y < const_1202;
      }
      ...
      private function createItemObject(param1:String, param2:ToolbarIcon) : MenuAnimatorItem
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc4_ = this.var_1309.getIconByMenuId(param1);
            if(_loc4_ == null)
            {
               return null;
            }
      ...
      {
         var _loc2_:Point = this.var_1309.getIconLoc(param1.iconId);
      ...
      {
         return this.var_573[this.var_572.indexOf(param1)];
      }
      
      private function getWindowMenuId(param1:String) : String
      {
         return this.var_572[this.var_573.indexOf(param1)];
      }
      ...
      private function registerWindow(param1:IWindowContainer, param2:String) : void
      {
         ...
         if(_loc3_ > -1)
         {
            ...
            this.var_573.splice(_loc3_,1);
         }
         this.var_573.push(param1.name);
         this.var_572.push(param2);
         param1.addEventListener(WindowEvent.const_352,this.windowEventListener);
      ...
      public function windowEventListener(param1:WindowEvent) : void
      {
         ...
         {
            if(this.var_573[_loc2_] == param1.window.name)
            {
