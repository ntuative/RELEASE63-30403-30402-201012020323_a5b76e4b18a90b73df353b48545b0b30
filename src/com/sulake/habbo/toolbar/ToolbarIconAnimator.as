   ...
   public class ToolbarIconAnimator
   {
      ...
      public function ToolbarIconAnimator(param1:StateItem, param2:IAssetLibrary, param3:IBitmapWrapperWindow, param4:Number, param5:Number, param6:BitmapData = null)
      {
         ...
         else
         {
            ...
            if(_loc8_ != null)
            {
               this.var_833.push(new XML());
               this.var_832.push(_loc8_);
            }
         }
         if(param6 != null)
         {
            this.var_832[this._frame] = param6.clone();
         }
      ...
      {
         if(this.var_1265 == true || this.var_835 == 0)
         {
            if(this.var_833.length > 0)
            {
               ++this._frame;
               if(this._frame >= this.var_833.length)
               {
                  this._frame = 0;
                  ++this.var_835;
               }
      ...
      {
         return this.var_1265 == false && this.var_835 == 1 && this.var_1434 != this._state;
      }
      ...
      {
         var _loc2_:* = null;
         if(this._frame <= this.var_832.length)
         {
            _loc2_ = this.var_832[this._frame];
      ...
      private function setAsset(param1:IBitmapWrapperWindow, param2:BitmapData) : void
      {
         ...
         {
            _loc3_ = new BitmapData(Math.max(param2.width,this.var_834.width),Math.max(param2.height,this.var_834.height));
            _loc3_.copyPixels(this.var_834,this.var_834.rect,new Point(0,0));
