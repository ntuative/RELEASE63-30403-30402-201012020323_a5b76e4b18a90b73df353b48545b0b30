package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNavigator implements ICatalogNavigator
   {
      ...
      private var var_2652:String = "magic.credits";
      
      private var var_2610:String = "magic.pixels";
      
      private var var_2611:String = "catalog.page.club";
      ...
      public function activateNode(param1:ICatalogNode) : void
      {
         ...
         var _loc6_:* = null;
         var _loc7_:int = 0;
         var _loc2_:* = this.var_303.indexOf(param1) > -1;
         ...
         {
            _loc6_.close();
            _loc7_ = this.var_303.indexOf(_loc6_);
            this.var_303.splice(_loc7_,1);
         }
         param1.activate();
         if(_loc2_ && _loc3_)
         {
      ...
      {
         this.openPage(this.var_2610);
      }
      
      private function openClubPage() : void
      {
         this._catalog.openCatalogPage(this.var_2611,true);
      }
