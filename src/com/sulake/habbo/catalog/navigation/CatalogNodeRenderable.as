package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNodeRenderable extends CatalogNode
   {
      ...
      private static const const_1205:Number = 4285716709;
      ...
      private var var_1714:Number = 4.294967295E9;
      
      private var _icon:BitmapData;
      
      private var _window:IWindowContainer;
      
      private var var_2631:IWindowContainer;
      ...
      override public function activate() : void
      {
         ...
         if(_loc1_ != null)
         {
            if(this.var_1714 == 4294967295)
            {
               this.var_1714 = _loc1_.color;
            }
            _loc1_.color = const_1205;
         }
      }
      ...
      override public function close() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1412;
            }
         }
      }
      ...
      {
         this.var_53 = navigator.catalog.windowManager.buildFromXML(var_1315) as IItemListWindow;
         if(this.var_53 == null)
         {
      ...
      private function createWindow() : void
      {
         if(depth == 1)
         {
            this._window = navigator.catalog.windowManager.buildFromXML(var_1314) as IWindowContainer;
         }
         else
         {
