package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener
   {
      ...
      private const const_1546:uint = 4.293848814E9;
      
      private const const_1545:uint = 4.294967295E9;
      ...
      private function updateLocalizations() : void
      {
         ...
         var _loc8_:String = this.var_80.activityPointType == Purse.const_497 ? "pixels" : "activitypoints";
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc1_.isEnabled)
         {
            ...
            this.var_1497 = _loc1_.stuffTypes;
            this.var_647 = _loc1_.boxTypes;
            this.var_646 = _loc1_.ribbonTypes;
            this.var_957 = this.var_1497[0];
            this.var_301 = this.var_647[0];
            this.var_300 = this.var_646[0];
            this.initColorGrid();
      ...
      private function updatePreview() : void
      {
         ...
         if(this.var_300 < 0)
         {
            this.var_300 = this.var_646.length - 1;
         }
         if(this.var_300 > this.var_646.length - 1)
         {
            this.var_300 = 0;
         }
         if(this.var_301 < 0)
         {
            this.var_301 = this.var_647.length - 1;
         }
         if(this.var_301 > this.var_647.length - 1)
         {
            this.var_301 = 0;
         }
         var _loc1_:int = this.var_647[this.var_301] * 1000 + this.var_646[this.var_300];
         if(this._window == null)
         {
            return;
         }
         var _loc2_:IRoomEngine = this.var_80.page.viewer.roomEngine;
         _loc3_ = _loc2_.getFurnitureImage(this.var_957,new Vector3d(180),64,this,_loc1_.toString());
         if(_loc3_ == null)
         {
            return;
         }
         this.var_1214 = _loc3_.id;
      ...
      private function initColorGrid() : void
      {
         ...
         var _loc3_:Array = this.var_1497;
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(this.var_957);
         var _loc8_:int = !!_loc6_ ? 0 : int(this.var_647[this.var_301]);
         var _loc9_:int = !!_loc6_ ? 0 : int(this.var_646[this.var_300]);
         this._catalog.purchaseProductAsGift(this._pageId,this.var_80,this.var_1215,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      ...
      private function confirmationHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "gift_button":
               ...
               break;
            case "buy_button":
               this._catalog.purchaseProduct(this._pageId,this.var_80.offerId,this.var_1215);
               this.dispose();
               break;
            case "cancel_button":
      ...
      private function nameInputHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.const_40:
               ...
               break;
            case WindowKeyboardEvent.const_789:
      ...
      {
         if(this.var_220 == null || !this.var_220.visible)
         {
            return;
         }
         var _loc1_:IItemListWindow = this.var_220.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc1_ == null)
         {
            return;
         }
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(this.var_220 == null)
         {
            this.var_220 = this._window.findChildByName("suggestion_container") as IWindowContainer;
         }
         if(this.var_526 == null)
         {
         ...
         if(this.var_220 == null || this.var_526 == null)
         {
            return;
         }
         var _loc2_:IItemListWindow = this.var_220.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      {
         return param1 % 2 == 0 ? uint(this.const_1546) : uint(this.const_1545);
      }
      ...
      private function suggestionsEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER:
               _loc5_ = this.var_220.findChildByName("suggestion_list") as IItemListWindow;
               if(_loc5_ == null)
               {
                  return;
               }
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == this.var_957;
               }
            }
            _loc4_++;
         }
