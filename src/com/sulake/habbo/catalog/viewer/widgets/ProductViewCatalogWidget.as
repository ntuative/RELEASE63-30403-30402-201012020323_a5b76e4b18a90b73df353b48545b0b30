package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1242:IScrollbarWindow;
      ...
      {
         this.var_818 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         this.var_999 = _window.findChildByName("ctlg_description") as ITextWindow;
         this.var_82 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         this.var_1574 = new Point(this.var_82.x,this.var_82.y);
         this.var_439 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         this.var_1242 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         ...
         this.var_1573 = _loc2_.content as BitmapData;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         this.var_818.text = _loc4_;
         this.var_999.text = _loc5_;
         this.var_818.height = this.var_818.textHeight + 5;
         this.var_999.y = this.var_818.y + this.var_818.height;
         this.var_999.height = Math.max(130,this.var_999.textHeight + 5);
         ...
         else
         {
            ...
            {
               case Offer.const_526:
                  _loc6_ = this.var_1573.clone();
                  if(this.var_439 != null)
                  {
                     this.var_439.visible = true;
                     _loc10_ = _loc2_.productContainer as BundleProductContainer;
                     _loc10_.populateItemGrid(this.var_439,this.var_1242,this.var_1743);
                     this.var_439.scrollV = 0;
                  }
                  break;
                     ...
                     case ProductTypeEnum.const_241:
                        ...
                        if(_loc15_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc16_ != null)
                           {
                              ...
                              _loc16_.appendAction(AvatarAction.const_287,AvatarAction.const_523);
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_2139)
         {
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(this.var_82 != null && true)
         {
            ...
            this.var_82.x = this.var_1574.x;
            this.var_82.y = this.var_1574.y;
            if(param3 != null)
            {
