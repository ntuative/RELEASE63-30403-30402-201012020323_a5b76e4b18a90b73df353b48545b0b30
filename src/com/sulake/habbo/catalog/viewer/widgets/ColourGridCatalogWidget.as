package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ColourGridCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function init() : void
      {
         ...
         this.var_1578 = _loc1_.content as XML;
      ...
      private function onAvailableColours(param1:CatalogWidgetColoursEvent) : void
      {
         ...
         this.var_778 = _loc4_.content as BitmapData;
      ...
      private function select(param1:IWindowContainer) : void
      {
         ...
         {
            _loc2_ = this.var_329.getChildByName("chosen");
            if(_loc2_ != null)
            {
      ...
      private function populateColourGrid() : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:* = 0;
         Logger.log("[ColourGridCatalogWidget] Display colors: " + [this.var_1243.length,this._colourGrid.numGridItems]);
         this._colourGrid.destroyGridItems();
         this.var_329 = null;
         for each(_loc1_ in this.var_1243)
         {
            _loc2_ = page.viewer.catalog.windowManager.buildFromXML(this.var_1578) as IWindowContainer;
            _loc2_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onClick);
            _loc2_.background = true;
            _loc2_.color = 4294967295;
            _loc2_.width = this.var_669.width;
            _loc2_.height = this.var_669.height;
            this._colourGrid.addGridItem(_loc2_);
            _loc3_ = _loc2_.findChildByTag("BG_BORDER") as IBitmapWrapperWindow;
            if(_loc3_ != null)
            {
               _loc3_.bitmap = new BitmapData(this.var_669.width,this.var_669.height,true,0);
               _loc3_.bitmap.copyPixels(this.var_669,this.var_669.rect,new Point(0,0));
            }
            ...
            if(_loc5_ != null)
            {
               _loc5_.bitmap = new BitmapData(this.var_778.width,this.var_778.height,true,16777215);
               _loc5_.bitmap.copyPixels(this.var_778,this.var_778.rect,new Point(0,0),null,null,true);
