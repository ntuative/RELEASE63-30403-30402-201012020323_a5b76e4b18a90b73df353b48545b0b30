package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      protected var var_1869:XML;
      
      protected var _window:IWindowContainer;
      
      private var var_1081:ICatalogViewer;
      ...
      private var var_1330:EventDispatcher;
      ...
      public function CatalogPage(param1:ICatalogViewer, param2:int, param3:String, param4:IPageLocalization, param5:Array, param6:HabboCatalog)
      {
         ...
         this.var_1330 = new EventDispatcher();
      ...
      {
         return this._localization.getLinks(this.var_1073);
      }
      
      public function get hasLinks() : Boolean
      {
         return this._localization.hasLinks(this.var_1073);
      }
      ...
      protected function createWindow(param1:String) : void
      {
         ...
         this.var_1869 = _loc3_.content as XML;
         this._window = this.viewer.catalog.windowManager.buildFromXML(this.var_1869) as IWindowContainer;
         if(this._window == null)
         {
      ...
      private function createWidgets() : void
      {
         ...
         if(_loc1_ != null)
         {
            this.var_1331 = new ItemGridCatalogWidget(_loc1_);
            this.var_58.push(this.var_1331);
         }
         ...
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1356) as IWindowContainer;
         if(_loc1_ != null)
         {
         ...
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1326) as IWindowContainer;
         if(_loc1_ != null)
         {
         ...
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1249) as IWindowContainer;
         if(_loc1_ != null)
         {
         ...
         {
            _loc2_.page = this;
            _loc2_.events = this.var_1330;
            _loc2_.init();
         }
         this.var_1330.dispatchEvent(new CatalogWidgetsInitializedEvent());
      }
      
      public function dispatchWidgetEvent(param1:Event) : Boolean
      {
         return this.var_1330.dispatchEvent(param1);
      }
   }
}
