package com.sulake.habbo.catalog.marketplace
{
   ...
   public class MarketPlaceLogic implements IMarketPlace
   {
      ...
      private static const const_1175:String = "poster";
       
      
      public const const_1590:int = 1;
      
      public const const_1747:int = 2;
      ...
      {
         this.requestOffers(this.var_2229,this.var_2228,this.var_2230,this.var_2234);
      }
      ...
      public function buyOffer(param1:int) : void
      {
         ...
         this.showConfirmation(this.const_1590,_loc2_);
      }
      ...
      public function redeemSoldOffers() : void
      {
         ...
         for each(_loc2_ in _loc1_)
         {
            ...
            if(_loc3_.status == MarketPlaceOfferState.const_521)
            {
      ...
      public function onOffers(param1:IMessageEvent) : void
      {
         ...
         {
            _loc6_ = new MarketPlaceOfferData(_loc4_.offerId,_loc4_.furniId,_loc4_.furniType,_loc4_.stuffData,_loc4_.price,_loc4_.status,_loc4_.method_1,_loc4_.offerCount);
      ...
      public function onOwnOffers(param1:IMessageEvent) : void
      {
         ...
         this.var_2227 = _loc3_.creditsWaiting;
         this.var_202 = new Map();
         for each(_loc4_ in _loc3_.offers)
         {
            _loc6_ = new MarketPlaceOfferData(_loc4_.offerId,_loc4_.furniId,_loc4_.furniType,_loc4_.stuffData,_loc4_.price,_loc4_.status,_loc4_.method_1);
            _loc6_.timeLeftMinutes = _loc4_.timeLeftMinutes;
      ...
      public function onBuyResult(param1:IMessageEvent) : void
      {
         ...
         else if(parser.result == 3)
         {
            ...
            this.showConfirmation(this.const_1747,updateItem);
            this._visualization.listUpdatedNotify();
         }
      ...
      {
         if(param1.furniCategoryId != this.var_2226 || param1.furniTypeId != this.var_2233)
         {
            return;
         }
      ...
      private function isPosterItem(param1:MarketPlaceOfferData) : Boolean
      {
         ...
         if(param1.furniType == 2 && param1.stuffData != null)
         {
            ...
            {
               _loc4_ = _loc3_.name;
               if(_loc4_ != null && _loc4_ == const_1175)
               {
                  _loc2_ = true;
               }
            }
