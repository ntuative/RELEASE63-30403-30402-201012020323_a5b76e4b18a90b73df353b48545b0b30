package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      {
         return this.var_525 != const_823;
      }
      
      private function get systemActive() : Boolean
      {
         return this.var_1493 != RecyclerStatusMessageEvent.const_915;
      }
      
      private function get ready() : Boolean
      {
         return this.active && this.var_525 == const_385;
      }
      ...
      {
         this.var_525 = const_824;
         this.var_101 = new Array(const_160);
         if(param1 == null)
         {
            return;
         }
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         switch(this.var_1493)
         {
            case RecyclerStatusMessageEvent.const_1359:
               ...
               this.updateRecyclerButton();
               break;
            case RecyclerStatusMessageEvent.const_915:
               if(this._view == null)
               {
                  return;
               }
               ...
               this._catalog.setupInventoryForRecycler(false);
               break;
            case RecyclerStatusMessageEvent.const_1279:
               if(this._view == null)
               {
                  return;
               }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_1041:
               if(this._view != null)
               {
      ...
      private function isPoolFull() : Boolean
      {
         ...
         if(this.var_101.length < const_160)
         {
            return false;
         }
         var _loc1_:int = 0;
