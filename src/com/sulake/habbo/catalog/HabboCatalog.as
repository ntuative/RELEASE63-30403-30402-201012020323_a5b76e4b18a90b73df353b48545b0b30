package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog, IProductDataListener
   {
      ...
      private var var_338:CatalogViewer;
      ...
      private var var_2531:Boolean = true;
      
      private var var_2532:Boolean = true;
      
      private var var_1804:Boolean = false;
      
      private var var_2533:GiftWrappingConfiguration;
      
      private var var_1118:ClubGiftController;
      
      private var var_489:ClubBuyController;
      ...
      public function showPurchaseConfirmation(param1:IPurchasableOffer, param2:int, param3:String = "") : void
      {
         ...
         {
            this.var_489.showConfirmation(param1 as ClubBuyOfferData,param2);
         }
      }
      ...
      {
         return this.var_359.getProductData(param1);
      }
      ...
      public function getFurnitureData(param1:int, param2:String) : IFurnitureData
      {
         ...
         {
            _loc3_ = this.var_359.getFloorItemData(param1);
         }
         if(param2 == ProductTypeEnum.const_77)
         {
            _loc3_ = this.var_359.getWallItemData(param1);
         }
         return _loc3_;
      }
      ...
      private function updatePurse() : void
      {
         ...
         this._localization.registerParameter("catalog.purse.pixelbalance","balance",String(this.var_111.getActivityPointsForType(Purse.const_497)));
         var _loc1_:int = 0;
      ...
      {
         this._toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_115,HabboToolbarIconEnum.CATALOGUE));
      }
      ...
      private function toggleCatalog(param1:Boolean = false) : void
      {
         ...
         if(!this.var_722)
         {
            if(!this.var_359.loadProductData(this))
            {
               return;
            }
            this.init();
      ...
      private function getCurrentLayoutCode() : String
      {
         ...
         return this.var_338.getCurrentLayoutCode();
      }
      ...
      private function createCatalogViewer() : void
      {
         ...
         this.var_338 = new CatalogViewer(this,_loc1_,this._roomEngine);
         this.var_338.habboCatalog = this;
      }
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_87:
               this.var_1804 = param1.session.isPrivateRoom;
               if(this.var_89 != null)
               {
      ...
      private function createClubGiftController() : void
      {
         ...
         {
            this.var_1118 = new ClubGiftController(this);
         }
      }
      ...
      private function createClubBuyController() : void
      {
         if(this.var_489 == null)
         {
            this.var_489 = new ClubBuyController(this);
         }
      }
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         if(this.var_730 && this.var_730 != "")
         {
            this.var_339.openPage(this.var_730);
            this.var_730 = "";
            this.var_908 = -1;
         }
         else if(this.var_908 > -1)
         {
            this.var_339.openPageById(this.var_908,this.var_1803);
            this.var_908 = -1;
            this.var_1803 = -1;
            this.var_730 = "";
         }
      ...
      private function onCatalogPage(param1:IMessageEvent) : void
      {
         ...
         this.var_338.showCatalogPage(_loc4_,_loc5_,_loc8_,_loc3_.offers,_loc9_);
      }
      ...
      private function onApproveNameResult(param1:ApproveNameMessageEvent) : void
      {
         ...
         this.var_338.dispatchWidgetEvent(new CatalogWidgetApproveNameResultEvent(_loc2_.result));
      }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2531 && this.var_604 != null)
         {
            this.var_604.playSound(HabboSoundTypesEnum.const_945);
         }
         this.var_2531 = false;
      }
      ...
      private function onActivityPointNotification(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2532 && this.var_604 != null)
         {
            this.var_604.playSound(HabboSoundTypesEnum.const_959);
         }
         this.var_2532 = false;
      }
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         this.var_1118.setInfo(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers,_loc2_.giftData);
      }
      ...
      private function onRentableBotDefinitions(param1:IMessageEvent) : void
      {
         ...
         this.var_338.dispatchWidgetEvent(new RentableBotDefinitionWidgetEvent(_loc2_.rentableBots));
      }
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         this.var_2533 = new GiftWrappingConfiguration(param1);
      }
