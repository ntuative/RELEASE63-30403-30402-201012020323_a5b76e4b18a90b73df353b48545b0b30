package com.sulake.habbo.ui
{
   ...
   public class FurnitureEcotronBoxWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_764,RoomWidgetEcotronBoxOpenMessage.const_671,RoomWidgetEcotronBoxOpenedMessage.const_1398];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_764:
               ...
               break;
            case RoomWidgetEcotronBoxOpenMessage.const_671:
