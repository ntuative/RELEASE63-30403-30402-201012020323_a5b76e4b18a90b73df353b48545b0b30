   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler, IHabboAvatarEditorDataSaver, IAvatarImageListener
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_720,this.onFigureUpdate);
            }
            ...
            {
               this._container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_420,this.onHelpTutorialEvent);
               this._container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_103,this.onHelpTutorialEvent);
            }
            this._container = null;
         }
         ...
         {
            this._container.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_720,this.onFigureUpdate);
            this._container.sessionDataManager.events.addEventListener(SessionCreditBalanceEvent.const_174,this.onCreditBalance);
         }
         this._inventory = this._container.inventory;
         if(this._inventory != null)
         {
            (this._inventory as Component).events.addEventListener(HabboInventoryEffectsEvent.const_890,this.onAvatarEffectsChanged);
            (this._inventory as Component).events.addEventListener(HabboInventoryHabboClubEvent.const_932,this.onHabboClubSubscriptionChanged);
         }
         ...
         if(this._container.habboHelp)
         {
            this._container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_420,this.onHelpTutorialEvent);
            this._container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_103,this.onHelpTutorialEvent);
         }
      ...
      private function setMeMenuToolbarIcon() : void
      {
         ...
         if(this._container.avatarRenderManager != null)
         {
            ...
            if(_loc3_ != this.var_1359)
            {
               ...
               this.var_1782 = _loc1_;
            }
            else
            {
               _loc1_ = this.var_1782;
            }
         }
         ...
         if(_loc2_ != null)
         {
            ...
            {
               _loc8_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_1051,HabboToolbarIconEnum.MEMENU);
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetGetEffectsMessage.const_577);
         ...
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_565);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_625);
         _loc1_.push(RoomWidgetStopEffectMessage.const_569);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1403);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_973);
         _loc1_.push(RoomWidgetToolbarMessage.const_709);
         _loc1_.push(RoomWidgetToolbarMessage.const_659);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_313);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1245);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_988);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_728);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_684);
         ...
         _loc1_.push(RoomWidgetClothingChangeMessage.const_364);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_684:
            ...
            case RoomWidgetDanceMessage.const_703:
               ...
               break;
            case RoomWidgetGetEffectsMessage.const_577:
               if(this._inventory != null)
               {
            ...
            case RoomWidgetSelectEffectMessage.const_777:
               ...
               break;
            case RoomWidgetOpenCatalogMessage.const_625:
               _loc2_ = param1 as RoomWidgetOpenCatalogMessage;
               if(this._catalog != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.const_1015)
               {
                  this._catalog.openCatalogPage(CatalogPageName.const_182,true);
               }
               break;
            case RoomWidgetOpenInventoryMessage.const_565:
               ...
               if(this._inventory != null)
               {
                  ...
                  switch(_loc3_.inventoryType)
                  {
                     case RoomWidgetOpenInventoryMessage.const_889:
                        this._catalog.openCatalogPage(CatalogPageName.const_1446,true);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1080:
            ...
            case RoomWidgetStopEffectMessage.const_569:
            ...
            case RoomWidgetToolbarMessage.const_659:
               ...
               {
                  this._toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_469,HabboToolbarIconEnum.MEMENU,_loc6_.window));
               }
               break;
            case RoomWidgetAvatarEditorMessage.const_313:
            ...
            case RoomWidgetGetSettingsMessage.const_697:
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_360,this._container.soundManager.volume));
               break;
            ...
            case RoomWidgetAvatarEditorMessage.const_582:
               ...
               break;
            case RoomWidgetClothingChangeMessage.const_364:
               this._container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_679));
               break;
            default:
      ...
      private function onAvatarEditorClosed(param1:Event = null) : void
      {
         ...
         this._container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_767));
      }
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_103:
               this._container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_103));
               break;
            case HabboHelpTutorialEvent.const_420:
               this._container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_411));
         }
      }
