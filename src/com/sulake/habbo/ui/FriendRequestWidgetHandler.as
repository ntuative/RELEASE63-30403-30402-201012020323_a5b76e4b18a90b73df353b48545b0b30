package com.sulake.habbo.ui
{
   ...
   public class FriendRequestWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetGetUserLocationMessage.const_609);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_610);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_561);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetGetUserLocationMessage.const_609:
               ...
               break;
            case RoomWidgetFriendRequestMessage.const_610:
               ...
               break;
            case RoomWidgetFriendRequestMessage.const_561:
