package com.sulake.habbo.ui
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler, IPetImageListener, IAvatarImageListener
   {
      ...
      private var var_667:Point = null;
      ...
      public function dispose() : void
      {
         ...
         if(this.var_366 != null)
         {
            ...
            {
               _loc2_ = this.var_366.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      {
         return [RoomWidgetChatMessage.const_807,RoomWidgetChatSelectAvatarMessage.const_702];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_807:
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           if(_loc10_.type == RoomObjectTypeEnum.const_252)
                           {
                              _loc13_ = this.var_365.getValue(_loc16_) as BitmapData;
                           }
                           else
                           {
                              _loc13_ = this.var_366.getValue(_loc16_) as BitmapData;
                           }
                           _loc12_ = uint(this.var_819.getValue(_loc16_));
                           if(_loc13_ == null)
                           {
                              if(this._container.avatarRenderManager != null)
                              {
                                 switch(_loc10_.type)
                                 {
                                    case RoomObjectTypeEnum.const_252:
                                 ...
                                 {
                                    this.var_366.add(_loc16_,_loc13_);
                                 }
                                 if(_loc12_ != 0)
                                 {
                                    this.var_819.add(_loc16_,_loc12_);
                                 }
                                 if(_loc17_ != null)
                                 {
                                    _loc17_.dispose();
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(this.var_667 == null)
            {
               ...
               this.var_440.y = 0;
               this.var_440.z = 0;
               this.var_667 = _loc4_.getScreenPoint(this.var_440);
            ...
            this.var_440.y = 0;
            this.var_440.z = 0;
            _loc8_ = _loc4_.getScreenPoint(this.var_440);
            if(_loc8_ != null)
            {
               ...
               if(_loc8_.x != this.var_667.x || _loc8_.y != this.var_667.y)
               {
                  _loc10_ = PointMath.sub(_loc8_,PointMath.mul(this.var_667,_loc5_));
