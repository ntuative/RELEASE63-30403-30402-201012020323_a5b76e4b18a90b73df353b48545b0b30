package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_500:IKeyExchange;
      
      private var var_919:String;
      
      private var _view:HabboLoginDemoView;
      
      private var var_2576:PseudoRandom;
      ...
      private const const_1539:String = "fuselogin";
      ...
      public function setSSOTicket(param1:String) : void
      {
         ...
         {
            this.var_616 = param1;
            this.var_47.initConnection(HabboConnectionType.const_233);
         }
      }
      ...
      {
         if(this.var_47 && this.var_127 && this.var_20 && this._windowManager)
         {
      ...
      private function componentsAreRunning() : void
      {
         ...
         this.var_616 = this.var_127.getKey("sso.ticket",null);
         this.var_1831 = this.var_127.getKey("flash.client.url","");
         this.var_2578 = this.var_127.getKey("external.variables.txt","");
         if(this.var_213 == null)
         {
            this.var_213 = new HabboHotelView(this._windowManager,assets,Component(context).events);
         }
         if(_loc3_)
         {
            this.var_47.mode = HabboConnectionType.const_106;
            if(this.var_616)
            {
               this.var_47.initConnection(HabboConnectionType.const_233);
            }
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         else
         {
            ...
            {
               this.var_47.mode = HabboConnectionType.const_884;
            }
         }
         this.var_47.initConnection(HabboConnectionType.const_233);
      }
      ...
      private function onConnectionEstablished(param1:Event = null) : void
      {
         ...
         if(_loc2_ != null)
         {
            this.dispatchLoginStepEvent(HabboCommunicationEvent.const_657);
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         this.var_2576 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(this.var_47.mode)
         {
            case HabboConnectionType.const_106:
               ...
               this.var_1395 = _loc4_;
               this.var_213.loadBannerImage(_loc7_ + "?token=" + this.var_1395,this.onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_884:
               this.sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1377:
               this.var_919 = this.generateRandomHexString(30);
               this.var_500 = new DiffieHellman(new BigInteger(this.var_127.getKey("connection.development.prime"),16),new BigInteger(this.var_127.getKey("connection.development.generator"),16));
               this.var_500.init(this.var_919);
               _loc8_ = this.var_500.getPublicKey(10);
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         this.var_500.generateSharedKey(_loc4_,10);
         var _loc5_:String = this.var_500.getSharedKey(16).toUpperCase();
         var _loc6_:RC4_R27 = new RC4_R27(null,null);
         var _loc7_:IEncryption = new RC4_R27(_loc6_,this.var_2576);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         connection.send(new VersionCheckMessageComposer(401,this.var_1831,this.var_2578));
         var machineId:String = "";
         try
         {
            so = SharedObject.getLocal(this.const_1539,"/");
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(this.var_616 != null)
         {
            _loc4_ = new SSOTicketMessageComposer(this.var_616);
            _loc2_.send(_loc4_);
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !this.var_2577)
         {
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,this.var_1395);
         ...
         this.var_500 = new DiffieHellman(_loc10_,_loc11_);
         var _loc13_:int = 10;
         var _loc14_:* = null;
         while(_loc13_ > 0)
         {
            _loc14_ = this.generateRandomHexString(30);
            this.var_500.init(_loc14_);
            _loc15_ = this.var_500.getPublicKey(10);
