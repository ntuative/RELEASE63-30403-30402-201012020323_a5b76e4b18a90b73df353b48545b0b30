package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      private function createWindow() : void
      {
         ...
         this._window = this.var_154.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_137,HabboWindowStyle.const_38,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
         ...
         var _loc7_:SharedObject = SharedObject.getLocal(this.const_1539,"/");
         if(_loc5_ != null)
         {
      ...
      private function windowEventProcessor(param1:WindowEvent = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            _loc6_ = SharedObject.getLocal(this.const_1539,"/");
      ...
      private function initSSOTicket() : void
      {
         ...
         {
            this.var_153.removeEventListener(SSOTicket.const_332,this.onParsedTicketSuccess);
            this.var_153.removeEventListener(SSOTicket.const_299,this.onParsedTicketFailure);
            this.var_153 = null;
         }
         var _loc1_:String = "";
         ...
         this.var_153 = new SSOTicket(this.var_154.assets,_loc2_,_loc1_);
         this.var_153.addEventListener(SSOTicket.const_332,this.onParsedTicketSuccess);
         this.var_153.addEventListener(SSOTicket.const_299,this.onParsedTicketFailure);
      }
      
      private function onParsedTicketSuccess(param1:Event) : void
      {
         Logger.log("Got ticket: " + this.var_153.ticket);
         this.var_154.shockwaveClientUrl = this.var_153.shockwaveClientUrl;
         this.var_154.ssoTicket = this.var_153.ticket;
         this.var_153.removeEventListener(SSOTicket.const_332,this.onParsedTicketSuccess);
         this.var_153.removeEventListener(SSOTicket.const_299,this.onParsedTicketFailure);
         this.var_153 = null;
         dispatchEvent(new Event(const_419));
