package com.sulake.habbo.friendlist
{
   ...
   public class FriendListView
   {
      ...
      private static const const_1532:String = "noconvinfo";
      
      private static const const_1531:String = "messageinput";
      ...
      public function FriendListView(param1:HabboFriendList)
      {
         ...
         this.var_1230 = new FriendListTabsView(this._friendList);
      }
      ...
      private function prepare() : void
      {
         ...
         this.var_786 = IWindowContainer(this.var_17.content.findChildByName("main_content"));
         this.var_240 = IWindowContainer(this.var_17.content.findChildByName("footer"));
         this.var_1230.prepare(this.var_786);
         this.var_17.procedure = this.onWindow;
         this.var_17.content.setParamFlag(HabboWindowParam.const_934,false);
         this.var_17.content.setParamFlag(HabboWindowParam.const_1002,true);
         this.var_17.header.setParamFlag(HabboWindowParam.const_641,false);
         this.var_17.header.setParamFlag(HabboWindowParam.const_587,true);
         this.var_17.content.setParamFlag(HabboWindowParam.const_641,false);
         this.var_17.content.setParamFlag(HabboWindowParam.const_587,true);
         this.var_17.findChildByName("open_edit_ctgs_but").procedure = this.onEditCategoriesButtonClick;
         this.var_1231 = ITextWindow(this.var_17.findChildByName("info_text"));
         this.var_1231.text = "";
      ...
      private function onWindow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = this.var_1533 == -1 ? 0 : int(this.var_17.height - this.var_1533);
         var _loc4_:int = this.var_1532 == -1 ? 0 : int(this.var_17.width - this.var_1532);
      ...
      private function refreshWindowSize() : void
      {
         ...
         this.var_240.width = this._friendList.tabs.windowWidth;
         ...
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_919,this._friendList.tabs.findSelectedTab() != null);
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_641,false);
         ...
         this.var_1533 = this.var_17.height;
         this.var_1532 = this.var_17.width;
