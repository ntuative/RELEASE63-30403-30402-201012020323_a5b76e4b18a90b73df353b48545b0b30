package com.sulake.habbo.friendlist
{
   ...
   public class SearchView implements ITabView, ISearchView
   {
      ...
      private var var_627:ITextFieldWindow;
      ...
      {
         this.var_627 = ITextFieldWindow(param1.findChildByName("search_str"));
         this.var_627.procedure = this.onSearchInput;
         this.var_627.addEventListener(WindowKeyboardEvent.const_146,this.onSearchStrInput);
      ...
      private function refreshShading() : void
      {
         ...
         {
            this.var_53.getListItemAt(_loc1_).color = this._friendList.laf.getRowShadingColor(FriendListTab.const_376,_loc1_ % 2 == 1);
            _loc1_++;
         }
      }
      ...
      private function onSearchStrInput(param1:Event) : void
      {
         ...
         {
            _loc5_ = 25;
            _loc6_ = this.var_627.text;
            if(_loc6_.length > _loc5_)
            {
               this.var_627.text = _loc6_.substring(0,_loc5_);
            }
         }
      }
      ...
      {
         var _loc1_:String = this.var_627.text;
