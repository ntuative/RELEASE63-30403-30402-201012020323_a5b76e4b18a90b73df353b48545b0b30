package com.sulake.habbo.friendlist
{
   ...
   public class FriendsView implements ITabView, IFriendsView
   {
      ...
      private var var_2115:IContainerButtonWindow;
      
      private var var_2116:IContainerButtonWindow;
      ...
      {
         this.var_2115 = this.initButton("open_minimail",this.onMinimailButtonClick,param1);
         this.var_2116 = this.initButton("open_homepage",this.onHomeButtonClick,param1);
         this.var_2118 = this.initButton("room_invite",this.onInviteButtonClick,param1);
         this.var_2117 = this.initButton("remove_friend",this.onRemoveButtonClick,param1);
         this.refreshButtons();
      }
      ...
      {
         this._friendList.tabs.findTab(FriendListTab.const_90).setNewMessageArrived(true);
      }
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:FriendCategory, param4:Friend) : Boolean
      {
         ...
         _loc7_.color = this._friendList.laf.getRowShadingColor(FriendListTab.const_90,_loc5_);
         if(param4 == null)
         {
            param3.view = _loc6_;
      ...
      {
         return this._friendList.laf.getRowShadingColor(FriendListTab.const_90,param1);
      }
      
      private function refreshButtons() : void
      {
         var _loc1_:Array = this._friendList.categories.getSelectedFriends();
         this.setEnabled(this.var_2115,this.isEnableMinimailButton(_loc1_));
         this.setEnabled(this.var_2116,this.isEnableHomeButton(_loc1_));
         this.setEnabled(this.var_2118,this.isEnableInviteButton(_loc1_));
         this.setEnabled(this.var_2117,this.isEnableRemoveButton(_loc1_));
      }
      ...
      private function onFriendClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK || param1.type == WindowMouseEvent.const_302)
         {
            _loc4_ = this._friendList.categories.findFriend(param2.id);
            _loc4_.selected = !_loc4_.selected;
            this.refreshButtons();
            this.refreshList();
            if(param1.type == WindowMouseEvent.const_302 && _loc4_.online)
            {
      ...
      private function refreshPageLink(param1:IWindowContainer, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         _loc6_.color = this._friendList.laf.getRowShadingColor(FriendListTab.const_90,param4);
         _loc6_.visible = true;
      }
