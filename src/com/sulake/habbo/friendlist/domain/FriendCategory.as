package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendCategory implements IDisposable
   {
      ...
      {
         if(this.var_860 >= this.getPageCount())
         {
            this.var_860 = Math.max(0,this.getPageCount() - 1);
         }
      }
      
      public function getPageCount() : int
      {
         return Math.ceil(this.var_204.length / const_375);
      }
      
      public function getStartFriendIndex() : int
      {
         this.checkPageIndex();
         return this.var_860 * const_375;
      }
      
      public function getEndFriendIndex() : int
      {
         this.checkPageIndex();
         return Math.min((this.var_860 + 1) * const_375,this.var_204.length);
      }
