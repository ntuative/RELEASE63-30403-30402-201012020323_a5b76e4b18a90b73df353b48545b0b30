package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      private var var_979:IAvatarRenderManager;
      
      private var var_656:ISessionDataManager;
      
      private var var_2066:FriendListLookAndFeel;
      
      private var var_392:FriendListTabs;
      
      private var _view:FriendListView;
      
      private var var_1537:OpenedToWebPopup;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_532.stop();
            this.var_532.removeEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_532 = null;
         }
         ...
         if(this.var_979)
         {
            this.var_979.release(new IIDAvatarRenderManager());
            this.var_979 = null;
         }
         if(this.var_796)
         {
            this.var_796.release(new IIDHabboNotifications());
            this.var_796 = null;
         }
         if(this._toolbar)
         {
         ...
         if(this.var_656)
         {
            this.var_656.release(new IIDSessionDataManager());
            this.var_656 = null;
         }
         super.dispose();
      }
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         {
            this.var_1537 = new OpenedToWebPopup(this);
         }
         this.var_1537.show(x,y);
      }
      ...
      public function openFriendList() : void
      {
         ...
         var _loc1_:FriendListTab = this.tabs.findTab(FriendListTab.const_90);
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = this._windowManager.createWindow(param1,"",HabboWindowType.const_267,HabboWindowStyle.const_38,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6) as IBitmapWrapperWindow;
      ...
      {
         var _loc2_:IAvatarImage = this.var_979.createAvatarImage(param1,AvatarScaleType.const_86,null,this);
         if(!_loc2_)
         {
            return null;
         }
      ...
      private function onAvatarRenderedReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_979 = param2 as IAvatarRenderManager;
      ...
      {
         this.var_796 = param2 as IHabboNotifications;
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         this.var_91.addCategory(new FriendCategory(FriendCategory.const_1008,this.getText("friendlist.friends")));
         this.var_91.addCategory(new FriendCategory(FriendCategory.const_350,this.getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in this.getSortedFriends(_loc2_.friends))
         {
            this.var_91.addFriend(new Friend(_loc4_));
         }
         this.var_392 = new FriendListTabs(new FriendListTabsDeps(this));
         if(!this.var_532)
         {
            this.var_532 = new Timer(120000);
            this.var_532.addEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_532.start();
         }
         this.getBuddyRequests();
         this.registerListeners();
         this._toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_115,HabboToolbarIconEnum.FRIENDLIST));
         ...
         {
            _loc5_ = this.var_91.findCategory(FriendCategory.const_350);
            if(_loc5_)
            {
               _loc5_.setOpen(true);
            }
      ...
      private function toggleWindow() : void
      {
         ...
         {
            this._view.openFriendList();
            _loc1_ = this.var_392.findSelectedTab();
            if(_loc1_ == null)
            {
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_392.findTab(FriendListTab.const_93).setNewMessageArrived(true);
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:FriendListTab = this.var_392.findTab(FriendListTab.const_93);
      ...
      {
         var _loc2_:FriendListTab = this.var_392.findTab(FriendListTab.const_93);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         if(!this.var_656 || !this.var_308)
         {
            return;
         }
         var _loc2_:int = 0;
         if(this.var_656.hasUserRight("fuse_super_extended_buddylist"))
         {
            _loc2_ = this.var_308.vipLimit;
         }
         else if(this.var_656.hasUserRight("fuse_extended_buddylist"))
         {
