package com.sulake.habbo.quest
{
   ...
   public class QuestController implements IDisposable
   {
      ...
      private var var_297:QuestCampaign;
      ...
      {
         return this.var_297 != null && this.var_297.isVisible();
      }
      ...
      {
         var _loc3_:QuestCampaign = this.var_639[param1];
         if(_loc3_)
         {
      ...
      {
         var _loc4_:QuestCampaign = this.var_639[param1];
         if(!_loc4_)
         {
         ...
         this.var_297 = _loc4_;
         this.var_297.openCampaign(param3);
      }
