package com.sulake.habbo.quest
{
   ...
   public class QuestCompleted implements IDisposable
   {
      ...
      {
         this.var_205 = IFrameWindow(this.var_70.controller.questEngine.getXmlWindow("QuestCompletedDialog"));
         ...
         this.var_205.findChildByName("description").caption = this.var_70.controller.questEngine.localization.getKey(_loc4_ + ".completed.desc");
         this.var_205.findChildByName("reward.currency.desc").caption = this.var_70.controller.questEngine.localization.getKey(_loc3_ + ".completed.currency");
