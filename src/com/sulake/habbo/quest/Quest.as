package com.sulake.habbo.quest
{
   ...
   public class Quest implements IDisposable
   {
      ...
      private var var_1722:Date;
      
      private var _localizationCode:String;
      
      private var var_186:Boolean = false;
      
      private var var_2376:uint = 2;
      
      private var var_2377:uint = 0;
      ...
      {
         this.var_346 = param1.status;
         this._type = param1.type;
         this.var_1759 = param1.roomItemTypeName;
         this.var_1757 = param1.rewardCurrencyAmount;
         this.var_1722 = new Date();
         this.var_1722.setTime(param1.endDateTimeStamp);
      ...
      private function itemGridEventProc(param1:Event, param2:IWindow = null) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            if(!this.var_186)
            {
               this.var_855.style = this.var_2377;
            }
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            if(!this.var_186)
            {
               this.var_855.style = this.var_2376;
            }
         }
      }
