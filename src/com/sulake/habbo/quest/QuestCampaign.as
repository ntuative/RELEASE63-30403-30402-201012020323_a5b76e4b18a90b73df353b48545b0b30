package com.sulake.habbo.quest
{
   ...
   public class QuestCampaign implements IDisposable
   {
      ...
      public function QuestCampaign(param1:QuestController, param2:String, param3:int)
      {
         ...
         this.var_151 = new QuestHelp(this);
      }
      ...
      private function prepareWindow() : void
      {
         ...
         this._window.center();
         this.var_1121 = this._window.findChildByName("quest.container") as IWindowContainer;
         this.var_1380 = this._window.findChildByName("currency.container") as IWindowContainer;
         this.var_282 = this._window.findChildByName("quests") as IItemListWindow;
         var _loc1_:* = "icon_" + this.id + "_pixeltype";
         var _loc2_:IBitmapWrapperWindow = this.var_1380.findChildByName("currency.icon") as IBitmapWrapperWindow;
         this._controller.questEngine.setImageFromAsset(_loc2_,_loc1_,this.onPreviewImageReady);
         this.var_1380.findChildByName("currency.amount").caption = "${quest_" + this.id + ".currency}";
         ...
         this.var_1122 = this._window.findChildByName("help.button") as IWindowContainer;
         if(this.var_1122)
         {
            this.var_1122.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.helpButtonEventProc);
            this.var_1122.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER,this.helpButtonEventProc);
            this.var_1122.addEventListener(WindowMouseEvent.const_25,this.helpButtonEventProc);
         }
      }
      ...
      private function openHelp() : void
      {
         ...
         if(this.var_490)
         {
            this.var_490.selected = false;
         }
         if(this.var_151)
         {
            this.var_1121.addChild(this.var_151.view);
         }
      }
      
      public function updatePurse() : void
      {
         var _loc1_:int = this._controller.questEngine.getActivityPointsForType(this.var_1565);
      ...
      private function onPreviewImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc3_ = this.var_1380.findChildByName("currency.icon") as IBitmapWrapperWindow;
      ...
      public function openCampaign(param1:Array) : void
      {
         ...
         for each(_loc4_ in this.var_340)
         {
            ...
            if(!_loc3_ && (_loc4_.status == QuestStatusEnum.const_41 || _loc4_.status == QuestStatusEnum.const_503))
            {
               _loc3_ = _loc4_;
            }
         }
      ...
      public function activateListItem(param1:Quest) : void
      {
         ...
         this.var_490 = param1;
         this.var_490.selected = true;
         this.showQuestData(this.var_490);
      }
      ...
      private function showQuestData(param1:Quest) : void
      {
         ...
         this.var_1121.addChild(this.var_283.view);
         this.var_283.init();
      }
