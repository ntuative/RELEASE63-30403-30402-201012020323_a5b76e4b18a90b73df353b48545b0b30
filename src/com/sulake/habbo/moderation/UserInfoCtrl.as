package com.sulake.habbo.moderation
{
   ...
   public class UserInfoCtrl implements IDisposable
   {
      ...
      private static const const_859:int = 60;
      
      private static const const_860:int = 3600;
      
      private static const const_858:int = 86400;
      
      private static const const_857:int = 31536000;
      ...
      public function UserInfoCtrl(param1:IFrameWindow, param2:ModerationManager, param3:String, param4:Boolean = false)
      {
         ...
         this.var_45 = param2;
         this.var_1191 = param3;
         this.var_1058 = param4;
      }
      
      public static function formatTime(param1:int) : String
      {
         if(param1 < 2 * const_859)
         {
            return param1 + " secs ago";
         }
         if(param1 < 2 * const_860)
         {
            return Math.round(param1 / const_859) + " mins ago";
         }
         if(param1 < 2 * const_858)
         {
            return Math.round(param1 / const_860) + " hours ago";
         }
         if(param1 < 2 * const_857)
         {
            return Math.round(param1 / const_858) + " days ago";
         }
         return Math.round(param1 / const_857) + " years ago";
      }
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_45.windowTracker.show(new ChatlogCtrl(new GetUserChatlogMessageComposer(this._data.userId),this.var_45,WindowTracker.const_1029,this._data.userId),this._callerFrame,this.var_1058,false,true);
      }
      ...
      private function onRoomVisitsButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_45.windowTracker.show(new RoomVisitsCtrl(this.var_45,this._data.userId),this._callerFrame,this.var_1058,false,true);
      }
      ...
      private function onMessageButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_45.windowTracker.show(new SendMsgsCtrl(this.var_45,this._data.userId,this._data.userName,this.var_1191),this._callerFrame,this.var_1058,false,true);
      }
      ...
      private function onModActionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_45.windowTracker.show(new ModActionCtrl(this.var_45,this._data.userId,this._data.userName,this.var_1191),this._callerFrame,this.var_1058,false,true);
      }
