package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private const const_1814:String = "my_issues";
      
      private const const_1813:String = "open_issues";
      
      private const const_1812:String = "picked_issues";
      
      private const const_1831:String = "closed_issues";
      ...
      private var var_309:IIssueBrowserView;
      
      private var var_1541:IIssueBrowserView;
      
      private var var_1540:IIssueBrowserView;
      
      private var var_1542:PickedIssuesView;
      ...
      private function selectView(param1:String) : void
      {
         ...
         this.var_309.view.width = this.var_223.container.width;
         this.var_309.view.height = this.var_223.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case this.const_1814:
               ...
               {
                  this.var_1541 = new MyIssuesView(this.issueManager,this,this.var_223.container);
               }
               return this.var_1541;
            case this.const_1813:
               if(this.var_1540 == null)
               {
                  this.var_1540 = new OpenIssuesView(this.issueManager,this,this.var_223.container);
               }
               return this.var_1540;
            case this.const_1812:
               if(this.var_1542 == null)
               {
                  this.var_1542 = new PickedIssuesView(this.issueManager,this,this.var_223.container);
               }
