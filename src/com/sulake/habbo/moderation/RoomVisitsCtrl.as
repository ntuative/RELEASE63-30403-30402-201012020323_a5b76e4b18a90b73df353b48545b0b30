package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_2420:IWindowContainer;
      ...
      {
         this.var_2420 = IWindowContainer(this.var_45.getXmlWindow("roomvisits_row"));
      ...
      {
         var _loc3_:IWindowContainer = IWindowContainer(this.var_2420.clone());
