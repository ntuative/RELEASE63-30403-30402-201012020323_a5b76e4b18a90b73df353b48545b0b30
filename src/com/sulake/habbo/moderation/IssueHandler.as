package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private var var_1024:UserInfoCtrl;
      ...
      private function createView() : void
      {
         ...
         this.setProc("close_abusive",this.method_4);
         ...
         this.var_454 = new UserInfoCtrl(this._window,this.var_61,_loc3_.message);
         this.var_1024 = new UserInfoCtrl(this._window,this.var_61,_loc3_.message);
         this.var_454.load(IWindowContainer(this._window.findChildByName("caller_user_info")),this.var_121.getHighestPriorityIssue().reporterUserId);
         ...
         {
            this.var_1024.load(_loc4_,this.var_121.reportedUserId);
         }
         else
         {
      ...
      {
         if(this.var_61 != null && this.var_61.issueManager != null && this.var_121 != null)
         {
            this.var_61.issueManager.removeHandler(this.var_121.id);
         }
         this.dispose();
      }
      ...
      private function onCloseUseless(param1:WindowMouseEvent) : void
      {
         ...
         this.var_61.issueManager.closeBundle(this.var_121.id,1);
      ...
      private function method_4(param1:WindowMouseEvent) : void
      {
         ...
         this.var_61.issueManager.closeBundle(this.var_121.id,2);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onCloseResolved(param1:WindowMouseEvent) : void
      {
         ...
         this.var_61.issueManager.closeBundle(this.var_121.id,3);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onRelease(param1:WindowMouseEvent) : void
      {
         ...
         this.var_61.issueManager.releaseBundle(this.var_121.id);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         this.var_61.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_),this.var_61,WindowTracker.const_1067,_loc2_),this._window,false,false,true);
      }
