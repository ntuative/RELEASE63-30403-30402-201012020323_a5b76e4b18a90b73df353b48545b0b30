package com.sulake.habbo.navigator.inroom
{
   ...
   public class RoomEventViewCtrl
   {
      ...
      private var var_1643:ITextWindow;
      
      private var var_1645:ITextWindow;
      
      private var var_1280:IButtonWindow;
      
      private var var_1282:IButtonWindow;
      
      private var var_2243:IButtonWindow;
      
      private var var_1281:IButtonWindow;
      
      private var var_844:IDropMenuWindow;
      ...
      private function editEvent(param1:RoomEventData) : void
      {
         ...
         this.var_1644.visible = true;
         this.var_2244.text = this._navigator.getText("roomevent_type_" + param1.eventType);
         this._eventNameInput.setText(param1.eventName);
         this.var_686.setText(param1.eventDescription);
         this.var_845.setText(this.getTagFromEvent(param1,1));
         this.var_846.setText(this.getTagFromEvent(param1,2));
      ...
      {
         var _loc1_:int = this.var_844.selection;
         return _loc1_ + 1;
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         if(this._window == null)
         {
            ...
            this.var_1644 = IWindowContainer(this.find("event_type_disabled_cont"));
            this.var_2244 = ITextWindow(this.find("event_type_disabled_text"));
            this.var_1643 = ITextWindow(this.find("create_caption"));
            this.var_1645 = ITextWindow(this.find("edit_caption"));
            this.var_1280 = IButtonWindow(this.find("create_button"));
            this.var_1282 = IButtonWindow(this.find("edit_button"));
            this.var_2243 = IButtonWindow(this.find("cancel_button"));
            this.var_1281 = IButtonWindow(this.find("end_button"));
            this.var_844 = IDropMenuWindow(this.find("event_type"));
            this.prepareEventTypes();
            Util.setProcDirectly(this.var_1280,this.onCreateButtonClick);
            Util.setProcDirectly(this.var_1282,this.onEditButtonClick);
            Util.setProcDirectly(this.var_1281,this.onEndButtonClick);
            Util.setProcDirectly(this.var_2243,this.onCancelButtonClick);
            ...
            this.var_845 = new TextFieldManager(this._navigator,this.getInput("event_tag_1"),25);
            this.var_846 = new TextFieldManager(this._navigator,this.getInput("event_tag_2"),25);
