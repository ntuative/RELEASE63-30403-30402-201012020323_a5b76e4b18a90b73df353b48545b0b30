package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_605:RoomInfoViewCtrl;
      
      private var var_1120:RoomCreateViewCtrl;
      ...
      private var var_2670:Dictionary;
      ...
      private var var_2407:RoomThumbnailRenderer;
      
      private var var_910:GuestRoomPasswordInput;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_605 = new RoomInfoViewCtrl(this);
         this.var_1120 = new RoomCreateViewCtrl(this);
         this.var_2407 = new RoomThumbnailRenderer(this);
         this.var_910 = new GuestRoomPasswordInput(this);
         this.var_316 = new GuestRoomDoorbell(this);
         this.var_392 = new Tabs(this);
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = IBitmapWrapperWindow(this._windowManager.createWindow(param1,"",HabboWindowType.const_267,HabboWindowStyle.const_38,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6));
      ...
      private function onToolbarReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_605.registerToolbarEvents();
      }
      ...
      private function setHabboToolbarIcon() : void
      {
         ...
         {
            this._toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_115,HabboToolbarIconEnum.NAVIGATOR));
            if(this._data != null && this._data.homeRoomId > 0)
            {
               this._toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_115,HabboToolbarIconEnum.EXITROOM));
            }
         }
      }
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         this.var_279.startSearch(Tabs.const_200,Tabs.const_366,param1);
      ...
      public function showOwnRooms() : void
      {
         ...
         this.var_279.startSearch(Tabs.const_303,Tabs.const_218);
         this.var_392.getTab(Tabs.const_303).tabPageDecorator.tabSelected();
      }
