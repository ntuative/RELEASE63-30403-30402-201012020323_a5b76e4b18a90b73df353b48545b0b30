package com.sulake.habbo.navigator
{
   ...
   public class TextFieldManager
   {
      ...
      public function TextFieldManager(param1:HabboNavigator, param2:ITextFieldWindow, param3:int = 1000, param4:Function = null, param5:String = null)
      {
         ...
         this.var_69.addEventListener(WindowKeyboardEvent.const_146,this.checkEnterPress);
         this.var_69.addEventListener(WindowEvent.const_109,this.checkMaxLen);
         this.var_2071 = this.var_69.textBackground;
         this._orgTextBackgroundColor = this.var_69.textBackgroundColor;
         this.var_2070 = this.var_69.textColor;
      }
      ...
      {
         this.var_69.textBackground = this.var_2071;
         this.var_69.textBackgroundColor = this._orgTextBackgroundColor;
         this.var_69.textColor = this.var_2070;
      }
      ...
      public function displayError(param1:String) : void
      {
         ...
         if(this.var_116 == null)
         {
            ...
            IWindowContainer(this.var_69.parent).addChild(this.var_116);
         }
         ...
         this.var_116.x += (this.var_69.width - this.var_116.width) / 2;
      ...
      public function goBackToInitialState() : void
      {
         ...
         {
            this.var_69.text = this.var_1231;
            this.var_533 = true;
         }
         else
         {
      ...
      {
         return !this.var_533 && Util.trim(this.getText()).length > 2;
      }
      ...
      private function onInputClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_69.text = this.var_2069;
         this.var_533 = false;
         this.restoreBackground();
      }
      ...
      private function checkMaxLen(param1:Event) : void
      {
         ...
         if(_loc2_.length > this.var_1538)
         {
            this.var_69.text = _loc2_.substring(0,this.var_1538);
         }
      }
   }
}
