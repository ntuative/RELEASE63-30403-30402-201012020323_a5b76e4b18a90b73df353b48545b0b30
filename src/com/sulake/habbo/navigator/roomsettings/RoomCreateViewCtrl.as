package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var var_1033:RoomLayout;
      ...
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         ...
         this.var_556 = new Timer(100);
         this.var_556.addEventListener(TimerEvent.TIMER,this.updateArrowPos);
      ...
      public function dispose() : void
      {
         if(this.var_556)
         {
            this.var_556.removeEventListener(TimerEvent.TIMER,this.updateArrowPos);
            this.var_556.reset();
            this.var_556 = null;
         }
      }
      ...
      {
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(this.var_1033.view.findChildByName("select_arrow"));
      ...
      private function prepare() : void
      {
         ...
         this.var_53 = IItemListWindow(this.var_158.findChildByName("item_list"));
         ...
         this.var_1032 = new TextFieldManager(this._navigator,ITextFieldWindow(this.var_158.findChildByName("room_name_input")),25,null,this._navigator.getText("navigator.createroom.roomnameinfo"));
      ...
      {
         this.var_1032.goBackToInitialState();
         this.var_1032.input.textBackgroundColor = 4294967295;
         this.var_1033 = this.var_37[0];
         this.refreshRoomThumbnails();
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow("","",HabboWindowType.const_56,HabboWindowStyle.const_35,HabboWindowParam.const_58,new Rectangle(0,0,100,300)));
      }
      
      private function isMandatoryFieldsFilled() : Boolean
      {
         var _loc1_:Boolean = this.var_1032.checkMandatory(this._navigator.getText("navigator.createroom.nameerr"));
      ...
      private function onCreateButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = this.var_1032.getText();
         var _loc4_:String = "model_" + this.var_1033.name;
