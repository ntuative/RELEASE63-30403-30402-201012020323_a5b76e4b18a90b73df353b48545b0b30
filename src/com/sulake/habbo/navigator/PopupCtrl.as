package com.sulake.habbo.navigator
{
   ...
   public class PopupCtrl
   {
      ...
      {
         this.var_377 = new Timer(500,1);
         this.var_318 = new Timer(100,1);
         super();
         this._navigator = param1;
         this.var_1294 = param4;
         this.var_2140 = param2;
         this._popupIndentLeft = param3;
         this.var_377.addEventListener(TimerEvent.TIMER,this.onDisplayTimer);
         this.var_318.addEventListener(TimerEvent.TIMER,this.onHideTimer);
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_377)
         {
            this.var_377.removeEventListener(TimerEvent.TIMER,this.onDisplayTimer);
            this.var_377.reset();
            this.var_377 = null;
         }
         if(this.var_318)
         {
            this.var_318.removeEventListener(TimerEvent.TIMER,this.onHideTimer);
            this.var_318.reset();
            this.var_318 = null;
         }
      }
      ...
      public function showPopup(param1:IWindow) : void
      {
         if(this.var_48 == null)
         {
            this.var_48 = IWindowContainer(this._navigator.getXmlWindow(this.var_1294));
         ...
         this.var_48.x = _loc2_.x + this.var_2140 + param1.width;
