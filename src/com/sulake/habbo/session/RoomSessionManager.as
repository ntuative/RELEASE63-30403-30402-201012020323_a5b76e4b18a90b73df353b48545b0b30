package com.sulake.habbo.session
{
   ...
   public class RoomSessionManager extends Component implements IRoomSessionManager, IRoomHandlerListener
   {
      ...
      private function initializeManager() : void
      {
         ...
         if(this.initialized && this.var_1601)
         {
            this.gotoRoom(this.var_2170,this.var_2169,this.var_1602);
            this.var_1601 = false;
            this.var_1602 = "";
         }
      }
      ...
      public function sessionUpdate(param1:int, param2:int, param3:String) : void
      {
         ...
         if(_loc4_ != null)
         {
            switch(param3)
            {
               case RoomSessionHandler.const_892:
                  break;
               case RoomSessionHandler.const_882:
                  break;
               case RoomSessionHandler.const_591:
