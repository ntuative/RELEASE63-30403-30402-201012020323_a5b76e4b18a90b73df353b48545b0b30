package com.sulake.habbo.session
{
   ...
   public class RoomSession implements IRoomSession
   {
      ...
      private const const_1826:int = 2500;
      ...
      public function RoomSession(param1:int, param2:int, param3:IHabboTracking, param4:String = "", param5:String = "")
      {
         ...
         this.var_1089 = new UserDataManager();
      }
      ...
      public function set connection(param1:IConnection) : void
      {
         ...
         {
            this.var_1089.connection = param1;
         }
      }
      ...
      {
         this._connection.send(new ChatMessageComposer(param1,this.var_1344));
         this.var_1345.add(this.var_1344,getTimer());
         ++this.var_1344;
      }
      ...
      public function receivedChatWithTrackingId(param1:int) : void
      {
         ...
         if(_loc2_ != null)
         {
            if(getTimer() - int(_loc2_) > this.const_1826)
            {
      ...
      {
         return this.var_1089 as IUserDataManager;
      }
