package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneMaterialCellMatrix
   {
      ...
      public static const const_1483:int = const_370;
      ...
      public static const const_282:int = const_113;
      ...
      public function PlaneMaterialCellMatrix(param1:int, param2:int = 1, param3:int = 1, param4:Number = -1.0, param5:Number = 1.0, param6:Number = -1.0, param7:Number = 1.0)
      {
         ...
         this.var_2062 = param7;
         this.var_629 = new Vector3d();
      ...
      public function clearCache() : void
      {
         ...
         if(this.var_629 != null)
         {
            this.var_629.assign(new Vector3d());
         }
         this.var_583 = 0;
         var _loc1_:int = 0;
      ...
      public function render(param1:BitmapData, param2:int, param3:int, param4:IVector3d, param5:Boolean, param6:int, param7:Boolean) : BitmapData
      {
         ...
         if(this.isStatic)
         {
            if(this.var_29 != null)
            {
               if(this.var_29.width == param2 && this.var_29.height == param3 && Vector3d.isEqual(this.var_629,param4))
               {
                  if(param1 != null)
                  {
      ...
      private function copyCachedBitmapOnCanvas(param1:BitmapData, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         var _loc5_:* = null;
         if(this.var_1731 == const_113)
         {
            _loc5_ = new Rectangle(0,0,this.var_29.width,this.var_583);
         }
         else
         {
            _loc5_ = new Rectangle(0,this.var_29.height - this.var_583,this.var_29.width,this.var_583);
         }
