package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualizationData implements IRoomObjectVisualizationData
   {
      ...
      private var var_736:WallAdRasterizer;
      
      private var var_495:LandscapeRasterizer;
      
      private var var_737:PlaneMaskManager;
      ...
      {
         super();
         this.var_493 = new WallRasterizer();
         this.var_494 = new FloorRasterizer();
         this.var_736 = new WallAdRasterizer();
         this.var_495 = new LandscapeRasterizer();
         this.var_737 = new PlaneMaskManager();
      }
      ...
      public function initialize(param1:XML) : Boolean
      {
         ...
         {
            _loc7_ = _loc2_[0];
            this.var_493.initialize(_loc7_);
         }
         ...
         {
            _loc9_ = _loc4_[0];
            this.var_736.initialize(_loc9_);
         }
         ...
         {
            _loc11_ = _loc6_[0];
            this.var_737.initialize(_loc11_);
         }
         return true;
      }
      ...
      public function initializeAssetCollection(param1:IGraphicAssetCollection) : void
      {
         ...
         this.var_736.initializeAssetCollection(param1);
         this.var_495.initializeAssetCollection(param1);
         this.var_737.initializeAssetCollection(param1);
         this.var_722 = true;
      }
