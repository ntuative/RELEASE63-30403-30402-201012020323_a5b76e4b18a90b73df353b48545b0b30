package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomPlane
   {
      ...
      private var var_812:IPlaneRasterizer = null;
      
      private var var_737:PlaneMaskManager = null;
      ...
      {
         return this._isVisible && this.var_664;
      }
      ...
      private function getTextureIdentifier(param1:Number) : String
      {
         ...
         {
            return this.var_812.getTextureIdentifier(param1,this.normal);
         }
      ...
      private function needsNewTexture(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         if(this.var_664 && (_loc3_ == null || _loc3_.timeStamp >= 0 && param2 > _loc3_.timeStamp || this.var_313))
         {
            return true;
         }
         return false;
      ...
      private function getTexture(param1:IRoomGeometry, param2:int) : BitmapData
      {
         ...
         if(this.needsNewTexture(param1,param2))
         {
            ...
            if(this.var_812 != null)
            {
               _loc3_ = this.var_812.render(_loc8_,this._id,_loc5_,_loc6_,param1.scale,_loc7_,this.var_1560,this.var_2112,this.var_2109,this.var_2113,this.var_2110,param2);
               if(_loc3_ != null)
               {
      ...
      public function update(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         if(!geometryChanged || !this.var_664)
         {
            if(!this.visible)
            {
               return false;
         ...
         if(geometryChanged)
         {
            ...
            i = 0;
            while(i < this.var_1238.length)
            {
               cosAngle = Vector3d.cosAngle(geometry.directionAxis,this.var_1238[i]);
               if(cosAngle > -0.001)
               {
                  if(this._isVisible)
                  {
            ...
            originPos = geometry.getScreenPosition(this.var_984);
            originZ = originPos.z;
            relativeDepth = Math.max(this.var_139.z - originZ,this.var_103.z - originZ,this.var_81.z - originZ,this.var_102.z - originZ);
            if(this._type == const_94)
            {
               relativeDepth += 0.02;
            }
            this.var_2114 = relativeDepth;
         ...
         if(geometryChanged || this.needsNewTexture(geometry,timeSinceStartMs))
         {
            ...
            Randomizer.setSeed(this.var_2111);
      ...
      public function addRectangleMask(param1:Number, param2:Number, param3:Number, param4:Number) : Boolean
      {
         ...
         if(this.var_813)
         {
            _loc5_ = null;
            _loc6_ = 0;
            while(_loc6_ < this.var_312.length)
            {
               _loc5_ = this.var_312[_loc6_] as RoomPlaneRectangleMask;
               if(_loc5_ != null)
               {
      ...
      private function updateMaskChangeStatus() : void
      {
         ...
         if(this.var_312.length > this.var_1237.length)
         {
            _loc3_ = false;
         }
         if(_loc3_)
      ...
      private function updateMask(param1:BitmapData, param2:IRoomGeometry) : void
      {
         ...
         var _loc13_:int = 0;
         var _loc14_:int = 0;
         if(!this.var_813 || this.var_226.length == 0 && this.var_312.length == 0 && !this.var_313 || this.var_737 == null)
         {
            return;
         }
         ...
         if(this.var_313)
         {
            ...
            while(_loc5_ < this.var_226.length)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc10_ = this.var_64.width - this.var_64.width * _loc3_.leftSideLoc / this.var_281.length;
                  _loc11_ = this.var_64.height - this.var_64.height * _loc3_.rightSideLoc / this.var_280.length;
                  _loc12_ = _loc3_.type;
                  this.var_737.updateMask(this.var_64,_loc12_,param2.scale,_loc9_,_loc10_,_loc11_);
            ...
            while(_loc6_ < this.var_312.length)
            {
               _loc4_ = this.var_312[_loc6_] as RoomPlaneRectangleMask;
               if(_loc4_ != null)
               {
                  _loc10_ = this.var_64.width - this.var_64.width * _loc4_.leftSideLoc / this.var_281.length;
                  _loc11_ = this.var_64.height - this.var_64.height * _loc4_.rightSideLoc / this.var_280.length;
                  _loc13_ = this.var_64.width * _loc4_.leftSideLength / this.var_281.length;
                  _loc14_ = this.var_64.height * _loc4_.rightSideLength / this.var_280.length;
                  this.var_64.fillRect(new Rectangle(_loc10_ - _loc13_,_loc11_ - _loc14_,_loc13_,_loc14_),4278190080);
                  this.var_1237.push(new RoomPlaneRectangleMask(_loc4_.leftSideLength,_loc4_.rightSideLoc,_loc4_.leftSideLength,_loc4_.rightSideLength));
               }
               _loc6_++;
            }
            this.var_313 = false;
      ...
      private function combineTextureMask(param1:BitmapData, param2:BitmapData) : void
      {
         ...
         if(this.var_193 != null && (this.var_193.width != param1.width || this.var_193.height != param1.height))
         {
            this.var_193.dispose();
            this.var_193 = null;
         }
         if(this.var_193 == null)
         {
            this.var_193 = new BitmapData(param1.width,param1.height,true,4294967295);
         }
         this.var_193.copyChannel(param1,param1.rect,new Point(0,0),BitmapDataChannel.ALPHA,BitmapDataChannel.RED);
         this.var_193.draw(param2,null,null,BlendMode.DARKEN);
         param1.copyChannel(this.var_193,this.var_193.rect,new Point(0,0),BitmapDataChannel.RED,BitmapDataChannel.ALPHA);
      }
   }
}
