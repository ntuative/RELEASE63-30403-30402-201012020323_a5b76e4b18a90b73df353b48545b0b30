package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class PetVisualization extends RoomObjectSpriteVisualization implements IPetImageListener
   {
      ...
      private var var_567:PetVisualizationData = null;
      ...
      private var var_1599:Number = NaN;
      ...
      {
         this.var_567 = param1 as PetVisualizationData;
         createSprites(this.const_1157);
         this.var_370 = new ExperienceData(this.var_567);
         return true;
      }
      ...
      private function updateModel(param1:IRoomObjectModel, param2:Number) : Boolean
      {
         ...
         {
            this.var_1691 = param1.getNumber(RoomObjectVariableEnum.const_402) > 0;
            this.var_1256 = param1.getString(RoomObjectVariableEnum.const_280);
            this.var_235 = param1.getString(RoomObjectVariableEnum.const_471);
            this._postureParameter = param1.getString(RoomObjectVariableEnum.const_568);
            this.var_1599 = param1.getNumber(RoomObjectVariableEnum.const_334);
            this.var_1255 = param1.getNumber(RoomObjectVariableEnum.const_1075);
            this.var_1989 = param1.getNumber(RoomObjectVariableEnum.const_1102);
            this.validateActions();
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_175);
            if(this.var_586 != _loc3_)
            {
               this.var_586 = _loc3_;
      ...
      private function updateObject(param1:IRoomObject, param2:IRoomGeometry, param3:Boolean = false) : Boolean
      {
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         if(param3 || var_408 != param1.getUpdateID() || this.var_1772 != param2.updateId)
         {
            _loc4_ = param1.getDirection().x - param2.direction.x;
            _loc4_ = (_loc4_ % 360 + 360) % 360;
            _loc5_ = this.var_1599;
            if(isNaN(this.var_1599))
            {
               _loc5_ = _loc4_;
            }
            else
            ...
            if(_loc4_ != this.var_1693 || param3)
            {
            ...
            if(_loc5_ != this.var_1692 || param3)
            {
               this.var_1692 = _loc5_;
               _loc5_ -= 112.5;
               _loc5_ = (_loc5_ + 360) % 360;
               this.var_54.setDirectionAngle(AvatarSetType.const_44,_loc5_);
            }
      ...
      private function getAvatarImage(param1:Number) : IAvatarImage
      {
         ...
         if(_loc3_ == null)
         {
            _loc3_ = this.var_567.getAvatar(this.var_586,param1,this);
            if(_loc3_ != null)
            {
      ...
      private function updateShadow(param1:Number) : void
      {
         ...
         this.var_569 = null;
         _loc2_ = getSprite(this.const_1540);
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         if(param1 < 48)
         {
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean) : void
      {
         ...
         if(_loc9_ || _loc6_ != var_252 || this.var_54 == null)
         {
            if(_loc6_ != var_252)
            {
               var_252 = _loc6_;
         ...
         var _loc11_:Boolean = this.var_851 || this.var_1007 > 0 || this.var_1597;
         this.var_370.alpha = 0;
         if(this.var_1255 > 0)
         {
            _loc12_ = param2 - this.var_1255;
            if(_loc12_ < AvatarAction.const_898)
            {
               this.var_370.alpha = int(Math.sin(_loc12_ / 0 * 0) * 255);
               this.var_370.setExperience(this.var_1989);
               this.var_1007 = this.const_1817;
            }
            else
            {
               this.var_1255 = 0;
            }
            _loc13_ = getSprite(this.const_1548);
            if(_loc13_ != null)
            {
               if(this.var_370.alpha > 0)
               {
                  _loc13_.asset = this.var_370.image;
                  _loc13_.offsetX = -20;
                  _loc13_.offsetY = -80;
                  _loc13_.alpha = this.var_370.alpha;
      ...
      private function updateActions(param1:IAvatarImage) : void
      {
         ...
         if(this.var_1256 != null && this.var_1256 != "")
         {
            param1.appendAction(AvatarAction.const_287,this.var_1256);
         }
         ...
         var _loc2_:int = param1.getSprites().length + this.const_1157;
