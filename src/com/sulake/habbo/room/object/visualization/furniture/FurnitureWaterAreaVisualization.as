package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureWaterAreaVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1182:String = "shore";
      ...
      {
         if(this.var_2278 == param1 && this.var_2277 == _direction)
         {
         ...
         while(_loc2_ >= 0)
         {
            if(getSpriteTag(_loc2_,_direction,param1) == const_1182)
            {
               this.var_1663 = _loc2_;
               this.var_2278 = param1;
               this.var_2277 = _direction;
               return this.var_1663;
            }
            _loc2_--;
         }
      ...
      {
         var _loc2_:* = null;
         if(this.var_457 == 0 || this.var_558 == 0)
         {
            ...
            this.var_457 = _loc2_.getNumber(RoomObjectVariableEnum.const_270);
            this.var_558 = _loc2_.getNumber(RoomObjectVariableEnum.const_340);
         }
         this.var_384 = [];
         this.var_557 = [];
         var _loc1_:int = 0;
         while(_loc1_ < this.var_457 * 2 + this.var_558 * 2)
         {
            this.var_384.push(false);
            this.var_557.push(ShoreMaskCreatorUtility.const_69);
            _loc1_++;
         }
      }
      ...
      private function createShoreMask(param1:int, param2:int, param3:Number) : BitmapData
      {
         ...
         return ShoreMaskCreatorUtility.createShoreMask2x2(this.var_64,getSize(param3),this.var_384,this.var_557,assetCollection);
      }
