package com.sulake.habbo.room.object.visualization.furniture.data
{
   ...
   public class SizeData
   {
      ...
      private var var_968:DirectionData = null;
      ...
      private function defineDirection(param1:DirectionData, param2:XMLList) : Boolean
      {
         ...
         },_loc5_++)
         {
            ...
            {
               case "ADD":
                  param1.setInk(_loc7_,LayerData.const_1022);
                  break;
               case "SUBTRACT":
                  param1.setInk(_loc7_,LayerData.const_1054);
                  break;
               case "DARKEN":
      ...
      public function getDirectionValue(param1:int) : int
      {
         var _loc6_:int = 0;
         var _loc7_:int = 0;
         var _loc2_:int = (param1 % 360 + 360 + this.var_1225 / 2) % 360 / this.var_1225;
         ...
         {
            _loc6_ = int(this.var_221.getKey(_loc5_)) * this.var_1225;
