package com.sulake.habbo.room.object.visualization.furniture.data
{
   public class AnimationFrameSequenceData
   {
      ...
      {
         return this.var_371.length * this._loopCount;
      }
      ...
      public function initialize() : void
      {
         var _loc1_:int = 1;
         var _loc2_:int = -1;
         var _loc3_:int = this.var_371.length - 1;
         while(_loc3_ >= 0)
         {
            if(this.var_371[_loc3_] == _loc2_)
            {
               _loc1_++;
            }
            else
            {
               _loc2_ = this.var_371[_loc3_];
               _loc1_ = 1;
            }
            this.var_880[_loc3_] = _loc1_;
            _loc3_--;
         }
      }
      ...
      public function addFrame(param1:int, param2:int, param3:int, param4:int, param5:int) : void
      {
         ...
         this.var_371.push(this._frames.length - 1);
         this.var_880.push(1);
      }
      ...
      public function getFrame(param1:int) : AnimationFrameData
      {
         ...
         if(this.var_1514)
         {
            param1 = Math.random() * this.var_371.length;
            if(param1 == this.var_371.length)
            {
               param1--;
            }
         }
         param1 = this.var_371[param1 % this.var_371.length];
      ...
      public function getRepeats(param1:int) : int
      {
         ...
         return this.var_880[param1 % this.var_880.length];
      }
   }
}
