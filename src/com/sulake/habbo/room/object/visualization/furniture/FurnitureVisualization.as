package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureVisualization extends RoomObjectSpriteVisualization
   {
      ...
      protected static const const_1510:Number = Math.sqrt(0.5);
       
      
      protected var _direction:int;
      
      protected var var_2584:Number = NaN;
      
      protected var var_2585:int = -1;
      
      protected var _alphaMultiplier:Number = 1.0;
      
      protected var var_1153:String = null;
      ...
      private var var_1947:Number = 0.0;
      ...
      protected function updateSprites(param1:int, param2:Boolean, param3:Array) : void
      {
         var _loc5_:int = 0;
         var _loc6_:int = 0;
         if(this.var_1473 != spriteCount)
         {
            createSprites(this.var_1473);
         }
         var _loc4_:Boolean = false;
         ...
         if(_loc5_ != null)
         {
            ...
            if(_loc6_ != null && _loc6_.asset != null)
            {
               ...
               if(param1 < spriteCount - 1)
               {
                  ...
                  _loc5_.color = this.getSpriteColor(param1,this.var_2585,param2);
      ...
      protected function getBlendMode(param1:int) : String
      {
         ...
         switch(param1)
         {
            case LayerData.const_1022:
               _loc2_ = "null";
               break;
            case LayerData.INK_DARKEN:
               _loc2_ = "null";
               break;
            case LayerData.const_1054:
               _loc2_ = "null";
         }
         return _loc2_;
      }
      ...
      protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(var_408 != _loc3_.getUpdateID() || param1 != var_252 || param2 != this.var_2584)
         {
      ...
      protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            this.var_2585 = _loc3_.getNumber(RoomObjectVariableEnum.const_249);
            _loc4_ = Number(_loc3_.getNumber(RoomObjectVariableEnum.const_272));
            if(isNaN(_loc4_))
            {
               _loc4_ = 1;
            }
            ...
            this.var_1153 = _loc3_.getString(RoomObjectVariableEnum.const_337);
      ...
      {
         if(this.var_1946 != param1 || this.var_1947 != param2)
         {
            this.var_781 = [];
            this.var_782 = [];
            this.var_638 = [];
            ...
            this.var_1473 = this._data.getLayerCount(param2) + 1;
         }
      }
      ...
      protected function getSpriteAssetName(param1:int, param2:Number) : String
      {
         ...
         var _loc6_:* = null;
         var _loc7_:int = 0;
         if(this._data == null || param1 >= FurnitureVisualizationData.const_900.length)
         {
            return "";
         }
         var _loc3_:String = this.var_781[param1];
         var _loc4_:Boolean = this.var_782[param1];
         if(_loc3_ == null || _loc3_.length == 0)
         {
            ...
            if(param1 < spriteCount - 1)
            {
               ...
               _loc6_ = FurnitureVisualizationData.const_900[param1];
            }
            else
            {
               _loc6_ = "sd";
      ...
      {
         if(this.var_633[param1] != null && !this.var_1474)
         {
      ...
      {
         if(this.var_636[param1] != null)
         {
            return this.var_636[param1];
         }
         if(this._data == null)
         {
