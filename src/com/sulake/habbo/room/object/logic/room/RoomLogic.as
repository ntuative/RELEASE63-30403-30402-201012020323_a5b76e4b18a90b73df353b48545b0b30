package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1306:uint = 16777215;
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_952,param1.toString(),true);
            _loc2_.setNumber(RoomObjectVariableEnum.const_752,16777215);
            _loc2_.setNumber(RoomObjectVariableEnum.const_791,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_632,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_622,1);
         }
      }
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(this.var_1049)
         {
            ...
            if(_loc2_ - this.var_1049 >= this.var_1703)
            {
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_752,_loc3_);
         }
      }
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            ...
            case RoomObjectRoomUpdateMessage.const_787:
               param2.setString(RoomObjectVariableEnum.const_699,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_749:
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomMaskUpdateMessage.const_430:
               _loc5_ = "null";
               if(param1.maskCategory == RoomObjectRoomMaskUpdateMessage.const_229)
               {
                  _loc5_ = "null";
               }
               this.var_436.addMask(param1.maskId,param1.maskType,param1.maskLocation,_loc5_);
               _loc4_ = true;
               break;
            case RoomObjectRoomMaskUpdateMessage.const_631:
               _loc4_ = this.var_436.removeMask(param1.maskId);
         }
         if(_loc4_)
         {
            _loc6_ = this.var_436.getXML();
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1097:
               param2.setNumber(RoomObjectVariableEnum.const_791,_loc3_);
               break;
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_948:
               param2.setNumber(RoomObjectVariableEnum.const_632,_loc3_);
               param2.setNumber(RoomObjectVariableEnum.const_622,_loc3_);
         }
      }
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         this.var_1306 = this._color;
         this.var_1702 = this.var_1701;
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         if(_loc5_ < 1 || _loc5_ > this._planeParser.planeCount)
         {
            ...
            {
               _loc4_.setNumber(RoomObjectVariableEnum.const_489,0);
            }
            return;
         }
         _loc5_--;
         ...
         if(_loc7_.x >= 0 && _loc7_.x < _loc14_ && _loc7_.y >= 0 && _loc7_.y < _loc15_)
         {
            ...
            _loc4_.setNumber(RoomObjectVariableEnum.const_1303,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1378,_loc22_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_489,_loc5_ + 1);
            var _loc23_:String = "";
            var _loc24_:int = 0;
            var _loc25_:* = null;
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc13_ == RoomPlaneData.const_157 || _loc13_ == RoomPlaneData.const_285)
                     {
                        _loc27_ = 90;
                        if(_loc11_ != null)
                        {
