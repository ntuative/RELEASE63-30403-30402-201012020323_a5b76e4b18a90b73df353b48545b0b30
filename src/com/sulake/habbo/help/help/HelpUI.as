package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      {
         this.var_307 = this._defaultViewId;
         ...
         this._windowManager.registerLocalizationParameter("info.client.version","version",new String(201012020318));
         this._toolbar = param5;
         this.var_94 = new Map();
         this.var_94.add(HabboHelpViewEnum.const_1492,IHelpViewController(new PlaceholderView(this,this._windowManager,this._assetLibrary)));
         this.var_94.add(HabboHelpViewEnum.const_188,IHelpViewController(new HelpMainView(this,this._windowManager,this._assetLibrary)));
         this.var_94.add(HabboHelpViewEnum.const_474,IHelpViewController(new FaqBrowseTopView(this,this._windowManager,this._assetLibrary)));
         this.var_94.add(HabboHelpViewEnum.const_297,IHelpViewController(new FaqBrowseCategoryView(this,this._windowManager,this._assetLibrary)));
         this.var_94.add(HabboHelpViewEnum.const_217,IHelpViewController(new FaqBrowseEntry(this,this._windowManager,this._assetLibrary)));
         this.var_94.add(HabboHelpViewEnum.const_579,IHelpViewController(new FaqBrowseSearchResults(this,this._windowManager,this._assetLibrary)));
         this.var_94.add(HabboHelpViewEnum.const_355,IHelpViewController(new CallForHelpTopicSelection(this,this._windowManager,this._assetLibrary)));
         this.var_94.add(HabboHelpViewEnum.const_737,IHelpViewController(new CallForHelpTextInput(this,this._windowManager,this._assetLibrary)));
         this.var_94.add(HabboHelpViewEnum.const_216,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_thanks")));
         this.var_94.add(HabboHelpViewEnum.const_1096,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_abusive")));
         ...
         this.var_94.add(HabboHelpViewEnum.const_637,IHelpViewController(new CallForHelpReportUserSelection(this,this._windowManager,this._assetLibrary)));
      }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         {
            if(this.var_435.length == 0 || param1 != this.var_307)
            {
               this.var_435.push(this.var_307);
            }
         }
         this.var_307 = param1;
         ...
         if(_loc4_ == null)
         {
            Logger.log("* No view controller found for " + this.var_307);
            return;
         }
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            ...
            case CallForHelpResultEnum.const_1084:
               ...
               break;
            case CallForHelpResultEnum.const_895:
               this.showUI(HabboHelpViewEnum.const_1096);
         }
      }
      ...
      public function updateCallForGuideBotUI(param1:Boolean) : void
      {
         ...
         var _loc2_:IHelpViewController = this.var_94.getValue(HabboHelpViewEnum.const_188) as IHelpViewController;
      ...
      public function handleCallGuideBot() : void
      {
         ...
         this.hideUI();
         this._component.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_478));
      }
      ...
      {
         return this.var_94.getValue(this.var_307);
      }
      ...
      private function createWindow() : void
      {
         ...
         this.var_1534 = this._window.width - _loc4_.width;
      ...
      public function updateWindowDimensions() : void
      {
         ...
         this._window.height = _loc1_.height + this.var_1535;
         this._window.width = _loc1_.width + this.var_1534;
      }
      ...
      private function onBack(param1:WindowMouseEvent) : void
      {
         ...
         {
            this.showUI(this.var_435.pop(),false);
         }
      }
      ...
      {
         var _loc3_:* = null;
         if(this.var_307 == HabboHelpViewEnum.const_188)
         {
            return;
         }
         if(this.var_531.length < 2)
         {
            _loc3_ = this._assetLibrary.getAssetByName("back_png") as BitmapDataAsset;
            this.var_531.push(_loc3_.content as BitmapData);
            _loc3_ = this._assetLibrary.getAssetByName("back_hi_png") as BitmapDataAsset;
            this.var_531.push(_loc3_.content as BitmapData);
         }
         var _loc2_:IBitmapWrapperWindow = this.var_306.findChildByName("back_image") as IBitmapWrapperWindow;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         if(param1)
         {
            _loc2_.bitmap.copyPixels(this.var_531[1],this.var_531[1].rect,new Point(0,0));
         }
         else
         {
            _loc2_.bitmap.copyPixels(this.var_531[0],this.var_531[0].rect,new Point(0,0));
         }
      }
      ...
      private function addBackButtonWindow() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         if(this.var_307 == HabboHelpViewEnum.const_188 || this.var_435.length == 0)
         {
            return;
         }
         if(this.var_306 == null)
         {
            ...
            this.var_306 = _loc2_.buildFromXML(XML(_loc3_.content)) as IWindowContainer;
            _loc4_ = this.var_306.findChildByName("back_image");
            if(_loc4_ != null)
            {
            ...
            _loc5_ = this.var_306.findChildByName("back_text");
            if(_loc5_ != null)
            {
         ...
         var _loc1_:IItemListWindow = this._window.findChildByName("content_list") as IItemListWindow;
         if(_loc1_ == null || this.var_306 == null)
         {
            return;
         }
         if(_loc1_.getListItemIndex(this.var_306 as IWindow) > -1)
         {
            return;
         }
         _loc1_.addListItem(this.var_306 as IWindow);
         this.setBackButtonActiveState(false);
      }
   }
}
