package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialClothesChangeView implements ITutorialUIView
   {
      ...
      public function TutorialClothesChangeView(param1:IItemListWindow, param2:TutorialUI)
      {
         ...
         this.var_45.help.toolbar.events.addEventListener(HabboToolbarShowMenuEvent.const_47,this.onShowMenuEvent);
      ...
      public function dispose() : void
      {
         ...
         this.var_45.help.toolbar.events.removeEventListener(HabboToolbarShowMenuEvent.const_47,this.onShowMenuEvent);
      }
      ...
      private function onShowMenuEvent(param1:HabboToolbarShowMenuEvent) : void
      {
         if(param1.menuId == HabboToolbarIconEnum.MEMENU && param1.type == HabboToolbarShowMenuEvent.const_47)
         {
            ...
            this.var_45.help.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_420));
         }
      }
      ...
      private function showToolbarIconHighlightArrow() : void
      {
         ...
         this.var_671 = this.var_45.buildXmlWindow("tutorial_arrow") as IWindowContainer;
         var _loc1_:IBitmapWrapperWindow = this.var_671.findChildByName("arrow") as IBitmapWrapperWindow;
         if(_loc1_ != null)
         {
         ...
         this.var_45.help.toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_47,HabboToolbarIconEnum.MEMENU_ARROW,this.var_671));
      }
      ...
      private function windowProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param2.name)
         {
            case "button_cancel":
               ...
               {
                  this.var_45.showView(TutorialUI.const_84);
               }
         }
      }
   }
