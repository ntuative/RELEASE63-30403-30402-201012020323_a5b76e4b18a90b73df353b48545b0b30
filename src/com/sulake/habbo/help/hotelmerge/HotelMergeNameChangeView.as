package com.sulake.habbo.help.hotelmerge
{
   ...
   public class HotelMergeNameChangeView
   {
      ...
      private function showSelectionView() : void
      {
         if(!this.var_641)
         {
            this.var_641 = this.createWindow("hotel_merge_name_selection_xml") as IWindowContainer;
            if(!this.var_641)
            {
               return;
            }
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_640)
         {
            this.var_640 = this.createWindow("hotel_merge_name_confirmation_xml") as IWindowContainer;
            if(!this.var_640)
            {
               return;
            }
