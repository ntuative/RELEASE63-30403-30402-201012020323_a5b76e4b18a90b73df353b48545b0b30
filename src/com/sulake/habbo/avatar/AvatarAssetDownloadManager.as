package com.sulake.habbo.avatar
{
   ...
   public class AvatarAssetDownloadManager extends EventDispatcher
   {
      ...
      private var var_858:int = 3;
      
      private var var_382:AssetLoaderStruct;
      ...
      private const const_1820:int = 100;
      
      private const const_1520:int = 2;
      ...
      public function AvatarAssetDownloadManager(param1:IAssetLibrary, param2:String, param3:String, param4:AvatarStructure)
      {
         ...
         if(_loc6_ == null)
         {
            this.var_382 = this._assets.loadAssetFromFile("figuremap",_loc5_,"text/xml");
         ...
         this.var_857 = new Timer(this.const_1820,1);
         this.var_857.addEventListener(TimerEvent.TIMER_COMPLETE,this.onNextDownloadTimeout);
      }
      ...
      private function addMapLoaderEventListeners() : void
      {
         if(this.var_382)
         {
            this.var_382.addEventListener(AssetLoaderEvent.const_30,this.onConfigurationComplete);
            this.var_382.addEventListener(AssetLoaderEvent.const_43,this.onConfigurationError);
         }
      }
      ...
      private function removeMapLoaderEventListeners() : void
      {
         if(this.var_382)
         {
            this.var_382.removeEventListener(AssetLoaderEvent.const_30,this.onConfigurationComplete);
            this.var_382.removeEventListener(AssetLoaderEvent.const_43,this.onConfigurationError);
         }
      }
      ...
      private function onConfigurationError(param1:Event) : void
      {
         ...
         {
            Logger.log("Could not download figuremap.xml. Retries left: " + this.var_858);
            if(this.var_1288.indexOf("?") > 0)
            {
               _loc2_ = this.var_1288 + "&retry=" + this.var_858;
            }
            else
            {
               _loc2_ = this.var_1288 + "?retry=" + this.var_858;
            ...
            this.var_382 = this._assets.loadAssetFromFile("figuremap",_loc3_,"text/xml");
            this.addMapLoaderEventListeners();
         }
      }
      ...
      private function generateMap(param1:XML) : void
      {
         ...
         {
            _loc3_ = new AvatarAssetDownloadLibrary(_loc2_.@id,_loc2_.@revision,this.var_2258,this._assets);
      ...
      public function loadFigureSetData(param1:AvatarFigureContainer, param2:IAvatarImageListener) : void
      {
         ...
         if(!this.var_1652)
         {
            this.var_1030.push([param1,param2]);
            return;
         }
         ...
         if(_loc4_.length > 0)
         {
            ...
            {
               _loc6_ = this.var_466[_loc3_];
               if(_loc6_ == null)
               {
                  _loc6_ = [];
               }
               _loc6_.push(param2);
               this.var_466[_loc3_] = _loc6_;
            }
      ...
      private function libraryComplete(param1:Event) : void
      {
         ...
         for(_loc3_ in this.var_856)
         {
            ...
            if(_loc7_)
            {
               ...
               delete this.var_466[_loc3_];
            }
         }
         for each(_loc3_ in _loc2_)
         {
            delete this.var_856[_loc3_];
         }
      ...
      {
         var _loc1_:* = null;
         while(this.var_693.length > 0 && this.var_692.length < this.const_1520)
         {
            _loc1_ = this.var_693[0];
            _loc1_.startDownloading();
            this.var_692.push(this.var_693.shift());
         }
      }
      
      private function addToQueue(param1:AvatarAssetDownloadLibrary) : void
      {
         if(!param1.isReady && this.var_693.indexOf(param1) == -1 && this.var_692.indexOf(param1) == -1)
         {
