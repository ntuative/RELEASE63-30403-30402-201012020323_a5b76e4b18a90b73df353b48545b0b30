package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class WardrobeSlot implements IOutfit, IAvatarImageListener
   {
      ...
      public function updateView() : void
      {
         ...
         if(this.var_586 && this.var_1346)
         {
            _loc5_ = this._controller.avatarRenderManager.createAvatarImage(this.figure,AvatarScaleType.const_86,this.var_889,this);
            if(_loc5_)
            {
               _loc5_.setDirection(AvatarSetType.const_32,parseInt(FigureData.const_583));
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            case "set_button":
               this.var_586 = this._controller.figureData.getFigureString();
               this.var_889 = this._controller.gender;
               this._controller.handler.saveWardrobeOutfit(this.var_1755,this);
               this.updateView();
               break;
            case "get_button":
               if(this.var_586)
               {
                  this._controller.loadAvatarInEditor(this.var_586,this.var_889,this._controller.clubMemberLevel);
               }
         }
      }
