package com.sulake.habbo.avatar.geometry
{
   public class Vector3D
   {
      ...
      {
         return this._x * param1.x + this.var_164 * param1.y + this.var_165 * param1.z;
      }
      
      public function cross(param1:Vector3D) : Vector3D
      {
         var _loc2_:Vector3D = new Vector3D();
         _loc2_.x = this.var_164 * param1.z - this.var_165 * param1.y;
      ...
      {
         return Math.sqrt(this._x * this._x + this.var_164 * this.var_164 + this.var_165 * this.var_165);
      }
      
      public function toString() : String
      {
         return "Vector3D: (" + this._x + "," + this.var_164 + "," + this.var_165 + ")";
      }
