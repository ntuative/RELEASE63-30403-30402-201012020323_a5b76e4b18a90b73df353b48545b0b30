package com.sulake.habbo.avatar
{
   ...
   public class AvatarRenderManager extends Component implements IAvatarRenderManager
   {
      ...
      private const const_1816:String = "hd-99999-99999";
      ...
      private var var_674:PaletteManager;
      
      private var var_612:String;
      
      private var var_264:Map;
      
      private var var_197:AvatarAssetDownloadManager;
      
      private var var_1587:AvatarFigureContainer;
      ...
      public function AvatarRenderManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_612 = RenderMode.const_1437;
         ...
         this.var_95.add(AvatarType.const_105,_loc4_);
         ...
         this.var_674 = new PaletteManager(param1.assets as AssetLibraryCollection);
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_197)
         {
            this.var_197.removeEventListener(Event.COMPLETE,this.onAvatarAssetsDownloadManagerReady);
      ...
      private function onAllModulesReadyAndRunning(param1:Event) : void
      {
         ...
         this.var_315.init();
         this.var_674.init();
         _loc2_ = this.var_95.getValue(AvatarType.const_105) as AvatarStructure;
         if(_loc2_)
         {
      ...
      private function onHabboConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            _loc3_ = this.var_95.getValue(AvatarType.const_105) as AvatarStructure;
            if(_loc3_ != null)
            {
               ...
               if(this.var_197 == null)
               {
                  ...
                  this.var_197 = new AvatarAssetDownloadManager(context.assets,_loc6_,_loc7_,_loc3_);
                  this.var_197.addEventListener(Event.COMPLETE,this.onAvatarAssetsDownloadManagerReady);
               }
            }
         }
      }
      ...
      private function checkIfReady() : void
      {
         if(!this.var_849)
         {
            if(this.var_2159 && this.var_2157 && this.var_2158)
            {
      ...
      public function isFigureReady(param1:AvatarFigureContainer) : Boolean
      {
         ...
         return this.var_197.isReady(param1);
      }
      ...
      public function downloadFigure(param1:AvatarFigureContainer, param2:IAvatarImageListener) : void
      {
         ...
         this.var_197.loadFigureSetData(param1,param2);
      }
      ...
      {
         var _loc5_:AvatarStructure = this.var_95.getValue(AvatarType.const_105) as AvatarStructure;
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         if(this.var_197.isReady(_loc6_))
         {
            return new AvatarImage(_loc5_,this._aliasCollection,_loc6_,param2);
         }
         if(!this.var_1587)
         {
            this.var_1587 = new AvatarFigureContainer(this.const_1816);
         }
         this.var_197.loadFigureSetData(_loc6_,param4);
         return new PlaceholderAvatarImage(_loc5_,this._aliasCollection,this.var_1587,param2);
      }
      ...
      public function createPetImage(param1:int, param2:int, param3:uint, param4:String, param5:IPetImageListener = null) : IAvatarImage
      {
         var _loc9_:* = null;
         var _loc6_:* = false;
         if(this.mode != RenderMode.const_1470)
         {
      ...
      {
         var _loc3_:AvatarStructure = this.var_95.getValue(AvatarType.const_105) as AvatarStructure;
