package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_1846:int = 6710886;
      ...
      private var var_426:ITabSelectorWindow;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:IHabboWindowManager, param3:IHabboCatalog, param4:Array, param5:Boolean)
      {
         ...
         var _loc8_:* = null;
         this.var_955 = [];
         this.var_1198 = [AvatarEditorFigureCategory.const_715,AvatarEditorFigureCategory.const_44,AvatarEditorFigureCategory.const_247,AvatarEditorFigureCategory.const_668,AvatarEditorFigureCategory.const_928,AvatarEditorFigureCategory.const_101];
         super();
         ...
         this.var_358 = new Timer(1000);
         this.var_358.addEventListener(TimerEvent.TIMER,this.onUpdate);
         if(param4 == null)
         {
            param4 = this.var_1198;
         }
         for each(_loc6_ in param4)
         {
            this.var_955.push(_loc6_);
         }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_358.stop();
            this.var_358.removeEventListener(TimerEvent.TIMER,this.onUpdate);
            this.var_358 = null;
         }
      ...
      public function validateAvailableCategories(param1:Array) : Boolean
      {
         ...
         if(param1 == null)
         {
            return this.validateAvailableCategories(this.var_1198);
         }
         if(param1.length != this.var_955.length)
         {
            return false;
         }
         for each(_loc2_ in param1)
         {
            if(this.var_955.indexOf(_loc2_) < 0)
            {
               return false;
            }
         }
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         {
            this.var_2018 = this.canChangeOutfit();
            this.var_358.stop();
            if(this._window)
            {
      ...
      private function createWindow(param1:Boolean) : void
      {
         ...
         this.var_426 = this._window.findChildByName("mainTabs") as ITabSelectorWindow;
         var _loc2_:int = this.var_426.numSelectables - 1;
         while(_loc2_ >= 0)
         {
            _loc4_ = this.var_426.getSelectableAt(_loc2_);
            if(_loc4_ != null && this.var_955.indexOf(_loc4_.name) < 0)
            {
               _loc5_ = this.var_426.removeSelectable(_loc4_);
               _loc6_ = _loc2_ + 1;
               while(_loc6_ < this.var_426.numSelectables)
               {
                  this.var_426.getSelectableAt(_loc6_).x = this.var_426.getSelectableAt(_loc6_).x - _loc5_.width;
                  _loc6_++;
               }
            }
            _loc2_--;
      ...
      private function attachImages() : void
      {
         ...
         var _loc1_:Array = this.var_1198;
      ...
      public function update() : void
      {
         ...
         if(this._controller.sessionData && this._controller.sessionData.hasUserRight("fuse_use_wardrobe") && (this.var_1494 == AvatarEditorSideCategory.const_101 || this.var_2019))
         {
         ...
         this.setViewToCategory(this.var_307);
      }
      ...
      {
         if(this.var_1494 == AvatarEditorSideCategory.const_101)
         {
            this.var_2019 = false;
            this.setSideContent(AvatarEditorSideCategory.const_623);
         }
         else
         {
      ...
      private function setSideContent(param1:String) : void
      {
         ...
         switch(param1)
         {
            case AvatarEditorSideCategory.const_623:
               break;
            case AvatarEditorSideCategory.const_446:
               _loc3_ = this._controller.getSideContentWindowContainer(AvatarEditorSideCategory.const_446);
               break;
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         this.var_307 = param1;
         this.var_426.setSelected(this.var_426.getSelectableByName(param1));
      ...
      private function displayStripClubDialog() : void
      {
         ...
         if(!this.var_427)
         {
            ...
            this.var_427 = this._windowManager.buildFromXML(_loc2_,2) as IFrameWindow;
            this.var_427.procedure = this.stripClubDialogEventProc;
            this.var_427.center();
         }
         else
         {
