   ...
   public class HeadView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_34)
         {
            ...
            var_34["null"] = new AvatarEditorGridView(var_62,FigureData.const_179,_windowManager,_assetLibrary);
            var_34["null"] = new AvatarEditorGridView(var_62,FigureData.const_246,_windowManager,_assetLibrary);
            ...
            var_34["null"] = new AvatarEditorGridView(var_62,FigureData.const_205,_windowManager,_assetLibrary);
         }
         else
         {
         ...
         if(var_62 && var_128 == "")
         {
            var_62.switchCategory(FigureData.const_179);
         }
      }
