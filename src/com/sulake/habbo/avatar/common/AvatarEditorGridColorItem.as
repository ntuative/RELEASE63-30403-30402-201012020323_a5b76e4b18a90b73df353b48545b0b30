package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridColorItem
   {
      ...
      private var var_777:IPartColor;
      ...
      public function AvatarEditorGridColorItem(param1:IWindowContainer, param2:IAvatarEditorCategoryModel, param3:IPartColor)
      {
         ...
         this.var_669 = _loc4_.content as BitmapData;
         ...
         this.var_778 = _loc6_.content as BitmapData;
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.bitmap = new BitmapData(this.var_669.width,this.var_669.height,true,0);
            _loc1_.bitmap.copyPixels(this.var_669,this.var_669.rect,new Point(0,0));
         }
         ...
         if(_loc2_ != null)
         {
            ...
            _loc5_.colorTransform(_loc5_.rect,this.var_777.colorTransform);
         ...
         if(_loc3_ != null)
         {
            if(this._isSelected)
            {
               _loc3_.bitmap = new BitmapData(this.var_778.width,this.var_778.height,true,16777215);
               _loc3_.bitmap.copyPixels(this.var_778,this.var_778.rect,new Point(0,0),null,null,true);
               _loc3_.visible = true;
            }
            else
            {
