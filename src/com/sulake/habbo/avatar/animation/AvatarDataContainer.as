package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      private var var_1667:Number = 1.0;
      
      private var var_1668:Number = 1.0;
      ...
      {
         super();
         this.var_1616 = parseInt(param1.@ink);
         var _loc2_:String = String(param1.@foreground);
         _loc2_ = _loc2_.replace("#","");
         var _loc3_:String = String(param1.@background);
         _loc3_ = _loc3_.replace("#","");
         this.var_2199 = parseInt(_loc2_,16);
         this.var_2198 = parseInt(_loc3_,16);
         ...
         this.var_1600 = new ColorTransform(this.var_1669,this.var_1667,this.var_1668,this._alphaMultiplier);
         this.var_1012 = this.generatePaletteMapForGrayscale(this.var_2198,this.var_2199);
      }
