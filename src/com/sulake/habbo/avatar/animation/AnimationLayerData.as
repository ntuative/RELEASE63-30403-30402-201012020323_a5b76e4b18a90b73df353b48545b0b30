package com.sulake.habbo.avatar.animation
{
   ...
   public class AnimationLayerData implements IAnimationLayerData
   {
      ...
      public static const const_666:String = "bodypart";
      ...
      public function AnimationLayerData(param1:AvatarStructure, param2:XML, param3:String, param4:int, param5:IActionDefinition)
      {
         ...
         this.var_2354 = parseInt(param2.@frame);
         this._dx = parseInt(param2.@dx);
         this.var_1383 = parseInt(param2.@dy);
         this.var_1382 = parseInt(param2.@dz);
         this.var_1737 = parseInt(param2.@dd);
         this._type = param3;
         this.var_1057 = String(param2.@base);
      ...
      private function baseAsInt() : int
      {
         ...
         {
            _loc1_ += this.var_1057.charCodeAt(_loc2_);
            _loc2_++;
         }
         return _loc1_;
      }
