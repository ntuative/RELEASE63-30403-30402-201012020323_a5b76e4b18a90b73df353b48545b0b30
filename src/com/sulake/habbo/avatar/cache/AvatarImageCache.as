package com.sulake.habbo.avatar.cache
{
   ...
   public class AvatarImageCache
   {
      ...
      private static const const_1563:int = 60000;
       
      
      private var _structure:AvatarStructure;
      
      private var var_1334:IAvatarImage;
      ...
      private var var_615:AvatarCanvas;
      ...
      private var var_397:AvatarImageBodyPartContainer;
      ...
      private var var_171:BitmapData;
      ...
      private var var_405:BitmapDataAsset;
      
      private var var_917:BitmapData;
      
      private var var_2573:ByteArray;
      
      private var var_2575:ImageData;
      
      private var var_1827:PaletteMap;
      
      private var var_916:Array;
      
      private var var_918:Point;
      ...
      public function setGeometryType(param1:String) : void
      {
         ...
         if(this.var_746 == GeometryType.const_1071 && param1 == GeometryType.const_913 || this.var_746 == GeometryType.const_913 && param1 == GeometryType.const_1071)
         {
            this.var_746 = param1;
            this.var_615 = null;
            return;
      ...
      public function getImageContainer(param1:String, param2:int) : AvatarImageBodyPartContainer
      {
            ...
            if(this.var_343.definition.isAnimation)
            {
               ...
               if(_loc12_ != null)
               {
                  ...
                  if(_loc14_ != null)
                  {
                     ...
                     if(_loc14_.type == AnimationLayerData.const_666)
                     {
                        if(_loc14_.action != null)
                        {
         ...
         if(_loc10_ == null)
         {
            _loc15_ = this._structure.getParts(param1,this.var_1334.getFigure(),_loc5_,this.var_746,_loc3_,_loc6_,_loc7_);
            _loc10_ = new AvatarImageDirectionCache(_loc15_);
            _loc9_.updateDirectionCache(_loc3_,_loc10_);
         }
         this.var_397 = _loc10_.getImageContainer(_loc4_);
         if(this.var_397 == null)
         {
            _loc16_ = _loc10_.getPartList();
            this.var_397 = this.renderBodyPart(_loc3_,_loc16_,_loc4_,this.var_343);
            if(this.var_397 == null)
            {
               return null;
            }
            _loc10_.updateImageContainer(this.var_397,_loc4_);
         }
         this.var_397.offset = _loc8_;
         return this.var_397;
      }
      ...
      private function renderBodyPart(param1:int, param2:Array, param3:int, param4:IActiveActionData) : AvatarImageBodyPartContainer
      {
         ...
         if(!this.var_615)
         {
            this.var_615 = this._structure.getCanvas(this._scale,this.var_746);
            if(!this.var_615)
            {
               return null;
            }
            this.var_2574 = new Point(0,this.var_615.height - int(this.var_615.width / 4));
         }
         var _loc5_:int = param1;
         var _loc6_:Boolean = AvatarDirectionAngle.const_1252[param1];
         var _loc9_:String = param4.definition.assetPartDefinition;
         var _loc10_:String = param4.definition.state;
         var _loc11_:Boolean = _loc10_ == AvatarAction.const_753 || _loc10_ == AvatarAction.const_335;
         ...
         while(_loc8_ >= 0)
         {
            ...
            {
               this.var_1393 = this.var_113.bodyPartId;
               this.var_170 = this.var_113.partType;
               this.var_1826 = this.var_113.partId;
               this._frame = this.var_113.getFrameIndex(param3);
               _loc5_ = param1;
               _loc7_ = false;
               if(_loc6_)
               {
                  if(_loc9_ == "wav" && (this.var_170 == "lh" || this.var_170 == "ls" || this.var_170 == "lc" || this.var_170 == "lhs"))
                  {
                     _loc7_ = true;
                  }
                  else if(_loc9_ == "drk" && (this.var_170 == "rh" || this.var_170 == "rs" || this.var_170 == "rc" || this.var_170 == "rhs"))
                  {
                     _loc7_ = true;
                  }
                  else if(_loc9_ == "crr" && this.var_170 == "rhs")
                  {
                     _loc7_ = true;
                  }
                  else if(this.var_170 == "ri")
                  {
                     _loc7_ = true;
                  }
                  else if(this.var_170 == "cp")
                  {
                     _loc7_ = true;
                  }
                  else
                  {
                     ...
                     if(this.var_113.flippedPartType != this.var_170)
                     {
                        this.var_170 = this.var_113.flippedPartType;
                     }
                  }
               }
               this.var_1392 = this._scale + "_" + this.var_113.action.assetPartDefinition + "_" + this.var_170 + "_" + this.var_1826 + "_" + _loc5_ + "_" + this._frame;
               this.var_405 = this._assets.getAssetByName(this.var_1392) as BitmapDataAsset;
               if(this.var_405 == null)
               {
                  this.var_1392 = this._scale + "_std_" + this.var_170 + "_" + this.var_1826 + "_" + _loc5_ + "_0";
                  this.var_405 = this._assets.getAssetByName(this.var_1392) as BitmapDataAsset;
               }
               if(!(!this.var_405 || !this.var_405.content))
               {
                  if(this.var_113.paletteMapId > -1)
                  {
                     this.var_1827 = this._structure.renderManager.paletteManager.getPalette(this.var_113.paletteMapId);
                     if(this.var_1827 != null)
                     {
                        this.var_917 = this.var_405.content as BitmapData;
                        this.var_171 = new BitmapData(this.var_917.width,this.var_917.height);
                        this.var_2573 = this.var_1827.colorize(this.var_917.getPixels(this.var_917.rect));
                        this.var_171.setPixels(this.var_171.rect,this.var_2573);
                     }
                     else
                     {
                        this.var_171 = (this.var_405.content as BitmapData).clone();
                     }
                  }
                  else
                  {
                  ...
                  if(_loc11_ && (this.var_1393 == AvatarBodyPartType.const_247 || this.var_1393 == AvatarBodyPartType.const_1304 || this.var_1393 == AvatarBodyPartType.const_1242) && this.var_113.color != null)
                  {
                     _loc16_ = 0.7;
                     ...
                     this.var_171.colorTransform(this.var_171.rect,_loc18_);
                  }
                  else if(this.var_113.isColorable && this.var_113.color != null)
                  {
                     this.var_171.colorTransform(this.var_171.rect,this.var_113.color.colorTransform);
                  }
                  if(this.var_113.isBlendable)
                  {
                     this.var_171.colorTransform(this.var_171.rect,this.var_113.blendTransform);
                  }
                  this.var_918 = this.var_405.offset.clone();
                  if(_loc7_)
                  {
                     if(this._scale == AvatarScaleType.const_50)
                     {
                  ...
                  this.var_2575 = new ImageData(this.var_171,this.var_918,_loc7_);
                  this.var_916.push(this.var_2575);
               }
            }
            _loc8_--;
         }
         if(this.var_916.length == 0)
         {
            return null;
         }
         var _loc13_:ImageData = this.createUnionImage(this.var_916,_loc6_);
         ...
         _loc8_ = this.var_916.length - 1;
         while(_loc8_ >= 0)
         {
            _loc15_ = this.var_916.pop();
            if(_loc15_)
            {
               _loc15_.dispose();
            }
