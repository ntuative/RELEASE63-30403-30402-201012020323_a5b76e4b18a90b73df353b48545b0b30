package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      private static const const_1219:String = "Default";
      
      private static const const_1218:int = 2;
      
      private static const const_1220:String = AvatarSetType.const_32;
      ...
      protected var var_586:AvatarFigureContainer;
      ...
      private var var_884:IActiveActionData;
      ...
      public function AvatarImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:AvatarFigureContainer, param4:String)
      {
         ...
         this.setDirection(const_1220,const_1218);
         this.var_288 = new Array();
         this.var_884 = new ActiveActionData(AvatarAction.const_353);
         this.var_884.definition = this._structure.getActionDefinition(const_1219);
         this.resetActions();
      ...
      {
         return this._structure.getPartColor(this.var_586,param1);
      }
      
      public function setDirection(param1:String, param2:int) : void
      {
         param2 += this.var_1737;
      ...
      private function getFullImageCacheKey() : String
      {
         ...
         if(this.var_284.length == 1 && this.var_84 == this.var_1878)
         {
            return this.var_84 + this.var_492 + this.var_608 % 4;
         }
         if(this.var_284.length == 2)
         {
      ...
      {
         if(param3 != this.var_2546 || param2 != this.var_2548 || param1 != this.var_2547)
         {
            this.var_2546 = param3;
            this.var_2548 = param2;
            this.var_2547 = param1;
            this.var_1810 = this._structure.getBodyParts(param1,param2,param3);
         }
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         if(this.var_1168 || this.var_39 == null || (this.var_39.width != _loc5_.width || this.var_39.height != _loc5_.height))
         {
            if(this.var_39 != null && !this.var_1168)
            {
               this.var_39.dispose();
            }
      ...
      protected function addActionData(param1:String, param2:String = "") : void
      {
         ...
         this.var_288.push(new ActiveActionData(param1,param2,this.var_608));
      }
      ...
      private function resetActions() : Boolean
      {
         ...
         this.var_256 = this.var_884;
         this.var_256.definition = this.var_884.definition;
         this.resetBodyPartCache(this.var_884);
         return true;
      }
      ...
      private function sortActions() : Boolean
      {
         ...
         var _loc1_:Boolean = false;
         this.var_492 = "";
         this.var_284 = this._structure.sortActions(this.var_288);
         if(this.var_284 == null)
         {
            this.var_694 = new Array(0,0,0);
            if(this.var_1384 != "")
            {
               _loc1_ = true;
               this.var_1384 = "";
         ...
         {
            this.var_694 = this._structure.getCanvasOffsets(this.var_284,this._scale,this.var_84);
            for each(_loc4_ in this.var_284)
            {
               this.var_492 += _loc4_.actionType + _loc4_.actionParameter;
               if(_loc4_.actionType == AvatarAction.const_274)
               {
                  _loc5_ = parseInt(_loc4_.actionParameter);
                  if(this.var_1385 != _loc5_)
                  {
                     _loc2_ = true;
                  }
                  this.var_1385 = _loc5_;
                  _loc3_ = true;
               }
            }
            if(!_loc3_)
            ...
            if(this.var_1384 != this.var_492)
            {
               _loc1_ = true;
               this.var_1384 = this.var_492;
            }
         }
         this.var_1339 = true;
         return _loc1_;
      ...
      private function setActionsToParts() : void
      {
         ...
         for each(_loc1_ in this.var_284)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               {
                  this.var_851 = _loc1_.definition.isAnimated(_loc1_.actionParameter);
                  _loc2_ = this._structure.getAnimation(_loc1_.definition.state + "." + _loc1_.actionParameter);
                  if(_loc2_ != null)
                  {
                     ...
                     {
                        this.var_1737 = _loc2_.directionData.offset;
                     }
               ...
               if(_loc1_.actionType == AvatarAction.const_300 || _loc1_.actionType == AvatarAction.const_231 || _loc1_.actionType == AvatarAction.const_335)
               {
                  this.var_851 = true;
               }
            }
