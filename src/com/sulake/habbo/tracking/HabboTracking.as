package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private static const const_868:uint = 11;
      ...
      private var var_1105:IHabboWindowManager;
      ...
      private var var_590:LagWarningLogger = null;
      
      private var var_591:ToolbarClickTracker = null;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_590 = new LagWarningLogger();
         this.var_591 = new ToolbarClickTracker(this);
         this.var_1354 = new Array(const_868);
         var _loc4_:int = 0;
         while(_loc4_ < const_868)
         {
            this.var_1354[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1457,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_773,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1082,String(0));
         }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_1105)
            {
               this.var_1105.release(new IIDHabboWindowManager());
               this.var_1105 = null;
            }
            if(this.var_259)
            {
            ...
            if(this.var_184)
            {
               if(!this.var_184.disposed)
               {
                  ...
                  Component(this.var_184).events.removeEventListener(HabboFriendListTrackingEvent.const_374,this.onFriendlistTrackingEvent);
               }
            ...
            if(this.var_151)
            {
               if(!this.var_151.disposed)
               {
                  this.var_151.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,this.onHelpTrackingEvent);
                  this.var_151.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,this.onHelpTrackingEvent);
               }
               this.var_151.release(new IIDHabboHelp());
               this.var_151 = null;
            }
            if(this._toolbar)
            {
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this.var_166)
         {
            if(this.var_244 != null)
            {
               this.var_244.configuration = this.var_166;
            }
            if(this.var_243 != null)
            {
               this.var_243.configuration = this.var_166;
            }
            ...
            if(this.var_166)
            {
               ...
               {
                  this.var_590.configure(this.var_166);
               }
               if(this.var_592 != null)
               {
                  this.var_592.configure(this.var_166);
               }
               if(this.var_591 != null)
               {
                  this.var_591.configure(this.var_166);
               }
            }
         }
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_657,this.onConnectionEvent);
         ...
         Component(context).events.addEventListener(HabboHotelViewEvent.const_645,this.onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_62,this.onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_516,this.onHotelViewEvent);
      }
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(this.var_590 != null)
            {
               this.var_590.connection = param1;
            }
         }
      }
      ...
      private function onHotelViewEvent(param1:Event) : void
      {
         ...
         else if(param1.type == HabboHotelViewEvent.const_516)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1306);
         }
         else if(param1.type == HabboHotelViewEvent.const_62)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1301);
         }
      }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               this.trackLoginStep(HabboLoginTrackingStep.const_1321);
               break;
            case HabboCommunicationEvent.const_657:
               this.trackLoginStep(HabboLoginTrackingStep.const_1485,String(this._communication.port));
               break;
      ...
      {
         this.var_1105 = IHabboWindowManager(param2);
         if(this.var_1105)
         {
         ...
         if(param1.critical && !this._crashed)
         {
            ...
            if(this.var_166)
            {
               if(this.var_166.keyExists("client.fatal.error.url"))
               {
                  ...
                  _loc8_ = "";
                  for each(_loc9_ in this.var_1354)
                  {
      ...
      private function onFriendlistReady(param1:IID, param2:IUnknown) : void
      {
         ...
         Component(this.var_184).events.addEventListener(HabboFriendListTrackingEvent.const_374,this.onFriendlistTrackingEvent);
      }
      ...
      {
         this.var_151 = param2 as IHabboHelp;
         this.var_151.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,this.onHelpTrackingEvent);
         this.var_151.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,this.onHelpTrackingEvent);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         if(!this.var_2486)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1429);
            this.var_2486 = true;
         }
         var _loc2_:RoomEntryInfoMessageParser = RoomEntryInfoMessageEvent(param1).getParser();
         if(_loc2_.guestRoom)
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1082,String(_loc2_.guestRoomId));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_773,String(true));
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(this._roomEngine).events.addEventListener(RoomObjectRoomAdEvent.const_271,this.onRoomAdClick);
      }
      
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_259 = param2 as IAdManager;
         this.var_259.events.addEventListener(AdEvent.const_408,this.onRoomAdLoad);
      }
      ...
      private function onToolbarClick(param1:HabboToolbarEvent) : void
      {
         if(this.var_591)
         {
            this.var_591.track(param1.iconName);
         }
      }
      ...
      {
         this.var_590.chatLagDetected();
      }
      
      public function update(param1:uint) : void
      {
         var _loc2_:int = getTimer();
         if(this.var_1104 > -1 && _loc2_ < this.var_1104)
         {
            ++this.var_1775;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + this.var_1775);
         }
         if(this.var_1104 > -1 && _loc2_ - this.var_1104 > 15000)
         {
            ++this.var_1774;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + this.var_1774);
         }
         this.var_1104 = _loc2_;
         if(this.var_243 != null)
         {
            this.var_243.update(param1);
         }
         if(this.var_244 != null)
         {
            this.var_244.update(param1);
         }
         if(this.var_592 != null)
         {
            this.var_592.trackUpdate(param1,this);
         }
         if(this.var_590 != null)
         {
            this.var_590.update();
