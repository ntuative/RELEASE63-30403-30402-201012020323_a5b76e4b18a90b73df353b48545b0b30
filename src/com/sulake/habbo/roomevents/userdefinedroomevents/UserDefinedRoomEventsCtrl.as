package com.sulake.habbo.roomevents.userdefinedroomevents
{
   ...
   public class UserDefinedRoomEventsCtrl
   {
      ...
      private var var_1717:TriggerConfs;
      
      private var var_1719:ActionTypes;
      
      private var var_1718:ConditionTypes;
      ...
      private var var_151:UserDefinedRoomEventsHelp;
      
      private var var_1063:SliderWindowController;
      
      public function UserDefinedRoomEventsCtrl(param1:HabboUserDefinedRoomEvents)
      {
         this.var_1717 = new TriggerConfs();
         this.var_1719 = new ActionTypes();
         this.var_1718 = new ConditionTypes();
         this.var_238 = new Dictionary();
         super();
         this.var_86 = param1;
         this.var_706 = new RoomObjectHightLighter(param1);
         this.var_151 = new UserDefinedRoomEventsHelp(param1);
      }
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1063 = new SliderWindowController(this.var_86,IWindowContainer(this.find(this.var_87,"delay_slider_container")),this.var_86.assets,0,20,1);
         this.var_1063.addEventListener(Event.CHANGE,this.onDelaySliderChange);
         this.var_1063.setValue(0);
      ...
      public function close() : void
      {
         if(this._window)
         {
            ...
            this.var_706.hideAll(this.var_238);
         }
      }
      ...
      public function getActionDelay() : int
      {
         ...
         return !!_loc1_.allowDelaying ? int(this.var_1063.getValue()) : 0;
      }
      ...
      private function onHelp(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_151.open(this._window.x + this._window.width + 5,this._window.y);
      }
      ...
      private function refresh() : void
      {
         ...
         this.refreshConfigureElement(this.var_1717);
         this.refreshConfigureElement(this.var_1719);
         this.refreshConfigureElement(this.var_1718);
