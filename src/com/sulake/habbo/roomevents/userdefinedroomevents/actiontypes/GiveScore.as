package com.sulake.habbo.roomevents.userdefinedroomevents.actiontypes
{
   ...
   public class GiveScore implements ActionType
   {
      ...
      private var var_954:SliderWindowController;
      ...
      public function readIntParamsFromForm(param1:IWindowContainer) : Array
      {
         ...
         _loc2_.push(this.var_954.getValue());
      ...
      {
         this.var_86 = param2;
         this.var_954 = new SliderWindowController(param2,this.getInput(param1),param2.assets,1,100,1);
         this.var_954.addEventListener(Event.CHANGE,this.onSliderChange);
         this.var_954.setValue(1);
         this.var_1107 = new SliderWindowController(param2,this.getCounterInput(param1),param2.assets,1,10,1);
         this.var_1107.addEventListener(Event.CHANGE,this.onCounterSliderChange);
      ...
      public function onEditStart(param1:IWindowContainer, param2:Triggerable) : void
      {
         ...
         this.var_954.setValue(_loc3_);
         this.var_1107.setValue(_loc4_);
      }
