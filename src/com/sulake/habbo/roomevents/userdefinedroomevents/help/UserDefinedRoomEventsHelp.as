package com.sulake.habbo.roomevents.userdefinedroomevents.help
{
   ...
   public class UserDefinedRoomEventsHelp
   {
      ...
      private var var_1099:IContainerButtonWindow;
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1770 = IWindowContainer(this.find(this._window,"help_container"));
         this.var_1099 = this.var_1770.findChildByName("button_previous") as IContainerButtonWindow;
         if(this.var_1099)
         {
            this.var_1099.procedure = this.onButtonClick;
         }
         this.var_1100 = this.var_1770.findChildByName("button_next") as IContainerButtonWindow;
         if(this.var_1100)
         {
      ...
      private function checkButtons() : void
      {
         ...
         if(this.var_242 <= 0)
         {
            this.var_1099.disable();
         }
         else
         {
            this.var_1099.enable();
         }
      }
