package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatItem
   {
      ...
      private static const const_834:Number = 18;
      
      private static const const_545:int = 6;
      
      private static const const_825:int = 6;
      
      private static const const_835:int = 35;
      
      private static var var_314:IRegionWindow;
      ...
      public function RoomChatItem(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IAssetLibrary, param4:String, param5:IHabboLocalizationManager, param6:String)
      {
         ...
         if(!var_369)
         {
            var_369 = this._windowManager.buildFromXML(this._assetLibrary.getAssetByName("bubble_shout").content as XML,1) as IRegionWindow;
         ...
         if(!var_314)
         {
            var_314 = this._windowManager.buildFromXML(this._assetLibrary.getAssetByName("bubble_whisper").content as XML,1) as IRegionWindow;
            var_314.tags.push("roomchat_bubble");
            var_314.x = 0;
            var_314.y = 0;
            var_314.width = 0;
            var_314.background = true;
            var_314.mouseTreshold = 0;
            var_196.setParamFlag(WindowParam.WINDOW_PARAM_FORCE_CLIPPING,true);
         }
      }
      ...
      {
         this.var_1248 = param1.chatType;
         this.var_1003 = param1.userId;
         this.var_824 = param1.userName;
         this.var_1002 = param1.userCategory;
         this._message = param1.text;
         this.var_441 = param1.links;
         this.var_1585 = param1.userX;
         this.var_227 = param1.userImage;
         this.var_2156 = param1.userColor;
      ...
      {
         var _loc5_:Rectangle = new Rectangle(this._x,this.var_164,this.width,const_834);
      ...
      public function renderView() : void
      {
         ...
         switch(this.var_1248)
         {
            ...
            case RoomWidgetChatUpdateEvent.const_281:
               this._window = var_314.clone() as IRegionWindow;
               isRespect = true;
               break;
         ...
         if(this.var_227 && !isRespect)
         {
            ...
            if(userIconWindow)
            {
               ...
               userIconWindow.x = x1;
               userIconWindow.y = y1;
               this.var_672 = Math.max(0,(this.var_227.height - background.height) / 2);
         ...
         if(nameWindow != null)
         {
            if(!isRespect)
            {
               ...
               nameWindow.width = nameWindow.textWidth + const_545;
            }
            else
            {
               nameWindow.text = "";
         ...
         if(this.var_1248 == RoomWidgetChatUpdateEvent.const_281)
         {
            textWindow.text = this._localizations.registerParameter("widgets.chatbubble.respect","username",this.var_824);
            this._width = const_835;
         }
         else if(this.var_1248 == RoomWidgetChatUpdateEvent.const_261)
         {
         ...
         else
         {
            ...
            lastLinkEndPos = -1;
            i = 0;
            while(i < this.var_441.length)
            {
               filteredLink = this.var_441[i][1];
               placeHolder = "{" + i + "}";
         ...
         if(textWindow.visible)
         {
            ...
            if(nameWindow != null)
            {
               ...
               if(nameWindow.width > const_545)
               {
                  textWindow.x -= const_545 - 1;
               }
            }
         ...
         var bitmap:BitmapData = this.buildBubbleImage(nameWindow.width + textWindow.width,background.height,this.var_2156,isRespect);
      ...
      private function onMessageLinkMouseClick(param1:WindowMouseEvent) : void
      {
         ...
         while(_loc3_ < this.var_673.length)
         {
            ...
            {
               if(this.var_441[_loc3_][2] == 0)
               {
                  HabboWebTools.openExternalLinkWarning(this.var_441[_loc3_][0]);
               }
               else if(this.var_441[_loc3_][2] == 1)
               {
                  HabboWebTools.openWebPage(this.var_1584 + this.var_441[_loc3_][0],"habboMain");
               }
               else
               {
                  HabboWebTools.openWebPage(this.var_1584 + this.var_441[_loc3_][0]);
               }
            }
            _loc3_++;
         }
      ...
      {
         this._widget.onItemMouseClick(this.var_1003,this.var_824,this.var_1002,this._roomId,this._roomCategory,param1);
      }
      
      private function onBubbleMouseDown(param1:WindowMouseEvent) : void
      {
         this._widget.onItemMouseDown(this.var_1003,this.var_1002,this._roomId,this._roomCategory,param1);
      }
      
      private function onBubbleMouseOver(param1:WindowMouseEvent) : void
      {
         this._widget.onItemMouseOver(this.var_1003,this.var_1002,this._roomId,this._roomCategory,param1);
      }
      
      private function onBubbleMouseOut(param1:WindowMouseEvent) : void
      {
         this._widget.onItemMouseOut(this.var_1003,this.var_1002,this._roomId,this._roomCategory,param1);
      }
