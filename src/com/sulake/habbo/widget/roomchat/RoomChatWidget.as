package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatWidget extends RoomWidgetBase implements IUpdateReceiver
   {
      ...
      private static const const_1177:int = 9;
      
      private static const const_840:int = 10;
      
      private static const const_549:int = 25;
      
      private static const const_1181:int = 25;
      
      private static const const_842:int = 4000;
      
      private static const const_1178:int = 6000;
      
      private static const const_1179:int = 3;
      
      private static const const_1180:int = 1;
      
      private static const const_548:int = 8;
      
      private static const const_388:int = 0;
      
      private static const const_841:int = (const_548 + const_388) * const_102 + const_102;
      ...
      private var var_2254:int = 150;
      
      private var var_203:int = 171.0;
      
      private var var_852:int = 18;
      ...
      public function RoomChatWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager, param5:int, param6:Component)
      {
         ...
         this.var_35 = param1.createWindow("chat_container","",HabboWindowType.const_56,HabboWindowStyle.const_35,HabboWindowParam.const_38,new Rectangle(0,0,200,this.var_203 + RoomChatHistoryPulldown.const_78),null,0) as IWindowContainer;
         this.var_35.background = true;
         this.var_35.color = 33554431;
         this.var_35.tags.push("room_widget_chat");
         this.var_322 = param1.createWindow("chat_contentlist","",HabboWindowType.const_989,HabboWindowStyle.const_38,0 | 0,new Rectangle(0,0,200,this.var_203),null,0) as IItemListWindow;
         this.var_35.addChild(this.var_322);
         this.var_105 = param1.createWindow("chat_active_content","",HabboWindowType.const_56,HabboWindowStyle.const_38,HabboWindowParam.const_58,new Rectangle(0,0,200,this.var_203),null,0) as IWindowContainer;
         this.var_105.clipping = false;
         this.var_322.addListItem(this.var_105);
         this.var_27 = new RoomChatHistoryViewer(this,param1,this.var_35,param2);
         this.var_2253 = param4.getKey("site.url");
         this.var_2254 = int(param4.getKey("chat.history.item.max.count","150"));
      ...
      {
         var _loc2_:int = 0;
         if(getTimer() > this.var_1028 && this.var_1028 > 0)
         {
            this.var_1028 = -1;
            this.animationStart();
         }
         if(this.var_851)
         {
            _loc2_ = param1 / const_1181 * const_1179;
            if(_loc2_ + this.var_854 > this.var_852)
            {
               _loc2_ = this.var_852 - this.var_854;
            }
            if(_loc2_ > 0)
            {
            ...
            if(this.var_854 >= this.var_852)
            {
               this.var_852 = const_102;
               this.var_854 = 0;
               this.animationStop();
               this.processBuffer();
               this.var_1028 = getTimer() + const_842;
            }
         }
         if(this.var_27 != null)
         {
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetChatUpdateEvent.const_661,this.onChatMessage);
         param1.addEventListener(RoomWidgetRoomViewUpdateEvent.const_289,this.onRoomViewUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetChatUpdateEvent.const_661,this.onChatMessage);
         param1.removeEventListener(RoomWidgetRoomViewUpdateEvent.const_289,this.onRoomViewUpdate);
      ...
      {
         var _loc2_:RoomChatItem = new RoomChatItem(this,windowManager,assets,this.getFreeItemId(),localizations,this.var_2253);
         _loc2_.define(param1);
         if(this.var_853 != 1)
         {
            _loc2_.senderX /= this.var_853;
         }
         _loc2_.senderX -= this.var_690.x;
      ...
      private function onRoomViewUpdate(param1:RoomWidgetRoomViewUpdateEvent) : void
      {
         ...
         if(param1.scale > 0)
         {
            if(this.var_1649 == 0)
            {
               this.var_1649 = param1.scale;
            }
            else
            {
               this.var_853 = param1.scale / this.var_1649;
            }
         }
         if(param1.positionDelta != null)
         {
            this.var_690.x += param1.positionDelta.x / this.var_853;
            this.var_690.y += param1.positionDelta.y / this.var_853;
         }
         if(param1.rect != null)
         {
            if(this.var_27 == null)
            ...
            this.var_322.height = this.var_203;
            this.var_322.x = this.var_35.x;
            this.var_322.y = this.var_35.y;
            this.var_105.width = this.var_35.width - this.var_27.scrollbarWidth;
            this.var_105.height = this.var_203;
      ...
      private function processBuffer() : void
      {
         ...
         while(this.var_65.length > const_1180 || this.historyViewerActive() && this.var_65.length > 0)
         {
         ...
         else
         {
            ...
            {
               this.var_852 = this.getItemSpacing(this._itemList[this._itemList.length - 1],this.var_65[0]);
            }
            else
            {
               this.var_852 = const_102;
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(this._itemList.length > 1)
               {
                  ...
                  {
                     _loc1_.screenLevel = _loc3_ + Math.max(this.var_689,1);
                  }
               }
               else
               {
               ...
               _loc1_.aboveLevels = this.var_689;
               if(_loc1_.aboveLevels > const_548 + const_388 + 2)
               {
                  _loc1_.aboveLevels = const_548 + const_388 + 2;
               }
               this.var_689 = 0;
      ...
      private function selectItemsToMove() : void
      {
         ...
         while(_loc3_ >= 0)
         {
            ...
            if(_loc4_.view != null)
            {
               if(_loc4_.screenLevel > const_388 || _loc4_.screenLevel == _loc2_ - 1 || _loc1_ - _loc4_.timeStamp >= const_1178)
               {
      ...
      private function setChatItemLocHorizontal(param1:RoomChatItem) : void
      {
         ...
         var _loc2_:Number = (param1.senderX + this.var_690.x) * this.var_853;
         var _loc3_:Number = _loc2_ - param1.width / 2;
         var _loc4_:Number = _loc3_ + param1.width;
         var _loc5_:Number = -this.var_35.width / 2 - const_840;
         var _loc6_:Number = this.var_35.width / 2 + const_840 - this.var_27.scrollbarWidth;
      ...
      private function setChatItemLocVertical(param1:RoomChatItem) : void
      {
         ...
         if(param1 != null)
         {
            ...
            _loc3_ = !!this.historyViewerActive() ? 0 : Number(this.var_689);
      ...
      private function purgeItems() : void
      {
         ...
         var _loc1_:int = 0;
         var _loc3_:int = 0;
         while(this._itemList.length > this.var_2254)
         {
      ...
      {
         return "chat_" + this.var_2255.toString() + "_item_" + (this.var_2252++).toString();
      }
      ...
      public function onItemMouseClick(param1:int, param2:String, param3:int, param4:int, param5:int, param6:WindowMouseEvent) : void
      {
         ...
         var _loc7_:RoomWidgetRoomObjectMessage = new RoomWidgetRoomObjectMessage(RoomWidgetRoomObjectMessage.const_319,param1,param3);
         messageListener.processWidgetMessage(_loc7_);
         var _loc8_:RoomWidgetChatSelectAvatarMessage = new RoomWidgetChatSelectAvatarMessage(RoomWidgetChatSelectAvatarMessage.const_702,param1,param2,param4,param5);
      ...
      public function stretchAreaBottomTo(param1:Number) : void
      {
         ...
         this.var_35.height = this.var_203 + RoomChatHistoryPulldown.const_78;
         if(this.var_27 != null)
         {
            this.var_27.containerResized(this.var_35.rectangle);
         }
      ...
      public function resetArea() : void
      {
         ...
         this.animationStop();
         this.var_203 = const_841 + const_389;
         this.var_35.height = this.var_203 + this.var_27.pulldownBarHeight;
         this.var_322.width = this.var_35.width - this.var_27.scrollbarWidth;
         this.var_322.height = this.var_203;
         this.var_105.width = this.var_35.width - this.var_27.scrollbarWidth;
         if(this.historyViewerActive())
         {
            this.var_105.height = this.getTotalContentHeight() + const_389;
         }
         else
         {
            this.var_105.height = this.var_203;
      ...
      public function resizeContainerToLowestItem() : void
      {
         ...
         if(Math.abs(_loc3_) < RoomChatHistoryViewer.const_976)
         {
            this.resetArea();
            return;
         }
      ...
      public function mouseUp() : void
      {
         ...
         if(this.var_1648 && !this.historyViewerActive())
         {
            this.resetArea();
            this.var_1648 = false;
         }
