package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private static const const_1140:int = 20;
      ...
      private var var_474:Number = 600;
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager)
      {
         ...
         this.var_961 = this._localization.getKey("widgets.chatinput.mode.whisper",":tell");
         this.var_2030 = this._localization.getKey("widgets.chatinput.mode.shout",":shout");
         this._chatModeIdSpeak = this._localization.getKey("widgets.chatinput.mode.speak",":speak");
         this.var_798 = new Timer(1000,1);
         this.var_798.addEventListener(TimerEvent.TIMER_COMPLETE,this.onTypingTimerComplete);
         this.var_960 = new Timer(5000,1);
         this.var_960.addEventListener(TimerEvent.TIMER_COMPLETE,this.onIdleTimerComplete);
         this.createWindow();
         this.refreshView();
      }
      ...
      private function createWindow() : void
      {
         ...
         this._window = this._windowManager.createWindow("chatinput_widget_window","",HabboWindowType.const_56,HabboWindowStyle.const_38,0 | 0,new Rectangle(300,400,400,30),null) as IWindowContainer;
         ...
         this._window.addEventListener(WindowEvent.const_352,this.onWindowMoved);
         this.var_1501 = true;
         this.var_432 = "";
      }
      ...
      private function refreshView() : void
      {
         ...
         var _loc12_:* = 0;
         var _loc13_:* = 0;
         this.var_2029 = _loc2_.width + const_825 + _loc6_.width + const_1140;
         if(_loc7_ != null)
         {
         ...
         if(_loc8_ != null)
         {
            _loc13_ = Number(Math.max(const_1141,_loc8_.width) + const_825);
            _loc8_.x = _loc12_;
      ...
      {
         this.var_474 = param1 - this.var_2029;
         ...
         {
            _loc3_ = Math.min(int(_loc2_.textWidth),this.var_474);
         }
         else
         {
            _loc3_ = Math.min(_loc3_,this.var_474);
         }
      ...
      private function windowKeyEventProcessor(param1:Event = null, param2:IWindow = null) : void
      {
         ...
         if(_loc4_ == Keyboard.BACKSPACE)
         {
            ...
            if(_loc8_ != null)
            {
               ...
               if(_loc10_[0] == this.var_961 && _loc10_.length == 3 && _loc10_[2] == "")
               {
                  _loc8_.text = "";
                  this.var_432 = "";
               }
      ...
      private function onInputChanged(param1:WindowEvent) : void
      {
         ...
         {
            if(!this._widget.allowPaste && _loc2_.text.length > this.var_432.length + 1)
            {
               _loc2_.text = "";
            }
            this.var_432 = _loc2_.text;
            if(!this.var_799)
            {
               this.var_799 = true;
               this.var_798.reset();
      ...
      private function sendTypingMessage() : void
      {
         ...
         var _loc1_:RoomWidgetChatTypingMessage = new RoomWidgetChatTypingMessage(this.var_799);
      ...
      private function checkInputFieldLimits() : void
      {
         ...
         if(_loc1_.textWidth >= this.var_474)
         {
