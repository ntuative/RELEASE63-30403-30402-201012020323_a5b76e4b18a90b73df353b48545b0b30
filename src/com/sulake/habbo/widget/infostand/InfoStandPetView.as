package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private const const_1798:int = 158;
      
      private const const_1796:int = 16;
      
      private const const_1800:uint = 11184810;
      
      private const const_1801:uint = 6710886;
      
      private const const_1803:uint = 3355443;
      
      private const const_1802:String = "level";
      
      private const const_1795:String = "experience";
      
      private const const_1799:String = "energy";
      
      private const const_1797:String = "nutrition";
      ...
      {
         if(this.var_50 == null || this.var_195 == null || this.var_63 == null)
         {
            return;
         }
         ...
         this.var_195.height = this.var_50.height + 20;
         this._window.width = Math.max(this.var_195.width,this.var_63.width);
         this._window.height = this._window.scrollableRegion.height;
         if(this.var_195.width < this.var_63.width)
         {
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         this.updateStateElement(this.const_1802,param1.level,param1.levelMax);
         this.updateStateElement(this.const_1795,param1.experience,param1.experienceMax);
         this.updateStateElement(this.const_1799,param1.energy,param1.energyMax);
         this.updateStateElement(this.const_1797,param1.nutrition,param1.nutritionMax);
         ...
         this.var_1182.remove(param1.id);
         this.var_1182.add(param1.id,param1);
      ...
      private function createPercentageBar(param1:int, param2:int) : BitmapData
      {
         ...
         var _loc5_:BitmapData = new BitmapData(this.const_1798,this.const_1796,false);
         _loc5_.fillRect(new Rectangle(0,0,_loc5_.width,_loc5_.height),this.const_1800);
         ...
         _loc5_.fillRect(_loc7_,this.const_1801);
         return _loc5_;
      }
      ...
      private function openTrainView() : void
      {
         ...
         var _loc1_:InfoStandPetData = this.var_1182.getValue(this.var_514) as InfoStandPetData;
         if(_loc1_ != null)
         {
      ...
      private function createWindow(param1:String) : void
      {
         ...
         {
            this.var_50 = this.var_195.findChildByName("infostand_element_list") as IItemListWindow;
         }
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(this.var_176 && this.var_176.getPetId() == this.var_514)
               {
