package com.sulake.habbo.widget.infostand
{
   ...
   public class TagListRenderer
   {
      ...
      private function fit(param1:Rectangle) : Boolean
      {
         ...
         if(this.var_951 + param1.height > this.var_952.height)
         {
            return false;
         }
         ...
         {
            this._offsetX = 0;
            this.var_951 += param1.height + this.const_1807;
            return this.fit(param1);
         }
         param1.offset(this._offsetX,this.var_951);
      ...
      {
         var _loc2_:* = null;
         if(this.var_1259 != null && this.var_1259.indexOf(param1) != -1)
         {
         ...
         _loc3_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.var_144);
