package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandFurniView
   {
      ...
      private function createWindow(param1:String) : void
      {
         ...
         this.var_808 = this.var_195.findChildByTag("catalog");
         if(this.var_808 != null)
         {
            this.var_808.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onCatalogButtonClicked);
         }
      }
      ...
      private function showCatalogButton(param1:Boolean) : void
      {
         if(param1)
         {
            ...
            {
               this.var_50.addListItem(this.var_808);
            }
            this.var_808.visible = param1;
         }
         else
         {
            this.var_50.removeListItem(this.var_808);
         }
      }
   }
}
