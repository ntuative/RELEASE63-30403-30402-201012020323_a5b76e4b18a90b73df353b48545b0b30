package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private function createWindow() : void
      {
         ...
         this._window = this._widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_56,HabboWindowStyle.const_35,0 | 0,new Rectangle(const_1153,const_1154,2,2),null,0) as IWindowContainer;
         ...
         if(_loc1_ != null)
         {
            this.var_390 = new DimmerViewAlphaSlider(this,_loc1_ as IWindowContainer,this._widget.assets);
         }
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         this.var_1325 = _loc2_.light;
         if(this.var_390 != null)
         {
            this.var_390.setValue(this.var_1325);
         }
         this.var_458 = this.colors.indexOf(_loc2_.color);
         if(this.var_578 != null)
         {
            this.var_578.setSelectedColorIndex(this.var_458);
         }
      ...
      private function get windowXML() : XML
      {
         ...
         this.var_1324 = XML(_loc1_.content);
         return this.var_1324;
      }
      ...
      public function set selectedType(param1:int) : void
      {
         ...
         if(this.var_390 != null)
         {
            this.var_390.min = this._widget.minLights[param1 - 1];
         }
      }
