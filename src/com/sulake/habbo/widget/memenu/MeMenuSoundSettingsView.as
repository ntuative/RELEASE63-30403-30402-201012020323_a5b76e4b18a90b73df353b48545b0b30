package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuSoundSettingsView implements IMeMenuView
   {
      ...
      private var var_780:MeMenuSoundSettingsSlider;
      ...
      {
         this.var_431 = param1.volume;
         if(this.var_780 != null)
         {
            this.var_780.setValue(this.var_431);
         }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         if(_loc5_ != null && _loc5_.content != null)
         {
            this.var_1451 = (_loc5_.content as BitmapData).clone();
         }
         ...
         this.var_780 = new MeMenuSoundSettingsSlider(this,this._window.findChildByName("volume_container") as IWindowContainer,this._widget.assets,0,1);
         this.setSoundsOffIcon();
         this.setSoundsOnIcon();
         ...
         this._widget.messageListener.processWidgetMessage(new RoomWidgetGetSettingsMessage(RoomWidgetGetSettingsMessage.const_697));
      }
      ...
      private function setSoundsOffIcon(param1:BitmapData = null) : void
      {
         ...
         else if(this.var_431 == 0)
         {
            this.setBitmapWrapperContent("sounds_off_icon",this.var_1454);
         }
         else
         {
            this.setBitmapWrapperContent("sounds_off_icon",this.var_1451);
         }
      }
      ...
      private function setSoundsOnIcon(param1:BitmapData = null) : void
      {
         ...
         else if(this.var_431 == 1)
         {
            this.setBitmapWrapperContent("sounds_on_icon",this.var_1453);
         }
         else
         {
            this.setBitmapWrapperContent("sounds_on_icon",this.var_1452);
         }
      }
