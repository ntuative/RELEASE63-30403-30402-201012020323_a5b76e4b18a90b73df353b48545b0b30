package com.sulake.habbo.widget.memenu
{
   ...
   public class EffectView
   {
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         if(this.var_915 != null)
         {
            if(this.var_169.isActive)
            {
               ...
               this.var_915.width = _loc2_ * this.var_474;
            }
            else
            {
      ...
      private function setTimeLeft() : void
      {
         ...
         {
            this.var_914.caption = "${widgets.memenu.effects.active.timeleft}";
            _loc1_ = this.var_914.text;
            if(this.var_169.isActive)
            {
               ...
               this.var_914.text = _loc1_;
            }
            else
            {
               this.var_914.caption = "${widgets.memenu.effects.activate}";
            }
         }
      }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         else
         {
            ...
            this.var_913 = this._window.findChildByName("effect_hilite");
            this.var_913.visible = false;
         }
         this.var_914 = this._window.findChildByName("time_left") as ITextWindow;
         this.setTimeLeft();
         this.var_915 = this._window.findChildByName("loader_bar");
         if(this.var_915 != null)
         {
            this.var_474 = this.var_915.width;
            this.var_181.start();
            this.onUpdate();
         }
