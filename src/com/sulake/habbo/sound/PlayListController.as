package com.sulake.habbo.sound
{
   ...
   public class PlayListController implements IDisposable
   {
      ...
      private const const_1823:String = "type_sound_machine";
      
      private const const_1544:String = "type_jukebox";
      
      private var var_604:HabboSoundManagerFlash10;
      ...
      public function PlayListController(param1:HabboSoundManagerFlash10, param2:IEventDispatcher, param3:IEventDispatcher, param4:IConnection)
      {
         ...
         this._events.addEventListener(SoundCompleteEvent.const_810,this.onSongFinishedPlayingEvent);
         this.var_86.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_781,this.onSoundMachinePlayEvent);
         this.var_86.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_794,this.onSoundMachineStopEvent);
         this.var_86.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_730,this.onJukeboxInitEvent);
         this.var_86.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_490,this.onDisposeEvent);
      }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._events)
            {
               this._events.removeEventListener(SoundCompleteEvent.const_810,this.onSongFinishedPlayingEvent);
               this._events = null;
            }
            if(this.var_86)
            {
               this.var_86.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_781,this.onSoundMachinePlayEvent);
               this.var_86.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_794,this.onSoundMachineStopEvent);
               this.var_86.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_730,this.onJukeboxInitEvent);
               this.var_86.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_490,this.onDisposeEvent);
               this.var_86 = null;
            }
            if(this.var_387)
            {
      ...
      {
         this.startPlaying(this.const_1823);
      }
      ...
      {
         this.startPlaying(this.const_1544);
      }
      ...
      {
         var _loc1_:IHabboSound = this.var_387[this.var_272] as IHabboSound;
         if(_loc1_ != null)
         {
            _loc1_.stop();
         }
      ...
      {
         var _loc2_:IHabboSound = this.var_387.getValue(this.var_272) as IHabboSound;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function playSong(param1:int) : void
      {
         ...
         _loc2_.volume = this.var_604.volume;
         _loc2_.play();
         if(_loc3_.length >= 4)
         {
            this.var_604.notifyPlayedSong(_loc3_.name,_loc3_.creator);
         }
      ...
      {
         if(this.var_1686 == this.const_1544)
         {
            this.var_75.shift();
         }
         var _loc2_:PlayListEntry = this.getNextEntry();
      ...
      private function requestSongInfo(param1:int) : void
      {
         ...
         if(this.var_563.indexOf(param1) == -1)
         {
      ...
      private function onSongInfoMessage(param1:IMessageEvent) : void
      {
         ...
         this.var_563 = this.var_563.splice(this.var_563.indexOf(_loc3_.id),1);
         if(_loc4_)
         {
            _loc7_ = this.var_387[_loc3_.id] as IHabboSound;
            if(_loc7_ == null)
            {
               _loc7_ = this.var_604.loadTraxSong(_loc3_.id,_loc3_.data);
