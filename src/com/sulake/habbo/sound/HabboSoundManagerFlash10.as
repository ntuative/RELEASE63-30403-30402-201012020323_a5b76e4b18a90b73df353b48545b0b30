package com.sulake.habbo.sound
{
   ...
   public class HabboSoundManagerFlash10 extends Component implements IHabboSoundManager
   {
      ...
      private var var_797:TraxSequencer;
      ...
      public function HabboSoundManagerFlash10(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         events.addEventListener(TraxSongLoadEvent.const_960,this.onTraxLoadComplete);
      ...
      public function playSound(param1:String) : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc2_:HabboSound = this.var_795.getValue(param1);
         if(_loc2_ == null)
         {
            _loc3_ = "";
            switch(param1)
            {
               ...
               case HabboSoundTypesEnum.const_1271:
                  ...
                  break;
               case HabboSoundTypesEnum.const_1313:
               ...
               case HabboSoundTypesEnum.const_945:
                  ...
                  break;
               case HabboSoundTypesEnum.const_1341:
            ...
            this.var_795.add(param1,_loc2_);
         }
         _loc2_.volume = this.var_431;
         _loc2_.play();
      }
      ...
      private function loadSample(param1:int) : void
      {
         ...
         _loc4_.load(_loc3_);
         this.var_528.add(_loc4_,param1);
      }
      ...
      public function loadTraxSong(param1:int, param2:String) : IHabboSound
      {
         ...
         var _loc5_:* = [];
         var _loc6_:Array = this.var_652.getKeys();
         var _loc7_:int = 0;
         ...
         var _loc8_:TraxSequencer = new TraxSequencer(param1,_loc3_,this.var_652,events);
         _loc8_.volume = this.var_431;
         this.var_797 = null;
         this.var_651 = -1;
         if(_loc5_.length != 0)
         {
      ...
      public function notifyPlayedSong(param1:String, param2:String) : void
      {
         ...
         this.var_796.addSongPlayingNotification(param1,param2);
      }
      ...
      private function onNotificationsReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_796 = IHabboNotifications(param2);
      }
      ...
      {
         if(this.var_166 == null || this._connection == null || this._roomEngine == null || this.var_527 != null)
         {
            return;
         }
      ...
      private function onSampleLoadComplete(param1:Event) : void
      {
         ...
         var _loc3_:int = this.var_528.getValue(_loc2_);
         ...
         this.var_528.remove(_loc2_);
         this.var_652.add(_loc3_,_loc6_);
         if(this.var_528.length == 0 && this.var_651 != -1)
         {
            this.var_797.ready = true;
            events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_960,this.var_651));
            this.var_651 = -1;
            this.var_797 = null;
         }
      }
      ...
      {
         events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_1338,this.var_651));
         this.var_651 = -1;
         this.var_797 = null;
      }
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         {
            this.setHabboToolbarIconState(this.var_431 > 0);
            return;
         }
      ...
      private function storeVolumeSetting() : void
      {
         ...
         {
            this._connection.send(new SetSoundSettingsComposer(int(this.var_431 * 100)));
         }
      }
      ...
      {
         this.var_431 = param1;
         this.var_527.updateVolume(this.var_431);
