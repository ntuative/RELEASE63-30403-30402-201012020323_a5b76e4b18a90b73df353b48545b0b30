package com.sulake.habbo.sound.object
{
   ...
   public class HabboSound implements IHabboSound
   {
      ...
      private var var_1026:Sound = null;
      ...
      public function HabboSound(param1:Sound)
      {
         ...
         this.var_1026.addEventListener(Event.COMPLETE,this.onComplete);
         this.var_431 = 1;
         this.var_1283 = false;
      }
      ...
      {
         this.var_1283 = false;
         this._soundChannel = this.var_1026.play(0);
         this.volume = this.var_431;
         return true;
      }
      ...
      {
         return !this.var_1026.isBuffering;
      }
