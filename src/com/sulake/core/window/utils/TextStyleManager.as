package com.sulake.core.window.utils
{
   ...
   public class TextStyleManager
   {
      ...
      public static const const_343:String = "regular";
      ...
      public static function setStyles(param1:Array, param2:Boolean = false) : void
      {
         ...
         if(param2)
         {
            _loc5_ = [var_83[const_343],var_83[ITALIC],var_83[BOLD]];
            var_83.reset();
            var_83[const_343] = _loc5_[0];
      ...
      private static function parseStyleNamesFromCSS(param1:String) : Array
      {
         ...
         {
            while(_loc5_.indexOf(const_1174) == 0)
            {
               _loc5_ = _loc5_.substring(_loc5_.indexOf(const_1173) + 2,_loc5_.length);
            }
