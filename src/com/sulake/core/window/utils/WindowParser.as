package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1683:String = "_INCLUDE";
      
      public static const const_1715:String = "_TEMP";
      
      private static const const_1184:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      
      private static const const_1183:RegExp = /(\s|\n|\r|\t|\v)*$/;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         TypeCodeTable.fillTables(this._typeStringToCodeTable,this.var_1156);
         this.var_926 = new Dictionary();
         this.var_1404 = new Dictionary();
         ParamCodeTable.fillTables(this.var_926,this.var_1404);
         this.var_1865 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1183,"");
         return param1.replace(const_1184,"");
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            for(_loc1_ in this.var_1156)
            {
               delete this.var_1156[_loc1_];
            }
      ...
      public function windowToXMLString(param1:IWindow) : String
      {
         ...
         var _loc2_:String = "";
         var _loc3_:String = this.var_1156[param1.type];
