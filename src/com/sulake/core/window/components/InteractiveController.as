package com.sulake.core.window.components
{
   ...
   public class InteractiveController extends WindowController implements IInteractiveWindow
   {
      ...
      protected static const const_1513:uint = 500;
      
      protected static var var_257:Array;
       
      
      protected var var_2595:uint = 0;
      
      protected var var_413:Array;
      
      protected var var_1407:uint = 500;
      ...
      public function InteractiveController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         this.var_413[0] = MouseCursorType.const_344;
         this.var_413[1] = MouseCursorType.const_35;
         this.var_413[2] = MouseCursorType.const_344;
         this.var_413[3] = MouseCursorType.const_344;
         this.var_413[4] = MouseCursorType.const_35;
         this.var_413[5] = MouseCursorType.const_35;
         this.var_413[6] = MouseCursorType.const_344;
         if(var_257 == null)
         {
            var_257 = new Array();
            var_257[0] = WindowState.const_96;
            ...
            var_257[6] = WindowState.const_76;
         }
      ...
      {
         param2.push(new PropertyStruct(const_1113,param1.toolTipCaption,PropertyStruct.const_89,param1.toolTipCaption != const_813));
         param2.push(new PropertyStruct(KEY_TOOLTIP_DELAY,param1.toolTipDelay,PropertyStruct.const_292,param1.toolTipDelay != const_1513));
         return param2;
      }
