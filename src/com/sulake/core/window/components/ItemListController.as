package com.sulake.core.window.components
{
   ...
   public class ItemListController extends WindowController implements IItemListWindow, IInputProcessorRoot
   {
      ...
      protected static const const_1117:String = "scale_to_fit_items";
      
      protected static const const_1116:String = "resize_on_item_update";
      
      protected static const const_1114:String = "auto_arrange_items";
      
      protected static const DEF_SPACING:int = 0;
      
      protected static const const_1514:Boolean = false;
      
      protected static const DEF_RESIZE_ON_ITEM_UPDATE:Boolean = false;
      
      protected static const const_1515:Boolean = true;
      ...
      protected var var_1867:Boolean = false;
      ...
      protected var var_1866:int = 0;
      
      protected var var_1160:Number;
      ...
      public function ItemListController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         var_150 = var_411 || !testParamFlag(WindowParam.const_31);
         this._container = var_16.create("_CONTAINER","",WindowType.const_367,WindowStyle.const_786,0 | 0 | 0,new Rectangle(0,0,width,height),null,this,0,null,[TAG_INTERNAL,TAG_EXCLUDE]) as IWindowContainer;
         ...
         this.resizeOnItemUpdate = this.var_1161;
      }
      ...
      {
         return new Rectangle(this.var_621 * this.maxScrollH,this.var_620 * this.maxScrollV,width,height);
      }
      ...
      public function set scrollH(param1:Number) : void
      {
         ...
         if(param1 != this.var_621)
         {
            ...
            dispatchEvent(new WindowEvent(WindowEvent.const_458,this,null));
         }
      }
      ...
      public function set resizeOnItemUpdate(param1:Boolean) : void
      {
         ...
         if(this._container)
         {
            if(this._horizontal)
            {
               this._container.setParamFlag(WindowParam.const_451,param1);
            }
            else
            {
      ...
      public function process(param1:WindowEvent) : Boolean
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.const_173:
               if(this.var_1158)
               {
                  this.var_1160 = this.var_1868 - _loc3_;
                  this.var_1159 = this.var_1866 - _loc4_;
                  if(this._horizontal)
                  {
                     if(this.var_1160 != 0 && this.var_99 != 0)
                     {
                        this.scrollH += this.var_1160 / this.var_99;
                     }
                  }
                  else if(this.var_1159 != 0 && this.var_90 != 0)
                  {
                     this.scrollV += this.var_1159 / this.var_90;
                  }
                  this.var_1868 = _loc3_;
                  this.var_1866 = _loc4_;
                  _loc2_ = true;
            ...
            case WindowMouseEvent.const_166:
               if(this.var_1158)
               {
                  if(this._horizontal)
                  {
                     var_16.getWindowServices().getGestureAgentService().begin(this,this.scrollAnimationCallback,0,-this.var_1160,0);
                  }
                  else
                  {
                     var_16.getWindowServices().getGestureAgentService().begin(this,this.scrollAnimationCallback,0,0,-this.var_1159);
                  }
                  this.var_1158 = false;
                  _loc2_ = true;
               }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_1115,this._spacing,PropertyStruct.const_52,this._spacing != DEF_SPACING));
         _loc1_.push(new PropertyStruct(const_1114,this.var_927,PropertyStruct.const_54,this.var_927 != const_1515));
         _loc1_.push(new PropertyStruct(const_1117,this.var_507,PropertyStruct.const_54,this.var_507 != const_1514));
         _loc1_.push(new PropertyStruct(const_1116,this.var_1161,PropertyStruct.const_54,this.var_1161 != DEF_RESIZE_ON_ITEM_UPDATE));
         return _loc1_;
      }
