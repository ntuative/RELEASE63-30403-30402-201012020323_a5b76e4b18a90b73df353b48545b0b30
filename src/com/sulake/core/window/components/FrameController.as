package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_878:String = "margin_left";
      
      private static const const_876:String = "margin_top";
      
      private static const const_877:String = "margin_right";
      ...
      private var var_1376:IHeaderWindow;
      ...
      public function get header() : IHeaderWindow
      {
         ...
         {
            this.var_1376 = findChildByTag(const_1229) as IHeaderWindow;
            if(!this.var_1376)
            {
      ...
      public function get content() : IWindowContainer
      {
         ...
         {
            this.var_158 = findChildByTag(const_1228) as IWindowContainer;
            if(!this.var_158)
            {
      ...
      override public function set color(param1:uint) : void
      {
         ...
         groupChildrenWithTag(const_1119,_loc2_,false);
      ...
      private function setupScaling() : void
      {
         ...
         var _loc4_:Boolean = testParamFlag(WindowParam.const_210);
         if(_loc1_)
         {
            if(_loc3_ || _loc2_)
            {
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_878,_loc3_.left,PropertyStruct.const_52,_loc2_));
         _loc1_.push(new PropertyStruct(const_876,_loc3_.top,PropertyStruct.const_52,_loc2_));
         _loc1_.push(new PropertyStruct(const_877,0 - _loc3_.right,PropertyStruct.const_52,_loc2_));
         _loc1_.push(new PropertyStruct(const_875,0 - _loc3_.bottom,PropertyStruct.const_52,_loc2_));
         return _loc1_;
      }
