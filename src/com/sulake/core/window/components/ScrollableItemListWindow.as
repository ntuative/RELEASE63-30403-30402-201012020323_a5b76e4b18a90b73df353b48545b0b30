package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_964:IItemListWindow;
      ...
      override public function dispose() : void
      {
         if(this.var_361)
         {
            this.var_361.removeEventListener(WindowEvent.const_301,this.scrollBarEventProc);
            this.var_361.removeEventListener(WindowEvent.const_214,this.scrollBarEventProc);
            this.var_361 = null;
         }
         if(this.var_964)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!this.var_964)
         {
            this.var_964 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
         return this.var_964;
      }
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!this.var_361)
         {
            this.var_361 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(this.var_361)
            {
               this.var_361.addEventListener(WindowEvent.const_301,this.scrollBarEventProc);
               this.var_361.addEventListener(WindowEvent.const_214,this.scrollBarEventProc);
            }
         }
         return this.var_361;
      }
