package com.sulake.core.window.components
{
   ...
   public class ScrollbarController extends InteractiveController implements IScrollbarWindow, ITouchAwareWindow
   {
      ...
      private static const const_1200:String = "increment";
      
      private static const const_1201:String = "decrement";
      
      private static const const_854:String = "slider_track";
      
      private static const const_552:String = "slider_bar";
       
      
      protected var _offset:Number = 0;
      
      protected var var_622:Number = 0.1;
      ...
      public function set scrollable(param1:IScrollableWindow) : void
      {
         if(this.var_19 != null && !this.var_19.disposed)
         {
            ...
            this.var_19.removeEventListener(WindowEvent.const_458,this.onScrollableScrolled);
         }
         this.var_19 = param1;
         if(this.var_19 != null && !this.var_19.disposed)
         {
            this.var_19.addEventListener(WindowEvent.const_45,this.onScrollableResized);
            this.var_19.addEventListener(WindowEvent.const_458,this.onScrollableScrolled);
            this.updateLiftSizeAndPosition();
         }
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            ...
            {
               this.var_876 = _loc3_.value as String;
            }
            _loc4_++;
         }
      ...
      {
         return findChildByName(const_854) as WindowController;
      }
      
      protected function get lift() : WindowController
      {
         return this.track.findChildByName(const_552) as WindowController;
      }
      ...
      override public function update(param1:WindowController, param2:Event) : Boolean
      {
         switch(param1.name)
         {
            case ScrollbarController.const_552:
         ...
         if(param1 == this)
         {
            ...
            else if(param2.type == WindowMouseEvent.const_264)
            {
               if(WindowMouseEvent(param2).delta > 0)
               {
                  if(this._horizontal)
                  {
                     this.scrollH -= this.var_622;
                  }
                  else
                  {
                     this.scrollV -= this.var_622;
                  }
               }
      ...
      private function scrollButtonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_40 || param1.type == WindowTouchEvent.const_413)
         {
            ...
            else if(param2.name == const_1201)
            {
               if(this.var_19)
               {
                  this.var_1056 = true;
            ...
            else if(param2.name == const_854)
            {
               ...
               _loc6_ = WindowController(param2).getChildByName(ScrollbarController.const_552).rectangle;
               if(this._horizontal)
               {
                  if(_loc4_ < _loc6_.x)
                  {
      ...
      private function resolveScrollTarget() : Boolean
      {
         ...
         {
            _loc1_ = findParentByName(this.var_876) as IScrollableWindow;
            if(_loc1_ == null && var_13 is IWindowContainer)
            {
               _loc1_ = IWindowContainer(var_13).findChildByName(this.var_876) as IScrollableWindow;
               if(_loc1_)
               {
