package com.sulake.core.window
{
   ...
   public class WindowController extends WindowModel implements IWindow, IGraphicContextHost
   {
      ...
      private static var var_1144:uint = 0;
      
      protected static const TAG_EXCLUDE:String = "_EXCLUDE";
      
      protected static const TAG_INTERNAL:String = "_INTERNAL";
      
      protected static const const_1119:String = "_COLORIZE";
      
      protected static const const_1521:String = "_IGNORE_INHERITED_STYLE";
      
      private static var var_1397:Point = new Point();
      ...
      public function WindowController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         if(_loc12_ != null)
         {
            ...
            var_56 = var_348.clone();
            var_11 = var_348.clone();
         ...
         if(_loc13_)
         {
            var_720 = _loc13_.blend;
            var_410 = _loc13_.treshold;
            if(var_411 != _loc13_.background)
            {
      ...
      {
         var_411 = param1;
         var_216 = !!var_411 ? uint(var_216 | var_504) : uint(var_216 & 16777215);
      ...
      {
         var_504 = param1 & 4278190080;
         var_216 = !!var_411 ? uint(param1) : uint(param1 & 16777215);
         var_16.invalidate(this,var_11,WindowRedrawFlag.const_73);
      }
      ...
      {
         var_504 = param1 << 24;
         var_216 = !!var_411 ? uint(var_504 | var_216) : uint(16777215 & var_216);
         var_16.invalidate(this,var_11,WindowRedrawFlag.const_73);
      }
      
      public function set blend(param1:Number) : void
      {
         var_720 = param1 > 1 ? 1 : (param1 < 0 ? 0 : Number(param1));
         var_16.invalidate(this,var_11,WindowRedrawFlag.const_992);
      }
      ...
      public function set state(param1:uint) : void
      {
         ...
         {
            _state = param1;
            this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_493,this,null));
         }
      }
      ...
      {
         var_410 = param1 > 255 ? 255 : uint(param1);
      }
      ...
      public function set parent(param1:IWindow) : void
      {
         ...
         if(this.var_13 != param1)
         {
            ...
            if(this.var_13 != null)
            {
               this.var_344 = this.var_13.rectangle.clone();
               var_56.x = var_11.x;
               var_56.y = var_11.y;
               var_56.width = var_11.width;
               var_56.height = var_11.height;
               this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_518,this,this.var_13));
            }
            else
            {
               this.var_344.x = 0;
      ...
      public function clone() : IWindow
      {
         ...
         var _loc2_:WindowController = new _loc1_(_name,_type,var_77,var_18,var_16,var_11,null,this.var_762,this.properties,var_755.concat(),_id) as WindowController;
      ...
      {
         return "[Window " + getQualifiedClassName(this) + " " + this.var_2579 + "]";
      }
      ...
      public function setRectangle(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         if(_loc5_ || _loc6_)
         {
            if(_loc5_)
            {
               _loc9_ = new WindowNotifyEvent(WindowNotifyEvent.const_885,this,null,true);
      ...
      public function update(param1:WindowController, param2:Event) : Boolean
      {
         ...
         var _loc8_:* = null;
         var _loc9_:* = 0;
         if(!testParamFlag(WindowParam.const_772))
         {
            ...
            switch(param2.type)
            {
               case WindowMouseEvent.const_40:
                  ...
                  if(testParamFlag(WindowParam.const_346))
                  {
                     ...
                     while(_loc3_ != null)
                     {
                        if(_loc3_.testParamFlag(WindowParam.const_201))
                        {
         ...
         if(param2 is WindowNotifyEvent)
         {
            switch(param2.type)
            {
               case WindowNotifyEvent.const_178:
                  ...
                  if(param1 == this)
                  {
                     this.notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_401,this,null));
                     if(testParamFlag(WindowParam.const_167,WindowParam.const_153))
                     {
                        this.updateScaleRelativeToParent();
                     }
                     else if(testParamFlag(WindowParam.const_183,WindowParam.const_144))
                     {
                        this.updateScaleRelativeToParent();
                     }
                     if(this.var_13 != null)
                     {
                        _loc9_ = uint(var_18);
                        var_18 &= ~(0 | 0);
                        if(testParamFlag(WindowParam.const_451))
                        {
               ...
               case WindowNotifyEvent.const_393:
                  var_16.invalidate(this,var_11.union(var_56),WindowRedrawFlag.const_440);
                  if(param1 == this)
                  {
                     this.notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_1108,this,null));
                     if(this.var_13 != null)
                     {
                        this.var_13.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_277,this.var_13,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_331:
                  if(param1 == this)
                  {
                     this.notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_748,this,null));
                     if(this.var_13 != null)
                     {
                        this.var_13.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_220,this.var_13,this));
                     }
                  }
                  break;
               ...
               case WindowNotifyEvent.const_464:
                  ...
                  while(--_loc7_ > -1)
                  {
                     ...
                     if(_loc8_.tags.indexOf(const_1521) == -1)
                     {
                        _loc8_.style = var_77;
                     }
                  }
               ...
               case WindowNotifyEvent.const_401:
                  this.var_13.getRegionProperties(null,this.var_344);
                  this.updateScaleRelativeToParent();
                  break;
      ...
      protected function forwardNotifyEvent(param1:WindowNotifyEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowNotifyEvent.const_1001:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_1373:
               _loc2_ = "null";
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_1497:
               _loc2_ = "null";
               break;
      ...
      {
         return this.testLocalPointHitAgainstAlpha(param1,param2,var_410);
      }
      ...
      public function validateGlobalPointIntersection(param1:Point, param2:BitmapData) : Boolean
      {
         ...
         return this.testLocalPointHitAgainstAlpha(_loc3_,param2,var_410);
      }
         ...
         if(this.var_150 && var_410 > 0)
         {
            if(!testParamFlag(WindowParam.const_31))
            {
               if(param1.x <= var_11.width && param1.y <= var_11.height)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     _loc4_ = _loc5_.hitTest(var_1397,param3,param1);
                  }
               }
            }
            else
            {
               _loc4_ = param2 != null ? Boolean(param2.hitTest(var_1397,param3,param1)) : false;
            }
         }
      ...
      protected function updateScaleRelativeToParent() : void
      {
         ...
         var _loc1_:* = !testParamFlag(WindowParam.const_128,WindowParam.const_153);
         var _loc2_:* = !testParamFlag(WindowParam.const_140,WindowParam.const_144);
         if(_loc1_ || _loc2_)
         {
            _loc3_ = var_11.clone();
            if(_loc1_)
            {
               _loc4_ = this.var_13.width - this.var_344.width;
            ...
            if(_loc2_)
            {
               _loc4_ = this.var_13.height - this.var_344.height;
               _loc5_ = uint(var_18 & 0);
      ...
      public function addChild(param1:IWindow) : IWindow
      {
         ...
         _loc2_.parent = this;
         if(this.var_1396 || _loc2_.hasGraphicsContext())
         {
            this.setupGraphicsContext();
         ...
         this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_320,this,param1));
         return param1;
      }
      ...
      public function addChildAt(param1:IWindow, param2:int) : IWindow
      {
         ...
         _loc3_.parent = this;
         if(this.var_1396 || _loc3_.hasGraphicsContext())
         {
            this.setupGraphicsContext();
      ...
      public function removeChild(param1:IWindow) : IWindow
      {
         ...
         this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_653,this,param1));
         return param1;
      }
