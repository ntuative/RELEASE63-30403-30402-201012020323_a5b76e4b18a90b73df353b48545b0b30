package com.sulake.core.utils
{
   ...
   public class LibraryLoader extends EventDispatcher implements IDisposable
   {
      ...
      protected static const const_1509:uint = 1;
      
      protected static const const_1508:uint = 2;
      
      protected static const const_1506:uint = 4;
      
      protected static const const_1507:uint = 3;
      ...
      protected var var_251:URLRequest;
      
      protected var var_688:XML;
      
      protected var var_555:Class;
      ...
      protected var var_1855:int;
      
      protected var var_1152:int;
      
      protected var var_1151:int;
      ...
      {
         return !!this.var_251 ? this.var_251.url : null;
      }
      ...
      {
         return !!this.var_922 ? uint(this.var_1152 - this.var_1855) : uint(getTimer() - this.var_1855);
      }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            dispatchEvent(new LibraryLoaderEvent(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_DISPOSE,this.var_346,this.bytesTotal,this.bytesLoaded,this.elapsedTime));
            try
            {
               this.var_38.close();
            }
      ...
      public function load(param1:URLRequest, param2:int = 5) : void
      {
         ...
         this._name = parseNameFromUrl(this.var_251.url);
      ...
      public function resume() : void
      {
         ...
         {
            this.var_923 = false;
            if(!this.var_922 && this.var_251)
            {
               this.var_1152 = -1;
               this.var_1855 = getTimer();
               this.var_38.load(this.var_251,this.var_16);
            }
         }
      }
      ...
      {
         if(!this.var_922 && !_disposed && this.var_1151 > 0)
         {
            try
            {
               this.var_38.close();
            ...
            this.addRequestCounterToUrlRequest(this.var_251,const_1370 - this.var_1151);
            if(this.var_2583)
            {
               this.var_251.requestHeaders.push(new URLRequestHeader("pragma","no-cache"));
               this.var_251.requestHeaders.push(new URLRequestHeader("Cache-Control","no-cache"));
               this.var_2583 = false;
            }
            --this.var_1151;
            this.var_406 = 0;
      ...
      protected function loadEventHandler(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case HTTPStatusEvent.HTTP_STATUS:
               ...
               this.debug("Load event STATUS " + this.var_346 + " for file \"" + this.url + "\"");
               break;
            case Event.UNLOAD:
               this.debug("Load event UNLOAD for file \"" + this.url + "\"");
               dispatchEvent(new LibraryLoaderEvent(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_UNLOAD,this.var_346,this.bytesTotal,this.bytesLoaded,this.elapsedTime));
               break;
            case ProgressEvent.PROGRESS:
               this.debug("Load event PROGRESS for file \"" + this.url + "\"");
               dispatchEvent(new LibraryLoaderEvent(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_PROGRESS,this.var_346,this.bytesTotal,this.bytesLoaded,this.elapsedTime));
               break;
            case IOErrorEvent.IO_ERROR:
               this.debug("Load event IO ERROR for file \"" + this.url + "\"");
               if(!this.handleHttpStatus(this.var_346))
               {
                  this.var_1152 = getTimer();
            ...
            case TimerEvent.TIMER:
               ...
               if(!_disposed)
               {
                  this.var_406 = LibraryLoader.name_2;
         ...
         if(this.var_406 == LibraryLoader.const_1507)
         {
         ...
         if(this.var_406 == LibraryLoader.name_2)
         {
            if(this.prepareLibrary())
            {
               ...
               this.var_1152 = getTimer();
               this.removeEventListeners();
               dispatchEvent(new LibraryLoaderEvent(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE,this.var_346,this.bytesTotal,this.bytesLoaded,this.elapsedTime));
      ...
      protected function prepareLibrary() : Boolean
      {
         ...
         this.var_555 = this.getDefinition(this._name) as Class;
         if(this.var_555 == null)
         {
            if(!this.retry())
            {
               this.failure("Failed to find resource class \"" + this._name + "\" from library " + this.var_251.url + "!");
            }
            return false;
         }
         try
         {
            xmlClass = this.var_555.manifest as Class;
            if(xmlClass == null)
            {
               return false;
            }
         ...
         try
         {
            this.var_688 = new XML(bytes.readUTFBytes(bytes.length));
         }
         catch(e:Error)
         {
            if(!retry())
      ...
      protected function debug(param1:String) : void
      {
         ...
         if(this._debug)
         {
            dispatchEvent(new LibraryLoaderEvent(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_DEBUG,this.var_346,this.bytesTotal,this.bytesLoaded,this.elapsedTime));
         }
      }
      ...
      protected function failure(param1:String) : void
      {
         ...
         dispatchEvent(new LibraryLoaderEvent(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_ERROR,this.var_346,this.bytesTotal,this.bytesLoaded,this.elapsedTime));
         dispatchEvent(new Event(LIBRARY_LOADER_FINALIZE));
      }
