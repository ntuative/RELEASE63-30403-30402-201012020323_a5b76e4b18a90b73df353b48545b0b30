package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      public static const const_1065:String = "AssetLibraryReady";
      
      public static const const_621:String = "AssetLibraryLoaded";
      
      public static const const_1422:String = "AssetLibraryUnloaded";
      
      public static const const_1445:String = "AssetLibraryLoadError";
      
      private static var var_270:Dictionary;
      ...
      public function AssetLibrary(param1:String)
      {
         super();
         this._name = param1;
         this.var_688 = new XML();
         this.var_379 = 0;
         this.var_378 = new Array();
         if(var_270 == null)
         {
            var_270 = new Dictionary(false);
         ...
         ++var_456;
         this.var_380 = new Dictionary(false);
      ...
      public function loadFromFile(param1:LibraryLoader, param2:Boolean = true) : void
      {
         ...
         {
            if(!this.var_850 && param2)
            {
               AssetLibrary.fetchLibraryContents(this,this.var_688,this.var_555);
            }
            this.var_850 = param2;
            dispatchEvent(new Event(AssetLibrary.const_1065));
         }
         else
         {
      ...
      public function unload() : void
      {
         var _loc1_:* = null;
         var _loc2_:* = null;
         for(_loc1_ in this.var_455)
         {
            _loc2_ = this.var_455[_loc1_];
            _loc2_.assetLoader.dispose();
            delete this.var_455[_loc1_];
         }
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         var _loc4_:AssetLoaderStruct = this.var_455[param2.url];
         if(_loc4_ != null)
         {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_1025,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_930,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_883,this.assetLoadEventHandler);
         _loc4_ = new AssetLoaderStruct(param1,_loc6_);
         this.var_455[param2.url] = _loc4_;
         return _loc4_;
      }
      ...
      private function assetLoadEventHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var struct:AssetLoaderStruct = this.var_455[loader.url];
         if(struct == null)
         {
         ...
         if(remove)
         {
            if(!_disposed && loader)
            {
               delete this.var_455[loader.url];
            }
            if(struct)
            {
               struct.dispose();
      ...
      {
         return this.var_143[param1] != null || (this.var_555 != null ? this.var_555[param1] != null : false);
      }
      ...
      public function registerAssetTypeDeclaration(param1:AssetTypeDeclaration, param2:Boolean = true) : Boolean
      {
         if(param2)
         {
            if(var_270.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            var_270[param1.mimeType] = param1;
         }
         else
         {
            if(this.var_380.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            this.var_380[param1.mimeType] = param1;
         }
         return true;
      }
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            _loc3_ = AssetTypeDeclaration(var_270[param1]);
            if(_loc3_ != null)
            {
               return _loc3_;
            }
         }
         _loc3_ = AssetTypeDeclaration(this.var_380[param1]);
         if(_loc3_ != null)
         {
            return _loc3_;
         }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            for(_loc4_ in var_270)
            {
               _loc3_ = AssetTypeDeclaration(var_270[_loc4_]);
               if(_loc3_ != null)
               {
         ...
         for(_loc4_ in this.var_380)
         {
            _loc3_ = AssetTypeDeclaration(this.var_380[_loc4_]);
            if(_loc3_ != null)
            {
               if(_loc3_.assetClass == param1)
               {
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            for(_loc5_ in var_270)
            {
               _loc4_ = AssetTypeDeclaration(var_270[_loc5_]);
               if(_loc4_ != null)
               {
         ...
         for(_loc5_ in this.var_380)
         {
            _loc4_ = AssetTypeDeclaration(this.var_380[_loc5_]);
            if(_loc4_ != null)
            {
               if(_loc4_.fileTypes.indexOf(_loc3_))
               {
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         this.var_688 = _loc2_.manifest.copy();
         this.var_555 = _loc2_.resource;
      ...
      private function loadErrorHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         dispatchEvent(new Event(AssetLibrary.const_1445));
         this.var_38 = null;
      }
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = this.var_688.child("library");
         if(_loc2_ == null)
         {
         ...
         if(_loc2_ != null)
         {
            ...
            while(_loc7_ < _loc6_)
            {
               ...
               if(_loc3_.attribute("name").toString() == param1)
               {
                  ...
                  _loc5_.setUnknownContent(this.var_555[param1]);
